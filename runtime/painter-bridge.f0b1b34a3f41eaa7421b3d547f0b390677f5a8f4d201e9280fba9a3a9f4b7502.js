...
import { state, callIndirect } from "./win32/context.js";
import { callPromotedLiftedFromCpu } from "./lifted-runtime.js";
...
// The peep walking-movement core. runtime/harness.js already routes JS
// callers through state.fnDispatch; this import is for the EIP hook that
// covers the callNative and native-`call` paths (ADDENDUM 175).
import { FUN_extra_peepwalk_43c751 } from "../ported/auto/extra_peepwalk_43c751.js";
import { FUN_00423ffd } from "../ported/auto/423ffd.js";
// Three heap-and-EAX-exact ports that were unwireable only because they
// returned in the CARRY FLAG and modelled no flags at all (ADDENDUM 175).
import { FUN_005df40c } from "../ported/auto/5df40c.js";
import { FUN_00425432 } from "../ported/auto/425432.js";
import { FUN_0042547b } from "../ported/auto/42547b.js";
import { FUN_00458a7c } from "../ported/auto/458a7c.js";
import { FUN_00444bd4 } from "../ported/auto/444bd4.js";
import { FUN_00444c74 } from "../ported/auto/444c74.js";
import { FUN_00444d1f } from "../ported/auto/444d1f.js";
import { FUN_005e5496 } from "../ported/auto/5e5496.js";
import { FUN_0045a930 } from "../ported/auto/45a930.js";
import { FUN_0045a95d } from "../ported/auto/45a95d.js";
import { FUN_00429c3d } from "../ported/auto/429c3d.js";
import { FUN_00458bcf } from "../ported/auto/458bcf.js";
import { FUN_00458c14 } from "../ported/auto/458c14.js";
...
import { FUN_0042afb5 } from "../ported/auto/42afb5.js";
import { FUN_005e0d3c } from "../ported/auto/5e0d3c.js";
import { FUN_005e0cb6 } from "../ported/auto/5e0cb6.js";
import { FUN_005df1ff } from "../ported/auto/5df1ff.js";
import { FUN_004501b0 } from "../ported/auto/4501b0.js";
import { FUN_0042682d } from "../ported/auto/42682d.js";
import { FUN_00430326 } from "../ported/auto/430326.js";
import { resetTooltipExact } from "../ported/auto/extra_tooltip.js";
import { FUN_005e5b80_exact } from "../ported/auto/5e5b80.js";
import { FUN_005e6a83_exact } from "../ported/auto/5e6a83.js";
import { FUN_005e412c_exact } from "../ported/auto/5e412c.js";
import { FUN_005e4198_exact } from "../ported/auto/5e4198.js";
import { FUN_005e585a_exact } from "../ported/auto/5e585a.js";
import { FUN_005e3b2b_exact } from "../ported/auto/5e3b2b.js";
import { FUN_005e3bbf_exact } from "../ported/auto/5e3bbf.js";
import { FUN_005e117d_exact } from "../ported/auto/5e117d.js";
import { FUN_005e5301_exact } from "../ported/auto/5e5301.js";
import { FUN_005e5ca6_exact } from "../ported/auto/5e5ca6.js";
import { createWindowExact, canCreateWindowJs } from "../ported/auto/extra_window_lifecycle.js";
import { FUN_004271da, FUN_004271bb } from "../ported/auto/4271da.js";
import { FUN_005e5bd8_exact } from "../ported/auto/5e5bd8.js";
import { FUN_005e43de_exact } from "../ported/auto/5e43de.js";
import { FUN_005e56d3 } from "../ported/auto/5e56d3.js";
import { FUN_00423677_exact } from "../ported/auto/423677.js";
import { FUN_00434a94_exact } from "../ported/auto/434a94.js";
import { FUN_005e16f7 } from "../ported/auto/5e16f7.js";
import { FUN_005e19eb } from "../ported/auto/5e19eb.js";
import { FUN_005e1b3e } from "../ported/auto/5e1b3e.js";
import { FUN_005e1bfd } from "../ported/auto/5e1bfd.js";
import { FUN_005e4355_exact } from "../ported/auto/5e4355.js";
import { FUN_009bb374 } from "../ported/auto/9bb374.js";
...
import { FUN_00429d41 } from "../ported/auto/429d41.js";
import { FUN_00429f6c } from "../ported/auto/429f6c.js";
...
import { showTooltipRuntime } from "../ported/auto/extra_tooltip.js";
import { paintTooltipExact } from "../ported/auto/extra_tooltip_paint.js";
import { initializeViewportExact, viewportEventExact, selectToolExact, cancelToolExact, hitTestWidgetExact, hitTestWindowExact } from "../ported/auto/extra_ui_selection.js";
import { FUN_005e3861_exact } from "../ported/auto/5e3861.js";
import { FUN_00458678_exact } from "../ported/auto/458678.js";
...
import {
  FUN_extra_paint_436bc3,
  FUN_extra_paint_436c3d,
  FUN_extra_paint_436cb3,
} from "../ported/auto/extra_436b50.js";
...
import { installThinSprite42d807 } from "../ported/auto/extra_paint_42d807.js";
import { installTrackPaintTemplates } from "../ported/auto/track-paint-templates.js";
import { installLargeScenery } from "../ported/auto/extra_paint_451ff8.js";
import { installMiscAnimation } from "../ported/auto/extra_sim_42dd0b.js";
import { installStationPlatforms } from "../ported/auto/extra_paint_49b800.js";
import { installRideSupportTails } from "../ported/auto/ride-support-tails.js";
import { installRotatingRide59e41a } from "../ported/auto/extra_paint_59e41a.js";
import { installRideVehicle55203e } from "../ported/auto/extra_paint_55203e.js";
import { installPeepTileCheck } from "../ported/auto/peep-tile-check.js";
import { installWallPaintBlocks } from "../ported/auto/wall-paint-blocks.js";
import { installWallTail447bcc } from "../ported/auto/extra_paint_447bcc.js";
import { installDoorFrame446240 } from "../ported/auto/extra_paint_446240.js";
...
import { install436a8cHooks } from "../ported/auto/extra_paint_436a8c.js";
...
import { FUN_extra_paint_5ddf5d } from "../ported/auto/extra_paint_5ddf5d.js";
...
export function installPainterBridge(heap, opts = {}) {
  ...
  // Expose the interpreter entry point for runtime/win32/context.js's
  // callIndirect fallback (an unported indirect target runs the real binary
  // code instead of silently returning 0). Published through `state` rather
  // than imported, so context.js does not have to import this module back.
  state.__callNative = (addr, args) => callNative(addr, args);
  ...
  // FUN_005dbeeb — vehicle mode-flag query. Reviewed lifted closures win
  // crossings from the interpreter; the legacy hybrid body remains as the
  // development oracle path when this root is not promoted. The JS body
  ...
  setEipHook(0x5dbeeb, (c) => {
    if (!globalThis.__forceInterp5dbeeb && callPromotedLiftedFromCpu(heap, c, 0x5dbeeb)) return;
  ...
  // Off-map terrain painters (PTR_LAB_00436a8c). These are tail-jump entries
  // with a two-register unwind, so their installer handles the stack itself.
  if (globalThis.__realStartup) install436a8cHooks(setEipHook, heap);
  ...
  installDoorFrame446240(heap, setEipHook, getEipHook, clearEipHook, step);
  installWallTail447bcc(heap, setEipHook, getEipHook, clearEipHook, step);
  installTrackPaintTemplates(heap, setEipHook, getEipHook, clearEipHook, step);
  installLargeScenery(heap, setEipHook, getEipHook, clearEipHook, step);
  installMiscAnimation(heap, setEipHook, getEipHook, clearEipHook, step);
  installStationPlatforms(heap, setEipHook, getEipHook, clearEipHook, step);
  installRideSupportTails(heap, setEipHook, getEipHook, clearEipHook, step);
  installRotatingRide59e41a(heap, setEipHook, getEipHook, clearEipHook, step);
  installRideVehicle55203e(heap, setEipHook, getEipHook, clearEipHook, step);
  installPeepTileCheck(heap, setEipHook, getEipHook, clearEipHook, step);
  installWallPaintBlocks(heap, setEipHook, getEipHook, clearEipHook, step);
  installThinSprite42d807(heap, setEipHook, getEipHook, clearEipHook, step);
  ...
  const installJsFnEipHook = (addr, jsFn, forceFlag, onThrow, canHandle, syncFlags = false) => {
    // Publish every JS-port hook so a differential oracle can silence them for
    // the duration of its INTERPRETER leg. These hooks are global and fire on
    // whichever cpu is stepping, so an oracle that leaves them armed measures
    // the JS against itself. That contaminated tooltip_render_live and then
    // tools/_lockstep-real.mjs itself (ADDENDUM 176). Runtime shims and DLL
    // thunks are deliberately NOT listed — the interpreter leg still needs
    // those.
    (globalThis.__jsFnEipHooks || (globalThis.__jsFnEipHooks = new Map()))
      .set(addr >>> 0, forceFlag);
    const stepThroughNative = (c) => {
      const self = getEipHook(addr);
      clearEipHook(addr);
      const limit = globalThis.__painterStepLimit || 50_000_000;
      const espEntry = c.regs.esp >>> 0;
      const returnAddress = heap.u32(espEntry);
      try {
        c.regs.eip = addr >>> 0;
        let n = 0;
        while (!((c.regs.esp >>> 0) === espEntry && (c.regs.eip >>> 0) < heap.bytes.length
                 && (heap.u8(c.regs.eip >>> 0) === 0xc3 || heap.u8(c.regs.eip >>> 0) === 0xc2))) {
          const running = step(c);
          if ((c.regs.esp >>> 0) === ((espEntry + 4) >>> 0) && (c.regs.eip >>> 0) === returnAddress) {
            c.regs.esp = espEntry;
            break;
          }
          if (!running || ++n > limit) break;
        }
    ...
    setEipHook(addr, (c) => {
      ...
      regs.ebp = c.regs.ebp >>> 0;
      if (syncFlags) {
        regs.cf = c.eflags.CF | 0; regs.zf = c.eflags.ZF | 0; regs.sf = c.eflags.SF | 0;
        regs.of = c.eflags.OF | 0; regs.df = c.eflags.DF | 0;
      }
      ...
      try {
        ...
        if (onThrow === "throw") {
          ...
          if (typeof globalThis._missingIndirectHook === "function") {
            globalThis._missingIndirectHook(addr, {
              reason: "js-hook-threw",
              error: String(e?.message || e).slice(0, 240),
              registers: Object.fromEntries(["eax", "ebx", "ecx", "edx", "esi", "edi", "ebp", "esp"]
                .map((name) => [name, c.regs[name] >>> 0])),
              flags: Object.fromEntries(["CF", "ZF", "SF", "OF", "DF"].map((name) => [name, c.eflags[name] | 0])),
            });
          }
          throw e;
        }
      ...
      c.regs.ebp = regs.ebp >>> 0;
      if (syncFlags) {
        c.eflags.CF = regs.cf | 0; c.eflags.ZF = regs.zf | 0; c.eflags.SF = regs.sf | 0;
        c.eflags.OF = regs.of | 0; c.eflags.DF = regs.df | 0;
      }
    });
  };

  // Top-toolbar paint callback. The real startup renders this through
  // callNative, which otherwise enters the binary even though its complete JS
  // body is available. Keep the frozen replay path untouched; __forceInterp
  // remains the direct native oracle used by the regression test.
  if (globalThis.__realStartup) {
    installJsFnEipHook(0x425840, targetHeap => callIndirect(targetHeap, 0x425840), "__forceInterp425840", "throw",
      () => state.promotedLiftedAddresses?.has(0x425840), true);
    // Generated paint depth sort: enable only with a validated promotion.
    installJsFnEipHook(0x433bae, targetHeap => callIndirect(targetHeap, 0x433bae), "__forceInterp433bae", "throw",
      () => state.promotedLiftedAddresses?.has(0x433bae), true);
    installJsFnEipHook(0x4448fb, targetHeap => callIndirect(targetHeap, 0x4448fb), "__forceInterp4448fb", "throw",
      () => state.promotedLiftedAddresses?.has(0x4448fb), true);
    installJsFnEipHook(0x9ba943, targetHeap => callIndirect(targetHeap, 0x9ba943), "__forceInterp9ba943", "throw",
    ...
    installJsFnEipHook(0x5e3ace, hitTestWindowExact, "__forceInterp5e3ace", "throw", undefined, true);
    installJsFnEipHook(0x5e37e6, paintTooltipExact, "__forceInterp5e37e6", "throw", undefined, true);
    installJsFnEipHook(0x5e3861, FUN_005e3861_exact, "__forceInterp5e3861", "throw", undefined, true);
    installJsFnEipHook(0x458678, FUN_00458678_exact, "__forceInterp458678", "throw", undefined, true);
    installJsFnEipHook(0x42afb5, FUN_0042afb5, "__forceInterp42afb5", "warn");
    installJsFnEipHook(0x5e0d3c, FUN_005e0d3c, "__forceInterp5e0d3c", "warn");
    installJsFnEipHook(0x5e0cb6, FUN_005e0cb6, "__forceInterp5e0cb6", "warn", undefined, true);
    installJsFnEipHook(0x5df1ff, FUN_005df1ff, "__forceInterp5df1ff", "warn", undefined, true);
    installJsFnEipHook(0x4501b0, FUN_004501b0, "__forceInterp4501b0", "throw", undefined, true);
    installJsFnEipHook(0x42682d, FUN_0042682d, "__forceInterp42682d", "throw", undefined, true);
    installJsFnEipHook(0x430326, FUN_00430326, "__forceInterp430326", "throw", undefined, true);
    installJsFnEipHook(0x5e2fa0, resetTooltipExact, "__forceInterp5e2fa0", "throw", undefined, true);
    installJsFnEipHook(0x5e5b80, FUN_005e5b80_exact, "__forceInterp5e5b80", "throw", undefined, true);
    installJsFnEipHook(0x5e6a83, FUN_005e6a83_exact, "__forceInterp5e6a83", "throw", undefined, true);
    installJsFnEipHook(0x5e412c, FUN_005e412c_exact, "__forceInterp5e412c", "throw", undefined, true);
    installJsFnEipHook(0x5e4198, FUN_005e4198_exact, "__forceInterp5e4198", "throw", undefined, true);
    installJsFnEipHook(0x5e585a, FUN_005e585a_exact, "__forceInterp5e585a", "throw", undefined, true);
    installJsFnEipHook(0x5e3b2b, FUN_005e3b2b_exact, "__forceInterp5e3b2b", "throw", undefined, true);
    installJsFnEipHook(0x5e3bbf, FUN_005e3bbf_exact, "__forceInterp5e3bbf", "throw", undefined, true);
    installJsFnEipHook(0x5e117d, FUN_005e117d_exact, "__forceInterp5e117d", "warn", undefined, true);
    installJsFnEipHook(0x5e5301, FUN_005e5301_exact, "__forceInterp5e5301", "warn", undefined, true);
    installJsFnEipHook(0x5e5ca6, FUN_005e5ca6_exact, "__forceInterp5e5ca6", "warn", undefined, true);
    installJsFnEipHook(0x5e3f31, createWindowExact, "__forceInterp5e3f31", "throw", canCreateWindowJs, true);
    installJsFnEipHook(0x4271da, FUN_004271da, "__forceInterp4271da", "warn");
    installJsFnEipHook(0x4271bb, FUN_004271bb, "__forceInterp4271bb", "throw", undefined, true);
    installJsFnEipHook(0x5e5bd8, FUN_005e5bd8_exact, "__forceInterp5e5bd8", "throw", undefined, true);
    installJsFnEipHook(0x5e43de, FUN_005e43de_exact, "__forceInterp5e43de", "throw", undefined, true);
    installJsFnEipHook(0x436bc3, FUN_extra_paint_436bc3, "__forceInterp436bc3", "warn");
    installJsFnEipHook(0x436c3d, FUN_extra_paint_436c3d, "__forceInterp436c3d", "warn");
    installJsFnEipHook(0x436cb3, FUN_extra_paint_436cb3, "__forceInterp436cb3", "warn");
    installJsFnEipHook(0x5ddf5d, FUN_extra_paint_5ddf5d, "__forceInterp5ddf5d", "throw", undefined, true);
    installJsFnEipHook(0x5e56d3, FUN_005e56d3, "__forceInterp5e56d3", "warn", undefined, true);
    if (globalThis.__enableTrackerHooks && !globalThis.__disableTrackerHooks) {
      installJsFnEipHook(0x423677, FUN_00423677_exact, "__forceInterp423677", "throw", undefined, true);
      installJsFnEipHook(0x434a94, FUN_00434a94_exact, "__forceInterp434a94", "throw", undefined, true);
      installJsFnEipHook(0x5e4355, FUN_005e4355_exact, "__forceInterp5e4355", "throw", undefined, true);
      installJsFnEipHook(0x5e16f7, FUN_005e16f7, "__forceInterp5e16f7", "throw", undefined, true);
      installJsFnEipHook(0x5e19eb, FUN_005e19eb, "__forceInterp5e19eb", "throw", undefined, true);
      installJsFnEipHook(0x5e1b3e, FUN_005e1b3e, "__forceInterp5e1b3e", "throw", undefined, true);
      installJsFnEipHook(0x5e1bfd, FUN_005e1bfd, "__forceInterp5e1bfd", "throw", undefined, true);
      installJsFnEipHook(0x9bb374, FUN_009bb374, "__forceInterp9bb374", "throw", undefined, true);
    }
    installJsFnEipHook(0x429d41, FUN_00429d41, "__forceInterp429d41", "throw",
      (targetHeap, cpu) => {
        if ((cpu.regs.ebp & 0xffff) !== 2) return false;
        for (let index = 0; index < 0x14; index++) {
          if (targetHeap.u16(0x5f54f0 + index * 2) !== targetHeap.u16(0x5f5518 + index * 2)) return false;
        }
        return true;
      }, true);
    installJsFnEipHook(0x429f6c, FUN_00429f6c, "__forceInterp429f6c", "throw",
      (targetHeap, cpu) => (cpu.regs.edi >>> 0) === 0xffffffff && targetHeap.u8(0x8d7eb8) === 0, true);
  }
  ...
  installJsFnEipHook(0x422a90, FUN_00422a90, "__forceInterp422a90", "interp", undefined, true);
  ...
  // 0x43c751 — peep walking-movement core. The @manual port has been wired
  // for JS callers via state.fnDispatch since ADDENDUM ~66, but fnDispatch is
  // consulted only by callIndirect: callNative and native `call 0x43c751`
  // both ran the original bytes, which is why 0x43c751 was still the most
  // widespread interpreter entry point in the fleet — 18 of 22 parks, 403
  // distinct decoded addresses (ADDENDUM 175). The dominant caller is the
  // JS 0x43a5f8 peep-state handler doing callNative(0x43c751).
  //
  // Validated by tools/_lockstep-43c751.mjs on sc3 (the worst park): 151
  // calls, memMis=0, eaxMis=0 — whole-heap identical per call.
  installJsFnEipHook(0x43c751, FUN_extra_peepwalk_43c751, "__forceInterp43c751", "warn");

  // 0x423ffd — vertical wall / fence / support-column painter, and the
  // largest single interpreter consumer left in the fleet: 20.9% of every
  // decoded instruction on sc3, 29.4% on SC15, 56.7% on SC12. The auto
  // translation had it backwards in three ways (see the port's header); it
  // is now transcribed from asm.
  //
  // syncFlags=true is REQUIRED, not cosmetic: this function returns its
  // result in CF (`stc; ret` vs `and ax,ax; ret`) and preserves EAX at every
  // exit. Verified by tools/_lockstep-batch.mjs on sc3 — 480 calls, memMis=0,
  // eaxMis=0, cfMis=0 (ADDENDUM 175).
  installJsFnEipHook(0x423ffd, FUN_00423ffd, "__forceInterp423ffd", "warn", undefined, true);

  // Three CF-returning helpers. Each was already heap- and EAX-exact and each
  // had been left unwired because tools/_lockstep-batch.mjs could only say
  // "callers consume exit flags"; now that the oracle checks CF, they measure
  // clean and syncFlags carries the result out.
  //
  //   0x5df40c  the primary 32-bit RNG. Exit CF is the MSB of `ror eax,3`;
  //             ZF/SF survive from the preceding `add [0x6e3b88], ebx`. CF was
  //             wrong on 401 of 815 calls. 15 of 22 parks; 6% of SC11.
  //   0x425432  tile probe at (ax,cx): CF wrong on 122 of 122.
  //   0x42547b  the same probe with an extra height test, where BOTH height
  //             comparisons jump to the SUCCESS exit and the fall-through is
  //             the failure path.
  //
  // 0x425432 and 0x42547b also each had `mov word [0x991efc], 0x6a9` emitted
  // as setU32 — the ADDENDUM 173 width class, latent rather than measured.
  installJsFnEipHook(0x5df40c, FUN_005df40c, "__forceInterp5df40c", "warn", undefined, true);
  installJsFnEipHook(0x425432, FUN_00425432, "__forceInterp425432", "warn", undefined, true);
  installJsFnEipHook(0x42547b, FUN_0042547b, "__forceInterp42547b", "warn", undefined, true);

  // 0x458a7c — measureStringWidth, the text engine's inner loop: 8.7% of every
  // decoded instruction on sc8 and 5.3% on sc3, in 42 bytes. The @manual port
  // has been correct since it was written; it was never wired because
  // tools/_lockstep-batch.mjs boots without painting the UI and reported it
  // NOT-REACHED. tools/_lockstep-real.mjs, which boots the way the profiler
  // and the gates do, measures 182 calls memMis=0 eaxMis=0 cfMis=0
  // (ADDENDUM 175).
  installJsFnEipHook(0x444bd4, FUN_00444bd4, "__forceInterp444bd4", "throw", undefined, true);
  installJsFnEipHook(0x444c74, FUN_00444c74, "__forceInterp444c74", "throw", undefined, true);
  installJsFnEipHook(0x444d1f, FUN_00444d1f, "__forceInterp444d1f", "throw", undefined, true);
  installJsFnEipHook(0x5e5496, FUN_005e5496, "__forceInterp5e5496", "throw", undefined, true);
  installJsFnEipHook(0x45a930, FUN_0045a930, "__forceInterp45a930", "throw", undefined, true);
  installJsFnEipHook(0x45a95d, FUN_0045a95d, "__forceInterp45a95d", "throw", undefined, true);
  installJsFnEipHook(0x429c3d, FUN_00429c3d, "__forceInterp429c3d", "throw", undefined, true);
  installJsFnEipHook(0x458a7c, FUN_00458a7c, "__forceInterp458a7c", "warn", undefined, true);

  // 0x458bcf / 0x458c14 — format_string's entry and its walk loop. Both were
  // heap-exact with ESI, EDI and CF already matching; the only divergence was
  // EAX, and it had ONE cause: 0x458bcf's user-string branch left the slot
  // INDEX where the binary leaves the walked POINTER. Because a nested
  // user-string expansion returns into the walk loop, whose `mov al, [esi]`
  // touches only AL, those upper 24 bits ride out to the outermost caller —
  // so one wrong assignment showed up as eaxMis on every call of both
  // functions. Fixing it cleared both at once: 218/218 memMis=0 eaxMis=0
  // cfMis=0 on sc8 (ADDENDUM 176).
  installJsFnEipHook(0x458bcf, FUN_00458bcf, "__forceInterp458bcf", "warn", undefined, true);
  installJsFnEipHook(0x458c14, FUN_00458c14, "__forceInterp458c14", "warn", undefined, true);
  ...
  // Toolbar dispatch/refresh uses exact JS flags during real startup;
  // unported action continuations retain the existing development fallback.
  installJsFnEipHook(0x42a830, FUN_0042a830, "__forceInterp42a830", "warn", undefined, !!globalThis.__realStartup);
  ...
  installJsFnEipHook(0x5e2b52, FUN_005e2b52, "__forceInterp5e2b52", globalThis.__realStartup ? "throw" : "warn", undefined, !!globalThis.__realStartup);

  installJsFnEipHook(0x5e3652, globalThis.__realStartup ? showTooltipRuntime : FUN_005e3652,
    "__forceInterp5e3652", globalThis.__realStartup ? "throw" : "warn", undefined, !!globalThis.__realStartup);
...
// Run `body()` with a one-shot eip hook installed at `addr`, restoring whatever
// was there before. Used by the widget-loop port to execute a single un-ported
// jumptable handler through the real bytes: those handlers reach the loop only
// by `jmp 0x5e52a7`, so hooking that address makes the tail-jump unwind to
// runFunction's sentinel instead of re-running the whole loop interpreted.
export function hookOnce(addr, hookFn, body) {
  const a = addr >>> 0;
  const prev = getEipHook(a);
  setEipHook(a, hookFn);
  try { return body(); }
  finally { if (prev) setEipHook(a, prev); else clearEipHook(a); }
}
...
export function callNative(addr, args = []) {
  ...
  if (state.executionMode === "pure-js") {
    throw new Error(`pure-js interpreter fallback 0x${(addr >>> 0).toString(16)}`);
  }
  if (!_callNativeImpl) {

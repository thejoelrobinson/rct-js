  ...
  if ((unaff_EBX & 0x20000000) == 0) {
    if ((unaff_EBX & 0x40000000) == 0) {
      ...
      if (bVar3 != 0) {
        ...
        uVar5 = DAT_009a2028 & 3;
        if (DAT_009a2028 >> 2 != 0) {
          uVar10 = (uint)(DAT_009a2028 >> 2);
          uVar7 = uVar10;
LAB_009b8843:
          do {
            if (*unaff_ESI != 0) {
            ...
            if (sVar6 != 1) {
              ...
              if (sVar6 != 2) {
                ...
                if (sVar6 != 3) {
                  ...
                  pbVar11 = unaff_ESI;
                  pbVar12 = unaff_EDI;
                  if ((ushort)(sVar6 - 4U) != 0) goto LAB_009b8843;
                }
              }
            }
            unaff_ESI = pbVar11 + in_EDX + (uint)uVar4 * 3 + (uint)uVar5;
    ...
    else if (((_DAT_009a201c & 1) != 0) && (bVar3 >> 2 != 0)) {
      uVar4 = DAT_009a2028 + sVar6;
      uVar5 = DAT_009a2028 & 3;
      if (DAT_009a2028 >> 2 != 0) {
        _DAT_009a2028 = CONCAT22(DAT_009a2028_2,DAT_009a2028 >> 2);
      ...
      if (DAT_009a2028 >> 2 != 0) {
        ...
        do {
          ...
          do {
            ...
            if ((short)(sVar6 + -2) == 0) break;
            pbVar11 = unaff_ESI + 0xc;
            bVar3 = *(byte *)((uint)unaff_ESI[8] + iVar2);
            if (bVar3 != 0) {
              unaff_EDI[2] = bVar3;
            }
            iVar8 = CONCAT22(uVar9,sVar6 + -3);

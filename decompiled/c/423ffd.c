...
LAB_004243dd:
    ...
    if (uVar4 < *(ushort *)(&DAT_00991f04 + unaff_EBX * 4)) {
      ...
      if ((short)uVar2 < 0) goto LAB_004243dd;
      iVar8 = DAT_00991f88 * 2;
      uVar7 = (uint)(byte)(&DAT_005f419a)[unaff_EBX * 8 + iVar8];
      if ((((uVar2 <= *(ushort *)(&DAT_00991f04 + uVar7 * 4)) &&
           (uVar7 = (uint)*(byte *)(iVar8 + 0x5f41e2 + unaff_EBX * 8),
           uVar2 <= *(ushort *)(&DAT_00991f04 + uVar7 * 4))) &&
          (uVar7 = (uint)*(byte *)(iVar8 + 0x5f422a + unaff_EBX * 8),
          uVar2 <= *(ushort *)(&DAT_00991f04 + uVar7 * 4))) &&
         (uVar7 = (uint)*(byte *)(iVar8 + 0x5f4272 + unaff_EBX * 8),
         uVar2 <= *(ushort *)(&DAT_00991f04 + uVar7 * 4))) {
        return CONCAT44(in_EDX,in_EAX);
      }

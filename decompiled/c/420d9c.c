...

{
  ...
  uVar9 = DAT_00991f74 + *(short *)(&DAT_005f4686 + DAT_00991f88 * 4);
  if (((ushort)(DAT_00991f70 + *(short *)(&DAT_005f4684 + DAT_00991f88 * 4)) < 0x1000) &&
     (uVar9 < 0x1000)) {
    uVar9 = uVar9 * 0x80 | uVar9 >> 9 | DAT_00991f70 + *(short *)(&DAT_005f4684 + DAT_00991f88 * 4);
  ...
  bVar3 = cVar4 + (&DAT_005f46a4)[uVar11];

...
int FUN_00416d00(LCID param_1,uint param_2,LPCSTR param_3,LPCWSTR param_4,LPWSTR param_5,int param_6
...

{
  ...
  iVar1 = (int)param_4;
  if (0 < (int)param_4) {
    iVar1 = FUN_00416f30(param_3,param_4);
  }
  if (DAT_005f0264 == 2) {
  ...
  if ((iVar1 != 0) &&
    ...
    if ((param_2 & 0x400) == 0) {
      param_4 = (LPCWSTR)FUN_004133c0(iVar1 * 2);
      ...
      if (param_6 == 0) goto LAB_00416e6f;
      if (param_6 < iVar1) goto LAB_00416f08;
      iVar2 = LCMapStringW(param_1,param_2,lpWideCharStr,iVar2,param_5,param_6);
    }
    if (iVar2 != 0) {
LAB_00416e6f:
      FUN_00413470(lpWideCharStr);
      FUN_00413470(param_4);
      return iVar1;
    }
  }
LAB_00416f08:

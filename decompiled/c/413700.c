...
uint FUN_00413700(uint param_1)

{
  ...
  if (DAT_005f0270 == 0) {
    ...
    if ((int)param_1 < 0x100) {
      if (DAT_005ee754 < 2) {
        uVar2 = (byte)PTR_DAT_005ee548[param_1 * 2] & 2;
      }
      else {
        uVar2 = FUN_00416f60(param_1,2);
      }
      if (uVar2 == 0) {
        return uVar1;
      }
    ...
    iVar4 = FUN_00416d00(DAT_005f0270,0x200,&param_1,uVar3,local_8,3,0,1);
    if (iVar4 == 0) {
      return uVar1;
    }
    if (iVar4 == 1) {

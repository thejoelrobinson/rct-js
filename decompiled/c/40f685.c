...
undefined4 FUN_0040f685(undefined4 *param_1,int param_2,int param_3)

{
  ...
  if (param_1[0x22] == 0) {
    ...
    for (local_10 = 0; local_10 < 0x100; local_10 = local_10 + 1) {
      *(undefined *)(iVar1 + 0x2a + local_10 * 4) = (&DAT_005ef6aa)[local_10 * 4];
      *(undefined *)(iVar1 + 0x29 + local_10 * 4) = (&DAT_005ef6a9)[local_10 * 4];
      *(undefined *)(iVar1 + 0x28 + local_10 * 4) = (&DAT_005ef6a8)[local_10 * 4];
    ...
    *(undefined2 *)((int)puVar2 + 0xe) = 8;
    ...
    if (hdc == (HDC)0x0) {
      ...
      if (DAT_005ec0d8 == (HPALETTE)0x0) {
        local_20 = (HPALETTE)0x0;
      }
      else {
        local_20 = SelectPalette(hdc,DAT_005ec0d8,1);
      }

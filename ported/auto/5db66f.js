...
export function FUN_005db66f(heap) {
  ...
  sVar1 = CONCAT11(heap, ((ushort)(heap.u32((unaff_ESI + 0x10)) + heap.u32((__addr_DAT_0065247a) + ((heap.u32((byte)(__addr_DAT_008874a1) + (iVar6) * 4) & 3) * 2) * 4)) >>> 5), ((ushort)(heap.u32((unaff_ESI + 0xe)) + heap.u32((__addr_DAT_00652478) + ((heap.u32((byte)(__addr_DAT_008874a1) + (iVar6) * 4) & 3) * 2) * 4)) >>> 5));
  ...
  if (uVar7 != extraout_ECX) {
    ...
    bVar10 = CARRY2(heap, heap.u32((unaff_ESI + 0x3a)), heap.u32((__addr_DAT_0065247a) + (uVar7 * 2) * 4));
  ...
  if (uVar8 != uVar3) {
    ...
    bVar10 = CARRY2(heap, heap.u32((unaff_ESI + 0x3a)), heap.u32((__addr_DAT_0065247a) + (uVar8 * 2) * 4));
    FUN_005db615(heap);

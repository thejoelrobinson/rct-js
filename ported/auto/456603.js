...
export function FUN_00456603(heap) {
  ...
  if (((heap.u32((unaff_ESI + 0xc6)) & 8) != 0) && (0xb < heap.u32((unaff_ESI + 0xe2)))) {
    if ((heap.u32((unaff_ESI + 0x29)) & 0x18) == 0) {
      ...
      pbVar5 = heap.u32((0x00971ef4) + ((ushort)(uVar3 >>> 5 | uVar3 << 0xb)) * 4);
      ...
      if ((heap.u32((unaff_ESI + 0x29)) & 4) == 0) {
        ...
        if ((heap.u32(pbVar5 + (4) * 4) & 0x1f) != heap.u32((0x00630b41) + (heap.u32((unaff_ESI + 0x29)) & 3) * 4)) {
        return 0xffffffff;
      }
      }
    }
    ...
    if ((heap.u32(0x00632f08) >>> uVar2 & 1) != 0) {
      uVar4 = heap.u32((unaff_ESI + 0x24)) + heap.u32((0x00652478) + (uVar2 * 2) * 4);
      uVar3 = heap.u32((unaff_ESI + 0x26)) + heap.u32((0x0065247a) + (uVar2 * 2) * 4);

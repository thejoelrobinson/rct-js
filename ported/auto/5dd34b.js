...
import { CARRY2, CONCAT11, CONCAT31, LOCK, UNLOCK } from "../runtime/win32.js";
...
export function FUN_005dd34b(heap) {
  ...
  uVar15 = (uint)(ushort)(bVar20 * bVar1);
  uVar5 = FUN_00444d07(heap);
  if ((ushort)(bVar20 * bVar1) <= uVar5) {
    if ((unaff_EBX & 1) != 0) {
      uVar5 = extraout_CX;
      if (heap.u32(unaff_ESI + (4) * 4) == 8) {
        uVar6 = in_EAX - heap.u32((0x00652478) + ((heap.u32(unaff_EDI) & 3) * 2) * 4);
        in_EAX = uVar6;
        uVar5 = extraout_CX - heap.u32((0x0065247a) + ((heap.u32(unaff_EDI) & 3) * 2) * 4);
        pbVar16 = unaff_EDI + 2;
        uVar6 = uVar5 * 0x80 | uVar5 >>> 9 | uVar6;
        for (unaff_EDI = heap.u32((0x00971ef4) + ((ushort)(uVar6 >>> 5 | uVar6 << 0xb)) * 4); (heap.u32(pbVar16) != heap.u32(unaff_EDI + (2) * 4) || ((heap.u32(unaff_EDI) & 0x3c) != 8)); unaff_EDI = unaff_EDI + 8) {
      ...
      do {
        ...
        do {
          ...
          uVar12 = heap.u32((0x005f6f1c + iVar7 * 8));
          uVar13 = uVar12 >>> 10;
          heap.u32((pbVar17 + 0x44)) = uVar13;
          uVar12 = (uVar13 << 10 | uVar12 & 0x3ff) >>> 1;
          iVar14 = iVar14 - uVar12;
          heap.u32((pbVar17 + 0x24)) = iVar14;
          if ((heap.u32((0x005f7104 + iVar7 * 8)) & 0x4000) == 0) {
            iVar14 = iVar14 - uVar12;
          }
          heap.u32(pbVar17 + (0x14) * 4) = heap.u32((0x005f7106) + (iVar7 * 8) * 4);
          heap.u32(pbVar17 + (9) * 4) = heap.u32((0x005f7107) + (iVar7 * 8) * 4);
          heap.u32(pbVar17 + (0x15) * 4) = heap.u32((0x005f7108) + (iVar7 * 8) * 4);
          heap.u32((pbVar17 + 0x46)) = heap.u32((0x005f6f20 + iVar7 * 8));
          heap.u32(pbVar17 + (0xb2) * 4) = heap.u32((0x005f6f23) + (iVar7 * 8) * 4);
          heap.u32(pbVar17 + (0xc2) * 4) = heap.u32((0x005f7109) + (iVar7 * 8) * 4);
          heap.u32(pbVar17 + (0xc3) * 4) = heap.u32((0x005f710a) + (iVar7 * 8) * 4);
          ...
          local_24 = in_EAX;
          if ((heap.u32((0x005f7104 + iVar7 * 8)) & 0x8000) == 0) {
            bVar20 = (heap.u32((0x005f7104 + iVar7 * 8)) & 0x1000) != 0;
            if (((heap.u32((0x005f7104 + iVar7 * 8)) & 0x4000) != 0) && (bVar20 = 5, (uVar9 & 0x100) == 0)) {
              bVar20 = 6;
            }
            ...
            FUN_00444927(heap);
            heap.u32((pbVar17 + 0x36)) = CONCAT31(heap, (int3)((heap.u32(unaff_EDI + (4) * 4) << 2) >>> 8), (byte)(heap.u32(unaff_EDI + (4) * 4) << 2) | heap.u32(pbVar17 + (0x1e) * 4) >>> 3);
            ...
            sVar2 = heap.u32((0x0065ea84 + (heap.u32(unaff_EDI) & 3) * 4));
            sVar3 = heap.u32((0x0065ea86 + (heap.u32(unaff_EDI) & 3) * 4));
            ...
            heap.u32(pbVar17 + (0x4b) * 4) = (heap.u32(unaff_EDI + (5) * 4) & 0x70) >>> 4;
            uVar13 = (uint)(ushort)(bVar20 * 4 + heap.u32((0x005f5d02) + ((uint) * unaff_ESI * 8) * 4));
            ...
            do {
              ...
              bVar19 = CARRY2(heap, (ushort)((uVar8 & 0xffffff1e) >>> 0x15) & 0xff, local_24 + sVar2);
              FUN_005dcfee(heap);
            } while (bVar19);
            FUN_00444927(heap);
          }
          ...
          if (heap.u32(0x0065dc4e) != 0xffff) {
            heap.u32((0x00743bd6 + heap.u32(0x0065dc4e) * 0x100)) = heap.u32((pbVar17 + 10));
          }
          LOCK(heap);
          UNLOCK(heap);
          if (heap.u32(0x0065dc4e) == 0xffff) {
      ...
      if (((heap.u32((0x005f5b78 + (uint) * unaff_ESI * 8)) & 0x10000) == 0) && (heap.u32(unaff_ESI) != 0x29)) {
        uVar15 = CONCAT11(heap, heap.u32(unaff_ESI + (0x78) * 4), bVar20);
        iVar14 = 0;
        do {
          puVar18 = 0x00743b94 + (uint) * (unaff_ESI + iVar14 * 2 + 0x5e) * 0x100;
          if ((heap.u32((0x005f7104 + heap.u32((uint)(byte)(0x00743bc5) + ((uint) * (unaff_ESI + iVar14 * 2 + 0x5e) * 0x100) * 4) * 8)) & 0x8000) == 0) {
            FUN_005dbeeb(heap);
          }
          while (true) {
            ...
            puVar18 = 0x00743b94 + (uint) * (puVar18 + 0x3e) * 0x100;
          }
          iVar14 = iVar14 + 1;
          bVar20 = (uVar15 >>> 8) - 1;
          uVar15 = bVar20 << 8;

...
export function FUN_005db817(heap) {
  ...
  if (((heap.u32((__addr_DAT_00887422) + (uVar6 * 0x130) * 4) & 0xc0) == 0) || (heap.u32((__addr_DAT_0088755c) + (uVar7) * 4) != '\0')) {
    if (((heap.u32(0x0088741c) & 1) == 0) || (heap.u32((unaff_ESI + 0x34)) == '\0')) {
      ...
      heap.setU32((unaff_ESI + 0x1e), (heap.u32((unaff_ESI + 0x1e)) + '\x02') >>> 0);
      if ((heap.u32((unaff_ESI + 0x35)) & 0x40) != 0) {
        heap.setU32((unaff_ESI + 0x1e), (heap.u32((unaff_ESI + 0x1e)) + -4) >>> 0);
      }
    } else {
      if (heap.u32((unaff_ESI + 0x34)) < '\0') {
      heap.setU32((unaff_ESI + 0x34), (heap.u32((unaff_ESI + 0x34)) + '\x01') >>> 0);
      heap.setU32((unaff_ESI + 0x1e), (heap.u32((unaff_ESI + 0x1e)) + -2) >>> 0);
    } else {
      heap.setU32((unaff_ESI + 0x34), (heap.u32((unaff_ESI + 0x34)) + -1) >>> 0);
      heap.setU32((unaff_ESI + 0x1e), (heap.u32((unaff_ESI + 0x1e)) + '\x02') >>> 0);
    }
    }
    heap.setU32((unaff_ESI + 0x1e), (heap.u32((unaff_ESI + 0x1e)) & 0x1e) >>> 0);
    FUN_005e53ca(heap);
  }
  LAB_005db8c7: if (heap.u32((unaff_ESI + 0xc4)) != '\0') {
    bVar1 = heap.u32((unaff_ESI + 0xc4));
    heap.setU32((unaff_ESI + 0xc4), (0) >>> 0);
    uVar6 = bVar1 & 0x1e;
  ...
  heap.setU32((unaff_ESI + 0x24), (iVar4) >>> 0);
  if (0x3689 < iVar4) {
    ...
    FUN_005e53ca(heap);
    while (true) {
      heap.setU32((unaff_ESI + 0x35), (heap.u32((unaff_ESI + 0x35)) + '\x01') >>> 0);
      ...
      heap.setU32((unaff_ESI + 0x24), (heap.u32((unaff_ESI + 0x24)) - heap.u32((__addr_DAT_0065e6c0 + uVar6 * 8))) >>> 0);
    ...
    if (uVar7 == -1) {
      heap.setU32((unaff_ESI + 0x34), (6) >>> 0);
      uVar6 = FUN_005df40c(heap);
      if ((uVar6 & 0x20000000) != 0) {
        heap.setU32((unaff_ESI + 0x34), (0xfa) >>> 0);
      }
      if (0x1ffff < extraout_ECX_00) {
        heap.setU32((unaff_ESI + 0xc4), (extraout_DL_00 ^ 0x10) >>> 0);
      }
    } else {
      heap.setU32((unaff_ESI + 0x34), (1) >>> 0);
      uVar6 = FUN_005df40c(heap);
      if ((uVar6 & 0x400000) != 0) {
        heap.setU32((unaff_ESI + 0x34), (0xff) >>> 0);
      }
      if (0x1ffff < extraout_ECX) {
        heap.setU32(((__addr_DAT_00743c58) + ((uVar7 & 0xffff) * 0x100) * 4), (extraout_DL) >>> 0);
        heap.setU32((unaff_ESI + 0xc4), (extraout_DL ^ 0x10) >>> 0);
      }
    }
  ...
  heap.setU32((unaff_ESI + 0x2c), (iVar4) >>> 0);

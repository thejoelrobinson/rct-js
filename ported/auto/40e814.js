...
export function FUN_0040e814(heap, param_1, param_2, param_3) {
  ...
  if (heap.u32(param_1 + (0x22) * 4) == 0) {
    ...
    for (local_10 = ((0) >>> 0); local_10 < 0x100; local_10 = (((local_10 + 1) >>> 0)) >>> 0) {
      heap.setU8((iVar1 + 0x2a + local_10 * 4), (heap.u32((0x005eee9a) + (local_10 * 4) * 4)) & 0xff);
      heap.setU8((iVar1 + 0x29 + local_10 * 4), (heap.u32((0x005eee99) + (local_10 * 4) * 4)) & 0xff);
      heap.setU8((iVar1 + 0x28 + local_10 * 4), (heap.u32((0x005eee98) + (local_10 * 4) * 4)) & 0xff);

...
import { SBORROW4 } from "../runtime/win32.js";
...
export function FUN_004429db(heap) {
  ...
  let unaff_EBX = 0;
  let bVar3 = 0;
  uVar2 = ((uint)(0x0070093a - heap.u32(0x0087c3b4)) >>> 5 | (0x0070093a - heap.u32(0x0087c3b4)) * 0x8000000) - heap.u32(0x0087c3b8);
  ...
  if (heap.u32(0x0099c163) == '\0') {
    bVar3 = SBORROW4(heap, heap.u32(0x0087c3b4), unaff_EBX);

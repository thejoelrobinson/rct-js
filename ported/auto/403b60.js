...
export function FUN_00403b60(heap) {
  ...
  if ((heap.u32(0x005e91c0) != 0) && (heap.u32(0x005f1140) == 0)) {
    ...
    heap.setU32(__addr_local_8, ((heap.u32((__addr_local_18 + 12)) - heap.u32((__addr_local_18 + 4)) >>> 1) + heap.u32((__addr_local_18 + 4))) >>> 0);
    heap.setU32(0x005f14c4, (0) >>> 0);
    heap.setU32(0x005f1b20, (0) >>> 0);
    SetCursorPos(heap, (heap.u32((__addr_local_18 + 8)) - heap.u32(__addr_local_18) >>> 1) + heap.u32(__addr_local_18), heap.u32(__addr_local_8));
  }
  return;
} finally {
    heap.freeFrame(128);

...
export function FUN_005e3c3c(heap) {
  ...
  while (puVar9 != puVar2) {
    heap.u32((puVar2 + 0x177)) = heap.u32((puVar2 + -1));
    puVar2 = (puVar2 + -1);
  }
  ...
  uVar5 = (undefined4)(uVar12 >>> 0x20);
  heap.u32((puVar9 + 0xc)) = 0;
  heap.u32(puVar9 + (8) * 4) = uVar12;
  heap.u32(puVar9 + (9) * 4) = uVar8;
  heap.u32(puVar9 + (2) * 4) = 0;
  heap.u32(puVar9 + (1) * 4) = uVar5;
  heap.u32(puVar9) = unaff_EBP;
  heap.u32(puVar9 + (3) * 4) = 0;
  heap.u32(puVar9 + (4) * 4) = 0;
  heap.u32(puVar9 + (5) * 4) = 0;
  heap.u32(puVar9 + (6) * 4) = 0;
  heap.u32((puVar9 + 0x15a)) = 0;
  heap.u32((puVar9 + 0x57)) = 0;
  heap.u32((puVar9 + 0x15e)) = 0;
  heap.u32((puVar9 + 0x58)) = 0;
  heap.u32((puVar9 + 0x162)) = 0;
  heap.u32((puVar9 + 0x59)) = 0;
  heap.u32((puVar9 + 0x166)) = 0;
  heap.u32((puVar9 + 0x5a)) = 0;
  heap.u32((puVar9 + 0x16a)) = 0;
  heap.u32((puVar9 + 0x5b)) = 0;

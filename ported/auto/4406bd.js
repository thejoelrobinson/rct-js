...
export function FUN_004406bd(heap) {
  ...
  if (in_AL == 0) {
    ...
    uVar1 = 0x5bf;
    if ((heap.u32((__addr_DAT_005f5b78 + heap.u32((uint)(byte)(__addr_DAT_00887420) + (uVar2 * 0x260) * 4) * 8)) & 0x400000) != 0) {
      uVar1 = 0x5c0;
    }
    heap.setU32(0x0062d2de, (CONCAT22(heap, heap.u32((__addr_DAT_00887442) + (uVar2 * 0x130) * 4), uVar1)) >>> 0);
  ...
  if (in_AL != 1) {
    ...
    heap.setU32(0x0062d2fa, (1) >>> 0);
    heap.setU32(0x0062d2de, (CONCAT22(heap, heap.u32((__addr_DAT_00887442) + ((unaff_EBX & 0xff) * 0x130) * 4), 0xffff)) >>> 0);
  ...
  heap.setU32(0x0062d2fa, (0) >>> 0);
  heap.setU32(0x0062d2de, (CONCAT22(heap, heap.u32((__addr_DAT_00887442) + ((unaff_EBX & 0xff) * 0x130) * 4), 0x5be)) >>> 0);
  heap.setU32(0x0062d2e2, (heap.u32((__addr_DAT_00887444) + ((unaff_EBX & 0xff) * 0x98) * 4)) >>> 0);
  heap.setU32(0x0062d2fc, (0xffff) >>> 0);
  heap.setU32(0x0062d2fe, (0) >>> 0);
  heap.setU32(0x0062d2ff, (0) >>> 0);

...
export function FUN_00403d79(heap, param_1, param_2, param_3, param_4) {
  ...
  if (heap.u32(0x005e9168) != 0) {
    (regs.eax = FUN_004059dd(heap, param_2, param_3, param_4));
  }
  sVar1 = ((((param_4) << 16 >> 16)) & 0xffff);
  sVar2 = (((((param_4 >>> 0x10)) << 16 >> 16)) & 0xffff);
  if (param_2 < 0x10) {
    if (param_2 == 0xf) {
    ...
    if (param_2 < 0x15) {
      ...
      if (param_2 < 0x25) {
      if (param_2 == 0x24) {
        heap.setU32((param_4 + 0x18), (heap.u32(0x005f1a04)) & 0xffffffff);
      ...
      if (param_2 == 0x20) {
        switch (param_4 & 0xffff) {
          case 1:
            break switchD_004041f1_caseD_1;
          case 2:
          case 3:
          case 10:
          case 0xb:
      ...
      if (param_2 == 0x311) {
        ...
        /* goto LAB_00404234 — unsupported, early-return */ if (typeof globalThis._gotoWarn !== 'undefined') globalThis._gotoWarn("FUN_00403d79/LAB_00404234"); return 0;
      }
      if (param_2 == 0x400) {
        switch (param_4) {
          case 0x201:

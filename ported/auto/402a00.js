...
export function FUN_00402a00(heap) {
  let iVar1 = 0;
  let uVar2 = 0;
  iVar1 = (heap.u32(heap.u32(0x005ebe5c)))(heap.u32(0x005e9100));
  if (iVar1 == 0) {
    ...
    heap.setU32(0x005f2400, (heap.u32((heap.u32(0x005e9100) + 6))) >>> 0);
    heap.setU32(0x005f1ff0, (heap.u32((heap.u32(0x005e9100) + 2))) >>> 0);

...
export function FUN_004533d0(heap) {
  ...
  if ((((heap.u32(0x006323f4) | 0) != -1) && (heap.u8(0x006326bc) == 0)) && ((heap.u8(0x006326bd) & 1) != 0)) {
    ...
    LAB_00453459_skip: {
      ...
      // asm 0x453439: mov byte ptr [0x632404], 0 — 8-bit (0x453433 mov [0x632400], esi IS a dword).
      heap.setU8(0x00632404, (0) & 0xff);
      heap.setU32(0x00632400, (puVar14) >>> 0);
      // asm 0x453447: mov byte ptr [0x632404], 0x23 / 0x453452: mov byte ptr [0x632404], 0x46
      // — 8-bit. The u32 form zeroed 0x632405..07 (0x632408 is a separate dword written
      // immediately after at 0x453459).
      if ((heap.i8((iVar17 + 0x10)) != 0) && (heap.setU8(0x00632404, (0x23) & 0xff), heap.i8((iVar17 + 0x10)) != 1)) {
        heap.setU8(0x00632404, (0x46) & 0xff);
      }
    }

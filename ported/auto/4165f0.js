...
export function FUN_004165f0(heap, param_1, param_2, param_3) {
  ...
  heap.setU32((param_2 + (1) * 4), (iVar1 + -1) >>> 0);
  if (iVar1 + -1 < 0) {
    param_1 = FUN_00415b30(heap, param_1, param_2);
  } else {
    heap.setU32(heap.u32(param_2), (param_1) >>> 0);
    param_1 = param_1 & 0xff;
    heap.setU32(param_2, (heap.u32(param_2) + 1) >>> 0);
  }
  if (param_1 == 0xffffffff) {
    heap.setU32(param_3, (-1) >>> 0);
    return;
  }
  heap.setU32(param_3, (heap.u32(param_3) + 1) >>> 0);
  return;
}

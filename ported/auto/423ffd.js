...
export function FUN_00423ffd(heap) {
  ...
  if ((heap.u32(0x00991f8c) & 8) == 0) {
    ...
    if (uVar4 < heap.u16((0x00991f04 + unaff_EBX * 4))) {
      ...
      if (((uVar2) << 16 >> 16) < 0) {
        /* goto LAB_004243dd — unsupported, early-return */ if (typeof globalThis._gotoWarn !== 'undefined') globalThis._gotoWarn("FUN_00423ffd/LAB_004243dd"); return 0;
      }
      iVar8 = ((heap.u8(0x00991f88) * 2) >>> 0);
      uVar7 = ((heap.u32(((0x005f419a) >>> 0) + (unaff_EBX * 8 + iVar8) * 4)) >>> 0);
      if ((((uVar2 <= heap.u16((0x00991f04 + uVar7 * 4))) && (uVar7 = ((heap.u32((iVar8 + 0x5f41e2 + unaff_EBX * 8))) >>> 0), uVar2 <= heap.u16((0x00991f04 + uVar7 * 4)))) && (uVar7 = ((heap.u32((iVar8 + 0x5f422a + unaff_EBX * 8))) >>> 0), uVar2 <= heap.u16((0x00991f04 + uVar7 * 4)))) && (uVar7 = ((heap.u32((iVar8 + 0x5f4272 + unaff_EBX * 8))) >>> 0), uVar2 <= heap.u16((0x00991f04 + uVar7 * 4)))) {
        return 1;
      }

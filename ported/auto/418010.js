...
import { SUB41 } from "../runtime/win32.js";
...
export function FUN_00418010(heap, param_1) {
  ...
  if (heap.u32(0x005f0270) == 0) {
    if ((0x40 < heap.u32(__addr_param_1)) && (heap.u32(__addr_param_1) < 0x5b)) {
      return heap.u32(__addr_param_1) + 0x20;
    }
  } else {
    if (heap.u32(__addr_param_1) < 0x100) {
      if (heap.u32(0x005ee754) < 2) {
        uVar2 = heap.u32(heap.u32(0x005ee548) + (heap.u32(__addr_param_1) * 2) * 4) & 1;
      } else {
        uVar2 = FUN_00416f60(heap, heap.u32(__addr_param_1), 1);
      }
      if (uVar2 == 0) {
        return uVar1;
      }

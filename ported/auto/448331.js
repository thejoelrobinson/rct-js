...
export function FUN_00448331(heap) {
  ...
  uVar11 = 0;
  LAB_00448339: uVar9 = CONCAT21(heap, (uVar7 >>> 0x10), heap.u32(unaff_ESI));
  uVar2 = uVar9 & 0xffff3c;
  iVar8 = uVar2 << 8;
  bVar10 = uVar11;
  if ((uVar2 == '\x04') && ((heap.u32(unaff_ESI + (4) * 4) & 4) != 0)) {
    uVar12 = CONCAT31(heap, uVar9, heap.u32(unaff_ESI + (4) * 4)) & 0xffff3c03;
    uVar9 = (uint3)(uVar12 >>> 8);
    bVar6 = uVar12 - bVar10;
    uVar7 = CONCAT31(heap, uVar9, bVar6);
    if ((bVar6 & 1) == 0) {
      iVar8 = uVar9 << 8;
      if ((heap.u32(unaff_ESI + (4) * 4) & 3) == bVar10) {
        iVar8 = CONCAT31(heap, uVar9, 4);
      }

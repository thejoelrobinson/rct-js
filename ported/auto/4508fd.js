...
export function FUN_004508fd(heap) {
  ...
  let unaff_EBX = 0;
  let unaff_ESI = 0;
  uVar3 = heap.u32(0x008ae93e) + heap.u32((0x0065247a) + (unaff_EBX * 2) * 4);
  if (((ushort)(heap.u32(0x008ae93c) + heap.u32((0x00652478) + (unaff_EBX * 2) * 4)) < 0x1000) && (uVar3 < 0x1000)) {
    uVar3 = uVar3 * 0x80 | uVar3 >>> 9 | heap.u32(0x008ae93c) + heap.u32((0x00652478) + (unaff_EBX * 2) * 4);

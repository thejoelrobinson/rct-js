...
export function FUN_0040ecdc(heap, param_1, param_2, param_3, param_4, param_5) {
  ...
  if ((heap.i32((param_1 + 0x90)) == 0) && (heap.i32((param_3 + 0x90)) != 0)) {
    ...
    if (bVar1) {
      ...
      StretchDIBits(heap, hdc, param_4, param_5, heap.u32(param_2 + (2) * 4) - heap.u32(param_2), heap.u32(param_2 + (3) * 4) - heap.u32(param_2 + (1) * 4), heap.u32(param_2), ((heap.i16((param_1 + 8))) >>> 0) - heap.u32(param_2 + (3) * 4), heap.u32(param_2 + (2) * 4) - heap.u32(param_2), heap.u32(param_2 + (3) * 4) - heap.u32(param_2 + (1) * 4), heap.u32((param_1 + 0x84)), heap.u32((param_1 + 0x88)), 0, 0xcc0020);

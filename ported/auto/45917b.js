...
// Source: decompiled/c/45917b.c
// Edit by hand only after diff-test passes — re-running the translator will overwrite.

/** @typedef {import("../../runtime/heap.js").Heap} Heap */

import { regs } from "../../runtime/regs.js";
export function FUN_0045917b(heap) {
  let uVar1 = 0;
  ...
  if ((bVar2 | 0x30) != 0x30) {
    heap.setU32(unaff_EDI, (bVar2) & 0xffffffff);
    unaff_EDI = ((unaff_EDI + 1) >>> 0);
  }
  bVar3 = ((0x30) & 0xff);
  ...
  bVar2 = ((bVar2 | 0x30 | bVar3) & 0xff);
  if (bVar2 != 0x30) {
    heap.setU32(unaff_EDI, (bVar3) & 0xffffffff);
    heap.setU8((unaff_EDI + (1)), (0x2c) & 0xff);
  ...
  heap.setU32(unaff_EDI, (bVar2) & 0xffffffff);
  heap.setU8((unaff_EDI + (1)), (0x2e) & 0xff);
  bVar2 = ((0x30) & 0xff);
  while (true) {
    if (uVar1 < 10) {
      break;
  ...
  heap.setU8((unaff_EDI + (2)), (bVar2) & 0xff);
  heap.setU16((unaff_EDI + 3), (uVar1 + 0x30) & 0xffff);
  return;
}

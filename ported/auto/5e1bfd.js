...
export function FUN_005e1bfd(heap) {
  ...
  if (heap.u32(unaff_ESI + (2) * 4) < heap.u32((unaff_EDI + 0x20))) {
    ...
    uVar4 = uVar2 - uVar3;
    heap.u32(unaff_ESI) = uVar4;
    heap.u32(unaff_ESI + (2) * 4) = heap.u32(unaff_ESI + (2) * 4) + uVar3;
    heap.u32(unaff_ESI + (6) * 4) = uVar4 << (heap.u32(unaff_ESI + (8) * 4) & 0x1f);
    heap.u32(unaff_ESI + (4) * 4) = heap.u32(unaff_ESI + (4) * 4) + (uVar3 << (heap.u32(unaff_ESI + (8) * 4) & 0x1f));
    uVar3 = FUN_005e1bfd(heap);
    heap.u32(unaff_ESI + (4) * 4) = uVar6;
  ...
  if (heap.u32(unaff_ESI + (3) * 4) < heap.u32((unaff_EDI + 0x22))) {
    ...
    uVar4 = uVar2 - uVar3;
    heap.u32(unaff_ESI + (1) * 4) = uVar4;
    heap.u32(unaff_ESI + (3) * 4) = heap.u32(unaff_ESI + (3) * 4) + uVar3;
    heap.u32(unaff_ESI + (7) * 4) = uVar4 << (heap.u32(unaff_ESI + (8) * 4) & 0x1f);
    heap.u32(unaff_ESI + (5) * 4) = heap.u32(unaff_ESI + (5) * 4) + (uVar3 << (heap.u32(unaff_ESI + (8) * 4) & 0x1f));
    uVar3 = FUN_005e1bfd(heap);
    heap.u32(unaff_ESI + (5) * 4) = uVar6;
  ...
  if ((heap.u32((unaff_EDI + 0x22)) + heap.u32((unaff_EDI + 0x26))) < uVar5) {
    ...
    uVar4 = uVar6 - uVar5;
    heap.u32(unaff_ESI + (1) * 4) = uVar4;
    heap.u32(unaff_ESI + (3) * 4) = heap.u32(unaff_ESI + (3) * 4) + uVar5;
    heap.u32(unaff_ESI + (7) * 4) = uVar4 << (heap.u32(unaff_ESI + (8) * 4) & 0x1f);
    heap.u32(unaff_ESI + (5) * 4) = heap.u32(unaff_ESI + (5) * 4) + (uVar5 << (heap.u32(unaff_ESI + (8) * 4) & 0x1f));
    uVar5 = FUN_005e1bfd(heap);
    heap.u32(unaff_ESI + (5) * 4) = uVar3;
    heap.u32(unaff_ESI + (1) * 4) = uVar6;

...
export function FUN_0042de29(heap) {
  ...
  FUN_00444bd4(heap);
  if (!in_ZF) {
    heap.setU32((unaff_ESI + 0x28), (unaff_EBX) >>> 0);
    heap.setU32((unaff_ESI + (0x14) * 4), (0x40) >>> 0);
    heap.setU32((unaff_ESI + (9) * 4), (0x14) >>> 0);
    heap.setU32((unaff_ESI + (0x15) * 4), (0x1e) >>> 0);
    heap.setU32(unaff_ESI, (2) >>> 0);
    FUN_00444927(heap);
    heap.setU32((unaff_ESI + (1) * 4), (1) >>> 0);
    ...
    FUN_00458a7c(heap);
    heap.setU32((unaff_ESI + 0x44), (-(extraout_CX >>> 1)) >>> 0);
    heap.setU32((unaff_ESI + 0x46), (0) >>> 0);
  }

...
export function FUN_005d298a(heap) {
  ...
  if (((heap.u32((0x005f5b78 + heap.u32(((0x00887420) >>> 0) + (heap.u32(0x00652289) * 0x260) * 4) * 8)) & 0x1000) != 0) && (heap.u8(0x00652298) != 0)) {
  ...
  if ((((heap.u32(((0x0087c41c) >>> 0) + (heap.u32(((0x00887420) & 0xff) + (heap.u32(0x00652289) * 0x260) * 4)) * 4) >>> 5 & 1) == 0) && ((heap.u16((0x00652309 + (uVar6 >>> 8) * 2)) & 0x2000) != 0)) || ((heap.u16((0x00652309 + (uVar6 >>> 8) * 2)) & 0x1000) == 0)) {

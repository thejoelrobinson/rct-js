...
export function FUN_0040da50(heap, param_1, param_2, param_3) {
  let _Dst = 0;
  _Dst = (heap.u32(0x005f0394) * 0x210 + heap.u32(0x005ebf10));
  if (param_1 == 0) {
    _memset(heap, _Dst, 0, 0x10);
  } else {
    FUN_004138d0(heap, _Dst, param_1, 0x10);
  }
  FUN_00413170(heap, _Dst + 0x10, param_2);
  FUN_00413170(heap, _Dst + 0x110, param_3);

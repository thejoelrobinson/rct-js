...
export function FUN_0042ee93(heap) {
  ...
  let uVar3 = 0;
  let uVar4 = 0;
  iVar1 = FUN_004083b5(heap, 0x0099a888);
  if (iVar1 == -1) {
    iVar1 = FUN_004083b5(heap, 0x0099aa88);
    if (iVar1 != -1) {
      heap.setU32(0x005f8d3a, (iVar1) >>> 0);
      iVar1 = FUN_004083e1(heap, 0x0099a888);
      if (iVar1 != -1) {
        ...
        do {
          ...
          FUN_00408276(heap, heap.u32(0x005f8d3a), 0x00981efc, uVar3);
          pbVar5 = 0x00981efc;
          uVar4 = uVar3;
          do {
            heap.u32(pbVar5) = heap.u32(pbVar5) >>> 4 | heap.u32(pbVar5) << 4;
            pbVar5 = pbVar5 + 1;
            uVar4 = uVar4 - 1;
          } while (uVar4 != 0);
          FUN_00408342(heap, heap.u32(0x005f8d3e), 0x00981efc, uVar3);
          uVar2 = uVar2 - uVar3;
        } while (uVar2 != 0);

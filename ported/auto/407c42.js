...
export function FUN_00407c42(heap, param_1, param_2, param_3, param_4, param_5) {
  ...
  if (heap.u32(param_1) == 0) {
    ...
    if (param_2 == 0) {
      local_8 = (((regs.eax = callIndirect(heap, heap.u32((heap.i32(heap.u32(param_1)) + 0x30)), heap.u32(param_1), 0, 0, 0))) >>> 0);
    } else {
      if (param_2 == 1) {
      local_8 = (((regs.eax = callIndirect(heap, heap.u32((heap.i32(heap.u32(param_1)) + 0x30)), heap.u32(param_1), 0, 0, 1))) >>> 0);
    }
    }
    if (local_8 == 0) {
      uVar1 = ((1) >>> 0);

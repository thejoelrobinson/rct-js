...
export function FUN_005e19eb(heap) {
  ...
  heap.setU32((unaff_EDI + (4) * 4), (in_AX) >>> 0);
  heap.setU32((unaff_EDI + (5) * 4), (unaff_BX) >>> 0);
  ...
  if ((heap.u32((unaff_ESI + 0x32)) & 0x40) == 0) {
    ...
    if (sVar7 < 0) {
      heap.setU32(unaff_EDI, (heap.u32(unaff_EDI) + sVar7) >>> 0);
      heap.setU32((unaff_EDI + (2) * 4), (0) >>> 0);
      sVar7 = sVar7 << (bVar1 & 0x1f);
      heap.setU32((unaff_EDI + (6) * 4), (heap.u32(unaff_EDI + (6) * 4) + sVar7) >>> 0);
      heap.setU32((unaff_EDI + (4) * 4), (heap.u32(unaff_EDI + (4) * 4) - sVar7) >>> 0);
    }
    ...
    if (sVar7 != 0 && heap.u32(0x00971ed6) <= (heap.u32(unaff_EDI + (2) * 4) + heap.u32(unaff_EDI))) {
      heap.setU32(unaff_EDI, (heap.u32(unaff_EDI) - sVar7) >>> 0);
      heap.setU32((unaff_EDI + (6) * 4), (heap.u32(unaff_EDI + (6) * 4) - (sVar7 << (bVar1 & 0x1f))) >>> 0);
    }
    if (0 < heap.u32(unaff_EDI)) {
      sVar7 = heap.u32(unaff_EDI + (3) * 4);
      if (sVar7 < 0) {
        heap.setU32((unaff_EDI + (1) * 4), (heap.u32(unaff_EDI + (1) * 4) + sVar7) >>> 0);
        heap.setU32((unaff_EDI + (3) * 4), (0) >>> 0);
        sVar7 = sVar7 << (bVar1 & 0x1f);
        heap.setU32((unaff_EDI + (7) * 4), (heap.u32(unaff_EDI + (7) * 4) + sVar7) >>> 0);
        heap.setU32((unaff_EDI + (5) * 4), (heap.u32(unaff_EDI + (5) * 4) - sVar7) >>> 0);
      }
      ...
      if (sVar7 != 0 && heap.u32(0x00971ed8) <= (heap.u32(unaff_EDI + (3) * 4) + heap.u32(unaff_EDI + (1) * 4))) {
        heap.setU32((unaff_EDI + (1) * 4), (heap.u32(unaff_EDI + (1) * 4) - sVar7) >>> 0);
        heap.setU32((unaff_EDI + (7) * 4), (heap.u32(unaff_EDI + (7) * 4) - (sVar7 << (bVar1 & 0x1f))) >>> 0);
      }
      if (0 < heap.u32(unaff_EDI + (1) * 4)) {
        FUN_005e1b3e(heap);
      }
    }
    heap.setU32((unaff_EDI + (7) * 4), (sVar5) >>> 0);
    heap.setU32((unaff_EDI + (6) * 4), (sVar4) >>> 0);
    heap.setU32((unaff_EDI + (5) * 4), (sVar3) >>> 0);
    heap.setU32((unaff_EDI + (1) * 4), (sVar2) >>> 0);
    heap.setU32((unaff_EDI + (3) * 4), (sVar10) >>> 0);
    heap.setU32((unaff_EDI + (4) * 4), (sVar8) >>> 0);
    heap.setU32(unaff_EDI, (sVar9) >>> 0);
    heap.setU32((unaff_EDI + (2) * 4), (sVar6) >>> 0);
    return;
  }
  sVar6 = heap.u32(unaff_EDI + (2) * 4);

        ...
        if ((heap.u32((unaff_ESI + 0x51)) == '\x01') && (iVar7 = heap.u32((unaff_ESI + 0x30)) * 0x260, CONCAT11((extraout_DX >>> 5), (uVar3 >>> 5)) == heap.u32((__addr_DAT_008874a2 + iVar7)))) {
          ...
          if ((uVar5 & 0x1f) == 0x10) {
            ...
            if (!bVar15) {
              ...
              for (pbVar13 = heap.u32((__addr_DAT_00971ef4) + (((extraout_DX << 7 | extraout_DX >>> 9 | uVar10) >>> 5 | (extraout_DX >>> 9) << 0xb)) * 4); ((heap.u32(pbVar13) & 0x3c) != 8 || ((byte)(heap.u32((unaff_ESI + 0x3c)) >>> 2) != heap.u32(pbVar13 + (2) * 4))); pbVar13 = pbVar13 + 8) {
              
              }
              heap.u32((unaff_ESI + 0x36)) = CONCAT31((int3)((heap.u32(pbVar13 + (4) * 4) << 2) >>> 8), (byte)(heap.u32(pbVar13 + (4) * 4) << 2) | heap.u32((__addr_DAT_008874a1) + (iVar7) * 4) & 3);

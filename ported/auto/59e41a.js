...
export function FUN_0059e41a(heap, param_1) {
  ...
  if (puVar3 != 0xffffffff) {
    for (heap.setU32(0x00651d24, (heap.u32(0x00651d24) + (heap.u32(puVar3 + (0x1e) * 4) >>> 3) * 0x10 + heap.u32(puVar3 + (0x1f) * 4)) >>> 0); 0xd7 < heap.u32(0x00651d24); heap.setU32(0x00651d24, (heap.u32(0x00651d24) - 0xd8) >>> 0)) {
    
    }
  }
  heap.setU32(0x0099a4e8, (in_EAX + 0x10) >>> 0);
  heap.setU32(0x0099a4ea, (in_ECX + 0x10) >>> 0);
  uVar6 = CONCAT22((heap.u32(0x00651d24) >>> 0x10), 0x18);
  uVar5 = 0x18;

...
import { CONCAT11, CONCAT21, CONCAT22, LOCK, UNLOCK } from "../runtime/win32.js";
...
export function FUN_0044c464(heap) {
  ...
  if (-1 < bVar2) {
    if (bVar2 < heap.u32((byte)(0x00887498) + (iVar7) * 4)) {
      if ((heap.u32((0x00887422) + (uVar6 * 0x130) * 4) & 1) != 0) {
        uVar6 = heap.u32((0x0088747e + CONCAT11(heap, ((ushort) * (unaff_ESI + 0x15a) >>> 8), bVar2) * 2 + iVar7)) | 0xc0000000;
        iVar7 = heap.u32(0x00991f88) << 8;
        /* goto LAB_0044c557 */ throw new Error("goto LAB_0044c557 not supported");
      }
      heap.u32((unaff_ESI + 0x15a)) = 0;
    } else {
      bVar2 = bVar2 - heap.u32((0x00887498) + (iVar7) * 4);
      if (bVar2 < heap.u32((byte)(0x00887497) + (iVar7) * 4)) {
        iVar4 = -1;
        do {
          do {
            iVar5 = iVar4;
            iVar4 = iVar5 + 1;
          } while (heap.u32((0x0088744a) + (uVar6 * 0x130 + iVar4) * 4) == -1);
          bVar2 = bVar2 - 1;
        } while (-1 < bVar2);
        uVar6 = CONCAT22(heap, (heap.u32((ushort)(0x0088744a) + (uVar6 * 0x130 + iVar4) * 4) >>> 8) << 5, (heap.u32((0x0088744a) + (uVar6 * 0x130 + iVar4) * 4) & 0xff) << 5) | 0x40000000;
        iVar7 = CONCAT21(heap, ((heap.u32((uint)(byte)(0x00887453) + (iVar7 + iVar5) * 4) << 0x12) >>> 0x10), heap.u32(0x00991f88)) << 8;
        /* goto LAB_0044c557 */ throw new Error("goto LAB_0044c557 not supported");
      }
      heap.u32((unaff_ESI + 0x15a)) = 0;
    }
  ...
  iVar7 = CONCAT22(heap, extraout_DX, CONCAT11(heap, heap.u32(0x00991f88), 1));

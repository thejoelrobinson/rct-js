...
export function FUN_004272de(heap) {
  let puVar1 = 0;
  ...
  heap.setU32((unaff_ESI + (7) * 4), (heap.u32(0x005f5088)) & 0xffffffff);
  heap.setU32((unaff_ESI + (3) * 4), (heap.u32(0x005f50dc)) & 0xffffffff);
  heap.setU32((unaff_ESI + (6) * 4), (heap.u32(0x005f50f8)) & 0xffffffff);
  heap.setU32(unaff_ESI, (heap.u32(0x005f50a4)) & 0xffffffff);
  heap.setU32((unaff_ESI + (1) * 4), (heap.u32(0x005f50c0)) & 0xffffffff);
  heap.setU32((unaff_ESI + (5) * 4), (0) & 0xffffffff);
  return (regs.eax = 0x427bab, regs.ecx = 0x1b, regs.eax = FUN_005e412c(heap));
}

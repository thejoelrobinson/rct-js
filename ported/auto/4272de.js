...
export function FUN_004272de(heap) {
  ...
  FUN_005e43de(heap);
  heap.setU32((unaff_ESI + (7) * 4), (heap.u32(0x005f5088)) >>> 0);
  heap.setU32((unaff_ESI + (3) * 4), (heap.u32(0x005f50dc)) >>> 0);
  heap.setU32((unaff_ESI + (6) * 4), (heap.u32(0x005f50f8)) >>> 0);
  heap.setU32(unaff_ESI, (heap.u32(0x005f50a4)) >>> 0);
  heap.setU32((unaff_ESI + (1) * 4), (heap.u32(0x005f50c0)) >>> 0);

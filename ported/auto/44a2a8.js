...
export function FUN_0044a2a8(heap) {
  ...
  while ((byte)(iVar4 + 1) < heap.u32((unaff_ESI + 0x78))) {
    ...
    heap.u32((0x00743bdc + iVar5)) = heap.u32((0x00743bdc + iVar5)) & 0xffbf;
    bVar2 = heap.u32((0x00743bc5) + (iVar5) * 4);
    bVar3 = FUN_005df40c(heap);
    heap.u32((0x00743c56) + (iVar5) * 4) = ((bVar3 & 0xf) - 8) + heap.u32((0x005f7109) + (bVar2 * 8) * 4);
    iVar4 = extraout_ECX;
    if (heap.u32((0x00743c47) + (iVar5) * 4) != '\0') {
      bVar6 = 0xff8bc46b < (uint) * (0x00743be6 + iVar5) << 8;
      FUN_00441596(heap);
      bVar7 = false;
      if (bVar6) {
        pbVar1 = 0x00743c56 + iVar5;

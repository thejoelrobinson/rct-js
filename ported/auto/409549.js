...
export function FUN_00409549(heap, param_1, param_2, param_3) {
  ...
  if ((heap.u32(0x005ebf3c) != 0x0) && (param_2 < 0x100)) {
    ...
    for (local_c = param_2; local_c < param_3 + param_2; local_c = local_c + 1) {
      heap.u32((0x005f0960) + (local_c * 4) * 4) = heap.u32((param_1 + 2 + local_c * 4));
    ...
    (heap.u32(heap.u32((heap.u32(heap.u32(0x005ebf3c)) + 0x18))))(heap.u32(0x005ebf3c), 0, param_2, param_3, 0x005f0960 + param_2 * 4);
  }
  return;
}

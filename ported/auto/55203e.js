...
export function FUN_0055203e(heap, param_1) {
  ...
  if ((heap.u32((__addr_DAT_00887422) + (uVar6 * 0x130) * 4) & 1) != 0) {
    ...
    if (puVar4 != 0xffffffff) {
      iVar5 = (uint) * (__addr_DAT_0088747e + iVar7) * 0x100;
      ...
      if ((((heap.u32((__addr_DAT_00887422) + (uVar6 * 0x130) * 4) & 0xc0) != 0) && (heap.u32((__addr_DAT_0088755c) + (iVar7) * 4) == '\a')) && (0x7f < heap.u32((byte)(__addr_DAT_0088757c) + (iVar7) * 4))) {
        uVar3 = (uint)(ushort)(uVar2 + heap.u32((__addr_DAT_00651be8 + (heap.u32((__addr_DAT_00743be0 + iVar5)) >>> 1 & 7) * 2)));
      }
    }
  }
  heap.setU32(0x00651bc4, (0) >>> 0);
  if (puVar4 != 0xffffffff) {
    heap.setU32(0x00651bc4, (((uint)(heap.u32(puVar4 + (0x1e) * 4) >>> 3) + heap.u32(0x00991f88)) * 0x20 + heap.u32(puVar4 + (0x1f) * 4) & 0x7f) >>> 0);
  }
  ...
  if (((heap.u32((heap.u32(0x00981ef8) + 0xe)) == 0) && ((heap.u32((__addr_DAT_00887422 + iVar7)) & 1) != 0)) && ((heap.u32((__addr_DAT_0088747e + iVar7)) != 0xffff && (iVar7 = (uint) * (__addr_DAT_0088747e + iVar7) * 0x100, puVar4 = __addr_DAT_00743b94 + iVar7, heap.u32((__addr_DAT_00743c47) + (iVar7) * 4) != '\0')))) {

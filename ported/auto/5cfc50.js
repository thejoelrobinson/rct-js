...
export function FUN_005cfc50(heap) {
  ...
  uVar3 = CONCAT11(heap, heap.u32((__addr_DAT_00653ef7) + (iVar11) * 4), heap.u32((__addr_DAT_00653ef7) + (iVar11) * 4)) & 0x4ff;
  ...
  if ((bVar8 & 4) == 0) {
    uVar4 = CONCAT22(heap, (uVar4 >>> 0x10), uVar4 + heap.u32((__addr_DAT_00652478) + (bVar8 * 2) * 4));
    uVar6 = uVar6 + heap.u32((__addr_DAT_0065247a) + (bVar8 * 2) * 4);
  }
  uVar3 = uVar4;
  uVar6 = uVar6 << 7 | uVar6 >>> 9 | uVar3;
  pbVar10 = heap.u32((__addr_DAT_00971ef4) + ((ushort)(uVar6 >>> 5 | uVar6 << 0xb)) * 4);
  do {
    if ((((heap.u32(pbVar10) & 0x3c) == 8) && (heap.u32(pbVar10 + (7) * 4) == heap.u32(unaff_ESI + (7) * 4))) && (heap.u32(heap.u32((__addr_PTR_DAT_00652498) + (heap.u32(pbVar10 + (4) * 4)) * 4) + ((heap.u32((pbVar10 + 5)) & 0xf) * 10 + 10) * 4) == -1)) {
      ...
      uVar6 = CONCAT11(heap, heap.u32((__addr_DAT_00653ef8) + (iVar11) * 4), heap.u32((__addr_DAT_00653ef8) + (iVar11) * 4)) & 0x4ff;
      uVar9 = CONCAT11(heap, (uVar6 >>> 8), uVar6 + heap.u32(pbVar10)) & 0xffffff03;
      if (((byte)(uVar9 | (byte)(uVar9 >>> 8)) == heap.u32(0x00652471)) && ((ushort)(heap.u32(pbVar10 + (2) * 4) * 4 + (heap.u32((__addr_DAT_00653efb + iVar11)) - heap.u32((heap.u32((__addr_PTR_DAT_00652498) + (heap.u32(pbVar10 + (4) * 4)) * 4) + (heap.u32(pbVar10 + (5) * 4) & 0xf) * 10 + 5)))) == sVar7)) {
        ...
        return CONCAT24(heap, heap.u32(pbVar10 + (2) * 4) * 4 + (heap.u32((heap.u32((__addr_PTR_DAT_00652498) + (heap.u32(pbVar10 + (4) * 4)) * 4) + 5)) - heap.u32((heap.u32((__addr_PTR_DAT_00652498) + (heap.u32(pbVar10 + (4) * 4)) * 4) + (heap.u32((pbVar10 + 5)) & 0xf) * 10 + 5))), CONCAT22(heap, sVar7, uVar3));
      }
    }
    pbVar1 = pbVar10 + 1;
    pbVar10 = pbVar10 + 8;

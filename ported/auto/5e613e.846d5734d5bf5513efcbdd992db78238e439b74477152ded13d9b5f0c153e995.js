    ...
    if (cVar12 == 3) {
      ...
      if ((heap.u8(pbVar11) & 0x3c) == 0x10) {
        if (heap.u8(pbVar11 + (4)) != 0) {
          ...
          heap.setU16(0x005f54f4, (heap.u32(((0x00887444) & 0xffff) + (uVar8 * 0x98) * 4)) >>> 0);
          heap.setU16(0x005f54f6, (((heap.u32(((0x00887444) >>> 0) + (uVar8 * 0x98) * 4) >>> 0x10) & 0xffff)) >>> 0);
        ...
        heap.setU16(0x005f54f6, (heap.u32(((0x00887444) & 0xffff) + (uVar8 * 0x98) * 4)) >>> 0);
        ...
        heap.setU16(0x005f5500, (uVar17) & 0xffff);
        heap.setU16(0x005f54fe, (0x4f3) & 0xffff);   // 0x5e6362 `mov word ptr [0x5f54fe], ax`
        if ((uVar17 != 0) && (heap.setU16(0x005f54fe, (0x4f4) >>> 0), uVar17 != 1)) {
          heap.setU32(0x005f54fe, (0x4f5) & 0xffff);   // 0x5e6362 `mov word ptr [0x5f54fe], ax`
        }
      ...
      heap.setU16(0x005f54fe, (((bVar1) & 0xffff)) >>> 0);
      heap.setU32(0x005f54f0, (0x7ee) >>> 0);
      return uVar6;
    }
    if (cVar12 == 2) {
      ...
      if (bVar1 == 0) {
        ...
        heap.setU16(0x005f54fe, (sVar13) & 0xffff);   // 0x5e6362 `mov word ptr [0x5f54fe], ax`
        heap.setU32(0x005f54f0, (0x7ee) >>> 0);
        return uVar6;
      }
      if (bVar1 == 1) {
      ...
      heap.setU16(0x005f54f4, (((heap.u32(0x0087c3b0) >>> 0x10) & 0xffff)) >>> 0);
      return uVar6;
    }
    }
    iVar16 = ((unaff_ESI) >>> 0);
    ...
    if (((unaff_ESI != 0) && (pbVar11 = ((heap.u32((unaff_ESI + 8))) >>> 0), pbVar11 != 0x0)) && (heap.u8(pbVar11 + (0x10)) < 2)) {
      ...
      if (((unaff_EBP) & 0xffff) < 0x21) {
        ...
        if (heap.u8(pbVar11 + (0x2e)) != 0) {
          ...
          heap.setU16(0x005f54f6, (((heap.u32((pbVar11 + 0x9c)) >>> 0x10) & 0xffff)) >>> 0);
          ...
          heap.setU16(0x005f54fe, (((((uVar19) >>> 0) >>> 0x30) & 0xffff)) >>> 0);
          return ((uVar19) >>> 0);
        }
        ...
        heap.setU16(0x005f54fe, (extraout_CX) & 0xffff);   // 0x5e6362 `mov word ptr [0x5f54fe], ax`
        heap.setU32(0x005f5500, (extraout_EDX) >>> 0);
        uVar6 = (((regs.eax = FUN_0043fdfb(heap, unaff_ESI, unaff_EBX))) >>> 0);
        heap.setU16(0x005f54f2, (((unaff_EBP) & 0xffff)) >>> 0);
        heap.setU16(0x005f54f4, (((((unaff_EBP) >>> 0) >>> 0x10) & 0xffff)) >>> 0);
        return uVar6;
      }
    }
  }

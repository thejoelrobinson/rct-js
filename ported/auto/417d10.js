...
import { LPBOOL, WideCharToMultiByte } from "../runtime/win32.js";
export function FUN_00417d10(heap, param_1, param_2) {
  ...
  if (heap.u32(0x005f0270) == 0) {
    if (heap.u32(__addr_param_2) < 0x100) {
      heap.u32(param_1) = heap.u32(__addr_param_2);
      return 1;
    }
  } else {
    param_1 = 0x0;
    iVar1 = WideCharToMultiByte(heap, heap.u32(0x005f0280), 0x220, __addr_param_2, 1, lpMultiByteStr, heap.u32(0x005ee754), 0x0, (LPBOOL) & param_1);
    if ((iVar1 != 0) && (param_1 == 0x0)) {
      return iVar1;
    }
  }

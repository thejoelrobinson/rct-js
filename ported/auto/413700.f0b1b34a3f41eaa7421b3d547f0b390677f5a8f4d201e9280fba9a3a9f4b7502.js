  ...
  if (heap.u32(0x005f0270) == 0) {
    ...
    if (((heap.u32(__addr_param_1)) | 0) < 0x100) {
      if (heap.u32(0x005ee754) < 2) {
        ...
        uVar2 = (((regs.eax = FUN_00416f60(heap, heap.u32(__addr_param_1), 2))) >>> 0);
      }
      if (uVar2 == 0) {
        return uVar1;
      }
    ...
    iVar4 = (((regs.eax = FUN_00416d00(heap, heap.u32(0x005f0270), 0x200, __addr_param_1, uVar3, __addr_local_8, 3, 0, 1))) >>> 0);
    if (iVar4 == 0) {
      return uVar1;
    }
    if (iVar4 == 1) {

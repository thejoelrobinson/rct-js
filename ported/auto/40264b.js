...
export function FUN_0040264b(heap) {
  let iVar1 = 0;
  let local_8 = 0;
  iVar1 = (((regs.eax = FUN_0040aa7f(heap))) >>> 0);
  if (iVar1 == 0) {
    local_8 = ((0) >>> 0);
  } else {
    if (heap.u32(0x005e9154) == 0) {
      if (0 < heap.u32(0x005e9158)) {
        if (heap.u32(0x005e9144) == 0) {
          local_8 = (((regs.eax = FUN_004028a0(heap))) >>> 0);
        } else {
          local_8 = (((regs.eax = FUN_0040276c(heap))) >>> 0);
        }
      }
    } else {
      local_8 = (((regs.eax = FUN_004026ec(heap))) >>> 0);
    }
    (regs.eax = FUN_0040aae9(heap));
  }
  return local_8;
}

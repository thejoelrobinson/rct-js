...
export function FUN_0040a006(heap, param_1, param_2, param_3, param_4, param_5) {
  ...
  if ((((param_1 != 0) && (param_3 != 0)) && (heap.u32((param_3 + 0x80)) != 0)) && (heap.u32((param_1 + 0x80)) != 0)) {
    if (heap.u32(0x005ebf54) == 0) {
      ...
      heap.setU32(param_4, (heap.u32(param_4) + heap.u32(__addr_local_30)) >>> 0);
      heap.setU32((param_4 + (1) * 4), (heap.u32(param_4 + (1) * 4) + heap.u32((__addr_local_30 + 4))) >>> 0);
      heap.setU32((param_4 + (2) * 4), (heap.u32(param_4 + (2) * 4) + heap.u32(__addr_local_30)) >>> 0);
      heap.setU32((param_4 + (3) * 4), (heap.u32(param_4 + (3) * 4) + heap.u32((__addr_local_30 + 4))) >>> 0);
    }
    heap.setU32(__addr_local_20, (param_5) >>> 0);
    local_1c = param_5;
    (heap.u32(heap.u32((heap.u32(heap.u32((param_1 + 0x80))) + 0x74))))(heap.u32((param_1 + 0x80)), 8, __addr_local_20);
    do {
      local_8 = (heap.u32(heap.u32((heap.u32(heap.u32((param_3 + 0x80))) + 0x14))))(heap.u32((param_3 + 0x80)), param_4, heap.u32((param_1 + 0x80)), param_2, 0x1008000, 0);
      if ((local_8 == -0x7789fe3e) && (iVar1 = FUN_00408d5d(heap), iVar1 == 0)) {
        break;
      }
    } while (local_8 == -0x7789fe3e);
    if (heap.u32(0x005ebf54) == 0) {
      heap.setU32(param_4, (local_18) >>> 0);
      heap.setU32((param_4 + (1) * 4), (local_14) >>> 0);
      heap.setU32((param_4 + (2) * 4), (local_10) >>> 0);
      heap.setU32((param_4 + (3) * 4), (local_c) >>> 0);
    }
    if (local_8 == 0) {
      return 1;
    }

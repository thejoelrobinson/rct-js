...
export function FUN_005d88ec(heap) {
  ...
  do {
    if ((((heap.u32((unaff_ESI + 0x48)) & 0x100) == 0) || (heap.u32(unaff_ESI + (0xb5) * 4) == '\0')) || ((uVar4 = heap.u32(unaff_ESI + (0x30) * 4), iVar5 = uVar4 * 0x260, heap.u32((__addr_DAT_0088755c) + (iVar5) * 4) != '\x02' && (heap.u32((__addr_DAT_0088755c) + (iVar5) * 4) != '\x04')))) {
      ...
      heap.setU32(pbVar1, (heap.u32(pbVar1) - 0x14) >>> 0);
      if (0x13 < bVar2) {
        /* goto LAB_005d8994 */ throw new Error("goto LAB_005d8994 not supported");
      }
      heap.setU32((unaff_ESI + (0xb5) * 4), (0) >>> 0);
    } else {
      if ((heap.u32((__addr_DAT_00887422) + (uVar4 * 0x130) * 4) & 0x80) == 0) {
        heap.setU32(((__addr_DAT_00887422) + (uVar4 * 0x130) * 4), (heap.u32((__addr_DAT_00887422) + (uVar4 * 0x130) * 4) | 0x80) >>> 0);
        FUN_004518fc(heap, (uVar6 >>> 0x20), unaff_EDI, unaff_EBX);
        heap.setU32(((__addr_DAT_0088751d) + (iVar5) * 4), (heap.u32((__addr_DAT_0088751d) + (iVar5) * 4) | 0x1c) >>> 0);
        heap.setU32(((__addr_DAT_0088755d) + (iVar5) * 4), (1) >>> 0);
        heap.setU32(((__addr_DAT_00887560) + (iVar5) * 4), (heap.u32((__addr_DAT_00743bdf) + (heap.u32((__addr_DAT_0088747e + heap.u32((__addr_DAT_00887561) + (iVar5) * 4) * 2 + iVar5)) * 0x100) * 4)) >>> 0);
        heap.setU32(((__addr_DAT_00887563) + (iVar5) * 4), (heap.u32((__addr_DAT_0088755c) + (iVar5) * 4)) >>> 0);
      }

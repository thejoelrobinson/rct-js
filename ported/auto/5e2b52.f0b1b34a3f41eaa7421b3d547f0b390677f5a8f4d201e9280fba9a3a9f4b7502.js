...
// Frozen replay implementation; real startup uses extra_tooltip.js.
// Legacy tooltip/hover dwell-timer transcription notes:
...
import { tooltipInputRuntime } from "./extra_tooltip.js";
...
export function FUN_005e2b52(heap) {
  if (globalThis.__realStartup || state.executionMode === "pure-js") return tooltipInputRuntime(heap);
  if (!canHandle(heap)) {

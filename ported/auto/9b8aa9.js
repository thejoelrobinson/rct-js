...
export function FUN_009b8aa9(heap) {
  ...
  if ((heap.u32(0x009a2000) & 0x20000000) != 0) {
    if ((heap.u32(0x009a2000) & 0x40000000) != 0) {
      uVar1 = 0;
      puVar12 = (CONCAT22(heap, uVar13, heap.u32((unaff_ESI + heap.u32(0x009a2020) * 2))) + unaff_ESI);
      do {
        ...
        if ((uVar3 & 0x100) == 0) {
          ...
          uVar2 = uVar4;
          if (((sVar8 == 0 || (sVar7 + uVar4) < heap.u32(0x009a2028)) || (uVar2 = uVar4 - sVar8, uVar2 != 0 && sVar8 <= uVar4)) && (uVar2 = (ushort)(uVar2 + 3) >>> 2, uVar2 != 0)) {
            LOCK(heap);
            UNLOCK(heap);
            heap.setU32(0x009a200c, (puVar12) >>> 0);
            uVar1 = (heap.u32(heap.u32((0x009b9d78) + (uVar2) * 4)))();
            return uVar1;
          }
        } else {
    ...
    do {
      ...
      if ((uVar3 & 0x100) == 0) {
        ...
        if (((sVar8 == 0 || (sVar7 + uVar4) < heap.u32(0x009a2028)) || (uVar2 = uVar4 - sVar8, uVar2 != 0 && sVar8 <= uVar4)) && (uVar2 = (ushort)(uVar2 + 3) >>> 2, uVar2 != 0)) {
          ...
          UNLOCK(heap);
          heap.setU32(0x009a200c, (puVar12) >>> 0);
          uVar1 = (heap.u32(heap.u32((0x009b8cb0) + (uVar2) * 4)))();
          return uVar1;
        }
      } else {
        uVar9 = (uint)(ushort)(bVar5 + 1);
    ...
    do {
      ...
      if ((uVar3 & 0x100) == 0) {
        ...
        if (((sVar8 == 0 || (sVar7 + uVar4) < heap.u32(0x009a2028)) || (uVar2 = uVar4 - sVar8, uVar2 != 0 && sVar8 <= uVar4)) && (uVar2 = (ushort)(uVar2 + 3) >>> 2, uVar2 != 0)) {
          ...
          UNLOCK(heap);
          heap.setU32(0x009a200c, (puVar12) >>> 0);
          uVar1 = (heap.u32(heap.u32((0x009b95a4) + (uVar2) * 4)))();
          return uVar1;
        }
      } else {
        uVar9 = (uint)(ushort)(bVar5 + 1);

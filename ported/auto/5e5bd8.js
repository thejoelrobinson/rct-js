...
import { closeWindowExact } from "./extra_window_lifecycle.js";

export function FUN_005e5bd8_exact(heap, invoke) {
  return closeWindowExact(heap, invoke);
}

function FUN_005e5bd8_frozen(heap) {
...
export function FUN_005e5bd8(heap) {
  if (globalThis.__forceFrozen5e5bd8) return FUN_005e5bd8_frozen(heap);
  if (globalThis.__realStartup || state.executionMode === "pure-js") return FUN_005e5bd8_exact(heap);
  return FUN_005e5bd8_frozen(heap);
}

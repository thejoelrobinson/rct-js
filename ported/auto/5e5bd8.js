...
export function FUN_005e5bd8(heap) {
  ...
  let puVar2 = 0;
  if (unaff_ESI != 0x0) {
    (heap.u32(heap.u32((unaff_ESI + 2))))(CONCAT22(CONCAT31((int3)(in_ECX >>> 8), heap.u32((unaff_ESI + 0xba))), heap.u32(unaff_ESI + (0x18) * 4)));
    FUN_005e3b2b(heap);
    LOCK();
    puVar2 = heap.u32((unaff_ESI + 4));
    heap.setU32((unaff_ESI + 4), (0) >>> 0);
    UNLOCK();
    if (puVar2 != 0x0) {
    ...
    if (heap.u32(0x009a1164) - unaff_ESI != 0 && unaff_ESI <= heap.u32(0x009a1164)) {
      uVar1 = (heap.u32(0x009a1164) - unaff_ESI) >>> 1;
      puVar2 = unaff_ESI + 0xbc;
      for (; uVar1 != 0; uVar1 = uVar1 - 1) {
        heap.setU32(unaff_ESI, (heap.u32(puVar2)) >>> 0);
        puVar2 = puVar2 + 1;

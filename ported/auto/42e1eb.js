...
export function FUN_0042e1eb(heap) {
  ...
  let uVar2 = 0;
  let uVar3 = 0;
  uVar3 = CONCAT44(heap, in_EDX, in_EAX);
  uVar1 = heap.u32((0x00991f8e) + ((ushort)((ushort)((in_EAX & 0xfe0) << 2) | in_ECX >>> 5)) * 4);
  do {
    while (true) {
      if (uVar1 == 0xffff) {
      ...
      uVar2 = uVar1;
      if (heap.u32((0x00743b9c) + (uVar2 * 0x100) * 4) == '\b') {
        break;
      }
      LAB_0042e26a: uVar1 = heap.u32((0x00743b96) + (uVar2 * 0x80) * 4);
    }
    uVar1 = heap.u32((0x00743ba6) + (uVar2 * 0x80) * 4) - (uVar3 >>> 0x20);
    if (uVar1 < 0) {
      uVar1 = -uVar1;
    }
    if (0x10 < uVar1) {
    ...
    uVar1 = heap.u32((0x00743ba2) + (uVar2 * 0x80) * 4) - uVar3;
    if (uVar1 < 0) {
      uVar1 = -uVar1;
    }
    if (8 < uVar1) {
    ...
    uVar1 = heap.u32((0x00743ba4) + (uVar2 * 0x80) * 4) - in_ECX;
    if (uVar1 < 0) {
      uVar1 = -uVar1;
    }
    if (8 < uVar1) {

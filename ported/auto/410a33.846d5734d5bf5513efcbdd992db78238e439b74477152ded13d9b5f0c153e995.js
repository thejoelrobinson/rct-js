...
export function FUN_00410a33(heap, param_1, param_2, param_3, param_4) {
  ...
  let iVar2 = 0;
  let uVar3 = 0;
  if ((param_4 == 1) || (iVar2 = (((regs.eax = FUN_004133c0(heap, 0x10c))) >>> 0), iVar2 == 0)) {
    uVar3 = ((0) >>> 0);
  } else {
    heap.setU32((iVar2 + 0x104), (heap.u32((param_1 + 0x14))) & 0xffffffff);
    (regs.eax = FUN_00413170(heap, iVar2, param_1 + 0x24));
    heap.setU32((iVar2 + 0x108), (0) & 0xffffffff);
    heap.setU32(0x005ec134, (heap.u32(0x005ec134) + 1) >>> 0);
    iVar1 = ((iVar2) >>> 0);
    if (heap.u32(0x005ec138) != 0) {
      heap.setI32((heap.u32(0x005ec13c) + 0x108), (iVar2) & 0xffffffff);
      iVar1 = ((heap.u32(0x005ec138)) >>> 0);
    }

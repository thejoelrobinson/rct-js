...
export function FUN_00420d9c(heap) {
  ...
  let cVar2 = 0;
  let cVar4 = 0;
  uVar9 = heap.u32(0x00991f74) + heap.u32((__addr_DAT_005f4686 + heap.u32(0x00991f88) * 4));
  if (((ushort)(heap.u32(0x00991f70) + heap.u32((__addr_DAT_005f4684 + heap.u32(0x00991f88) * 4))) < 0x1000) && (uVar9 < 0x1000)) {
    uVar9 = uVar9 * 0x80 | uVar9 >>> 9 | heap.u32(0x00991f70) + heap.u32((__addr_DAT_005f4684 + heap.u32(0x00991f88) * 4));
    pbVar10 = heap.u32((__addr_DAT_00971ef4) + ((ushort)(uVar9 >>> 5 | uVar9 << 0xb)) * 4);
  ...
  cVar4 = (uVar7 >>> 8);
  bVar3 = cVar4 + heap.u32((__addr_DAT_005f46a4) + (uVar11) * 4);

...
export function FUN_0040857b(heap, param_1, param_2) {
  ...
  let local_124 = 0;
  let local_8 = 0;
  GetCurrentDirectoryA(heap, 0x117, local_120);
  uVar1 = FUN_00413700(heap, heap.u32(local_120 + (0) * 4));
  heap.u32(param_2) = uVar1;
  GetLogicalDriveStringsA(heap, 0x117, local_120);
  local_8 = 0;
  for (local_124 = 0; local_124 < 8; local_124 = local_124 + 1) {
    uVar1 = FUN_00413700(heap, heap.u32(local_120 + (local_8) * 4));
    heap.u32((local_124 + param_1)) = uVar1;
    if (heap.u32(local_120 + (local_8) * 4) != '\0') {
      for (; heap.u32(local_120 + (local_8) * 4) != '\0'; local_8 = local_8 + 1) {

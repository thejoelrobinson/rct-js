...
export function FUN_004405f3(heap) {
  ...
  heap.setU32(piVar1, (heap.u32(piVar1) - unaff_EBX) >>> 0);
  if (SBORROW4(iVar2, unaff_EBX) != heap.u32(piVar1) < 0) {
    heap.setU32((unaff_ESI + 0xa0), (0) >>> 0);
  }
  heap.setU32((unaff_ESI + 0xa4), (heap.u32((unaff_ESI + 0xa4)) + unaff_EBX) >>> 0);
  heap.setU32((heap.u32(0x006293b0) + unaff_ESI), (heap.u32((heap.u32(0x006293b0) + unaff_ESI)) + unaff_EBX) >>> 0);
  FUN_005e5301(heap);

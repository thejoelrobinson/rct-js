...
export function FUN_004543bd(heap) {
  ...
  if (((((heap.u32(0x006323f8) & 1) != 0) && (heap.u32(0x006326bc) == '\0')) && ((heap.u32(0x006326bd) & 1) != 0)) && (heap.u32(0x006323fc) != -1)) {
    uVar3 = 0;
    for (uVar4 = heap.u32(0x0087c398); uVar4 != 0xffff; uVar4 = heap.u32((0x00743b98) + (uVar4 * 0x80) * 4)) {
      iVar5 = uVar4 * 0x100;
      uVar2 = uVar3;
      if (((((heap.u32((0x00743baa + iVar5)) != -0x8000) && (heap.u32((0x00743bc2) + (iVar5) * 4) == '\0')) && ((heap.u32((heap.u32(0x006323fc) + 8)) <= heap.u32((0x00743bae + iVar5)) && ((heap.u32((0x00743baa + iVar5)) <= (heap.u32((heap.u32(0x006323fc) + 0xc)) + heap.u32((heap.u32(0x006323fc) + 8))) && (heap.u32((heap.u32(0x006323fc) + 10)) <= heap.u32((0x00743bb0 + iVar5)))))))) && (heap.u32((0x00743bac + iVar5)) <= (heap.u32((heap.u32(0x006323fc) + 0xe)) + heap.u32((heap.u32(0x006323fc) + 10))))) && (uVar2 = uVar3 + 2, heap.u32((0x00743bbf) + (iVar5) * 4) == '\x06')) {
        uVar2 = uVar3 + 1;
      }
      uVar3 = uVar2;
    }

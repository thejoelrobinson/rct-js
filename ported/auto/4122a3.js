...
export function FUN_004122a3(heap, param_1, param_2, param_3, param_4, param_5) {
  ...
  let local_8 = 0;
  local_8 = 0;
  MVar1 = mmioGetInfo(heap, param_1, __addr_local_5c, 0);
  local_8 = (MVar1 != 0);
  if (local_8 == 0) {
    local_14 = param_2;
    ...
    for (local_c = 0; local_c < local_14; local_c = local_c + local_10) {
      ...
      heap.setU32((__addr_local_5c + 16), (heap.u32((__addr_local_5c + 16)) + local_10) >>> 0);
    }
    local_8 = mmioSetInfo(heap, param_1, __addr_local_5c, 0);
    if (local_8 == 0) {
      heap.setU32(param_5, (local_14) >>> 0);
      return 0;
    }
  }
  LAB_004123e9: heap.setU32(param_5, (0) >>> 0);
  return local_8;
} finally {
    heap.freeFrame(128);
  }

...
export function FUN_00437bb3(heap) {
  let cVar1 = 0;
  let in_EAX = 0;
  let in_CX = 0;
  let in_EDX = 0;
  ...
  if ((in_EAX < 0x1000) && (in_CX < 0x1000)) {
    pbVar6 = heap.u32((0x00971ef4) + ((ushort)((ushort)((in_CX & 0xfe0) << 7 | in_EAX & 0xfe0) >>> 5 | ((in_CX & 0xfe0) >>> 9) << 0xb)) * 4);

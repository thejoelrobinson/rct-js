...
export function FUN_0042727a(heap) {
  ...
  FUN_005e43de(heap);
  heap.setU32((unaff_ESI + (7) * 4), (heap.u32(0x005f5084)) >>> 0);
  heap.setU32((unaff_ESI + (3) * 4), (heap.u32(0x005f50d8)) >>> 0);
  heap.setU32((unaff_ESI + (6) * 4), (heap.u32(0x005f50f4)) >>> 0);
  heap.setU32(unaff_ESI, (heap.u32(0x005f50a0)) >>> 0);
  heap.setU32((unaff_ESI + (1) * 4), (heap.u32(0x005f50bc)) >>> 0);

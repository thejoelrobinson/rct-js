  ...
  if ((heap.u32((__addr_DAT_00887422) + (uVar2 * 0x130) * 4) & 1) != 0) {
    for (iVar1 = 0; iVar1 < heap.u32((byte)(__addr_DAT_00887498) + (uVar2 * 0x260) * 4); iVar1 = iVar1 + 1) {
      if (heap.u32((__addr_DAT_0088747e + iVar1 * 2 + uVar2 * 0x260)) != 0xffff) {
        heap.u32((__addr_DAT_00743bdc + heap.u32((__addr_DAT_0088747e + iVar1 * 2 + uVar2 * 0x260)) * 0x100)) = heap.u32((__addr_DAT_00743bdc + heap.u32((__addr_DAT_0088747e + iVar1 * 2 + uVar2 * 0x260)) * 0x100)) & 0xffdf;
      }
    }
  }
  FUN_005e5301(heap);

...
import { CONCAT11, CONCAT24, CONCAT44 } from "../runtime/win32.js";
...
export function FUN_005d6a1d(heap) {
  ...
  let sStack_20 = 0;
  let sVar16 = 0;
  uVar15 = CONCAT24(heap, heap.u32(0x0099a4e2), in_EAX);
  heap.setU32(0x006522ab, (unaff_EBX) >>> 0);
  heap.setU32(0x00652289, ((undefined1)(unaff_EBX >>> 8)) >>> 0);
  if (heap.u32(0x00656b34) == '\x14') {
    if (heap.u32(0x006522ab) == '\0') {
      heap.u16(0x99a02c) = 0xffff;
    ...
    heap.setU32(0x0099a4e2, ((undefined2)(uVar15 >>> 0x20)) >>> 0);
  ...
  while (true) {
    ...
    if (heap.u32(0x006522ab) == '\0') {
      for (pcVar10 = heap.u32((__addr_PTR_DAT_00652498) + (pcVar10) * 4); heap.u32(pcVar10) != -1; pcVar10 = pcVar10 + 10) {
        if ((heap.u32(pcVar10 + (9) * 4) & 1U) == 0) {
          ...
          heap.u32(psVar9) = sVar2;
          heap.u32(psVar9 + (1) * 4) = sVar5;
          heap.u32(psVar9 + (2) * 4) = -1;
        }
        LAB_005d6b52: 
      }
    }
    if ((heap.u32(0x006522ab) == '\x01') || (heap.u32(0x006522ab) == '\x02')) {
      uVar4 = CONCAT11(heap, uVar13, heap.u32(0x006522ab) != '\x01');
    ...
    if (heap.u32(0x006522ab) == '\x03') {
      for (pcVar10 = heap.u32((__addr_PTR_DAT_00652498) + (heap.u32(pbVar12)) * 4); heap.u32(pcVar10) != -1; pcVar10 = pcVar10 + 10) {
        ...
        if ((uVar3 < 0x1000) && (uVar6 < 0x1000)) {
          ...
          pbVar7 = heap.u32((__addr_DAT_00971ef4) + ((ushort)(uVar3 >>> 5 | uVar3 << 0xb)) * 4);
          ...
          sVar2 = (uVar8 - heap.u32((__addr_DAT_00653ef9 + (uint) * pbVar12 * 10))) + heap.u32((pcVar10 + 5)) + heap.u32(0x006522ac);
          if (sVar2 < uVar3) {
            heap.u16(0x6522ac) = heap.u32(0x006522ac) - (sVar2 - uVar3);
          }
        }
      }
    }
    ...
    switch (uVar13 & 3) {
      case 0:
        uVar4 = (uint)(ushort)(sVar16 + heap.u32((__addr_DAT_00653efd + iVar11)));
        in_ECX = (uint)(ushort)(sStack_20 + heap.u32((__addr_DAT_00653eff + iVar11)));
        break;
      case 1:
        uVar4 = (uint)(ushort)(sVar16 + heap.u32((__addr_DAT_00653eff + iVar11)));
        in_ECX = (uint)(ushort)(sStack_20 - heap.u32((__addr_DAT_00653efd + iVar11)));
        break;
      case 2:
        uVar4 = (uint)(ushort)(sVar16 - heap.u32((__addr_DAT_00653efd + iVar11)));
        in_ECX = (uint)(ushort)(sStack_20 - heap.u32((__addr_DAT_00653eff + iVar11)));
    ...
    uVar13 = (uVar13 & 3) + (uint)(byte)(heap.u32((__addr_DAT_00653ef8) + (iVar11) * 4) - heap.u32((__addr_DAT_00653ef7) + (iVar11) * 4)) & 3;
    if ((heap.u32((__addr_DAT_00653ef8) + (iVar11) * 4) & 4) != 0) {
      uVar13 = uVar13 | 4;
    }
    uVar8 = (uint)(ushort)((uVar8 - heap.u32((__addr_DAT_00653ef9 + iVar11))) + heap.u32((__addr_DAT_00653efb + iVar11)));
    if ((uVar13 & 4) == 0) {
      uVar4 = (uint)(ushort)(uVar4 + heap.u32((__addr_DAT_00652478) + (uVar13 * 2) * 4));
      in_ECX = (uint)(ushort)(in_ECX + heap.u32((__addr_DAT_0065247a) + (uVar13 * 2) * 4));
    }
    uVar15 = CONCAT24(heap, heap.u32(0x0099a4e2), uVar4);
    pbVar12 = pbVar12 + 2;
  }
  if (heap.u32(0x006522ab) == '\0') {
    heap.setU32(0x0099a020, (heap.u32(0x0099a020) & 0xfff7 | 6) >>> 0);

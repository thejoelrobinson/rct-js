...
export function FUN_005dcd40(heap) {
  ...
  if ((heap.u32((unaff_ESI + 0x48)) & 2) == 0) {
      ...
      do {
        ...
        while (uVar4 != 0xffff) {
          ...
          if ((__addr_DAT_00743b94 + iVar16 != unaff_ESI) && (heap.u32((__addr_DAT_00743b94) + (iVar16) * 4) == '\0')) {
            ...
            if ((uVar4 < 0x11) && ((heap.u32((__addr_DAT_005f7104 + heap.u32((uint)(byte)(__addr_DAT_00743bc5) + (iVar16) * 4) * 8)) & 0x40) != 0)) {
              uVar4 = sVar3 - heap.u32((__addr_DAT_00743ba2) + (uVar17 * 0x80) * 4);
              if (!SBORROW2(heap, sVar3, heap.u32((__addr_DAT_00743ba2) + (uVar17 * 0x80) * 4))) {
                if (uVar4 < 0) {
                  uVar4 = -uVar4;
                }
                uVar7 = in_CX - heap.u32((__addr_DAT_00743ba4) + (uVar17 * 0x80) * 4);
                if (!SBORROW2(heap, in_CX, heap.u32((__addr_DAT_00743ba4) + (uVar17 * 0x80) * 4))) {
                  if (uVar7 < 0) {
                    uVar7 = -uVar7;
                  }
                  if (!CARRY2(heap, uVar4, uVar7)) {
                    ...
                    if ((((bVar6 == bVar10) || (bVar6 != 5)) || (bVar10 != 6)) && ((ushort)(uVar4 + uVar7) < (ushort)((uint)((ushort)(heap.u32((unaff_ESI + 0x44)) + heap.u32((__addr_DAT_00743bd8 + iVar16))) >>> 1) * 0x1e >>> 8))) {
                      if ((heap.u32((__addr_DAT_005f7104 + heap.u32((uint)(byte)(__addr_DAT_00743bc5) + (iVar16) * 4) * 8)) & 0x4000) == 0) {
    ...
    if (__addr_DAT_00743b94 + iVar16 != unaff_ESI) {
      ...
      if (!SBORROW2(heap, sVar3, heap.u32((__addr_DAT_00743ba2) + (uVar15 * 0x80) * 4))) {
        if (uVar4 < 0) {
          uVar4 = -uVar4;
        }
        uVar7 = in_CX - heap.u32((__addr_DAT_00743ba4) + (uVar15 * 0x80) * 4);
        if (!SBORROW2(heap, in_CX, heap.u32((__addr_DAT_00743ba4) + (uVar15 * 0x80) * 4))) {
          if (uVar7 < 0) {
            uVar7 = -uVar7;
          }
          if (!CARRY2(heap, uVar4, uVar7)) {
            ...
            if (((!CARRY2(heap, uVar4 + uVar7, uVar11)) && ((ushort)(uVar4 + uVar7 + uVar11) < (ushort)((uint)((ushort)(heap.u32((unaff_ESI + 0x44)) + heap.u32((__addr_DAT_00743bd8 + iVar16))) >>> 1) * 0x1e >>> 8))) && (((heap.u32(unaff_ESI + (0x1e) * 4) - heap.u32((__addr_DAT_00743bb2) + (iVar16) * 4)) + 7U & 0x1f) < 0xf)) {
              return CONCAT44(heap, in_EDX, in_EAX);
            }
          }
        }

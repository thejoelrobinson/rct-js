...
export function FUN_00414690(heap) {
  ...
  (regs.eax = FUN_00414730(heap, pcVar2, 0, 0, __addr_local_8, __addr_local_4));
  iVar1 = (((regs.eax = FUN_004133c0(heap, heap.u32(__addr_local_4) + heap.u32(__addr_local_8) * 4))) >>> 0);
  if (iVar1 == 0) {
    __amsg_exit(8);
  }
  (regs.eax = FUN_00414730(heap, pcVar2, iVar1, iVar1 + heap.u32(__addr_local_8) * 4, __addr_local_8, __addr_local_4));

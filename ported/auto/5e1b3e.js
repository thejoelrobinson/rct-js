...
export function FUN_005e1b3e(heap) {
  ...
  if (heap.u32(unaff_ESI + (2) * 4) < heap.u32((unaff_EDI + 0x20))) {
    ...
    uVar3 = uVar2 - uVar4;
    heap.setU32(unaff_ESI, (uVar3) >>> 0);
    heap.setU32((unaff_ESI + (2) * 4), (heap.u32(unaff_ESI + (2) * 4) + uVar4) >>> 0);
    heap.setU32((unaff_ESI + (6) * 4), (uVar3 << (heap.u32(unaff_ESI + (8) * 4) & 0x1f)) >>> 0);
    heap.setU32((unaff_ESI + (4) * 4), (heap.u32(unaff_ESI + (4) * 4) + (uVar4 << (heap.u32(unaff_ESI + (8) * 4) & 0x1f))) >>> 0);
    uVar4 = FUN_005e1bfd(heap);
    heap.setU32((unaff_ESI + (4) * 4), (uVar9) >>> 0);
  ...
  if ((heap.u32(unaff_ESI + (2) * 4) + heap.u32(unaff_ESI)) <= (heap.u32((unaff_EDI + 0x20)) + heap.u32((unaff_EDI + 0x24)))) {
    if (heap.u32((unaff_EDI + 0x22)) <= heap.u32(unaff_ESI + (3) * 4)) {
      ...
      if ((heap.u32((unaff_EDI + 0x22)) + heap.u32((unaff_EDI + 0x26))) < uVar5) {
        ...
        uVar5 = uVar9 - uVar4;
        heap.setU32((unaff_ESI + (1) * 4), (uVar5) >>> 0);
        heap.setU32((unaff_ESI + (3) * 4), (heap.u32(unaff_ESI + (3) * 4) + uVar4) >>> 0);
        heap.setU32((unaff_ESI + (7) * 4), (uVar5 << (heap.u32(unaff_ESI + (8) * 4) & 0x1f)) >>> 0);
        heap.setU32((unaff_ESI + (5) * 4), (heap.u32(unaff_ESI + (5) * 4) + (uVar4 << (heap.u32(unaff_ESI + (8) * 4) & 0x1f))) >>> 0);
        uVar5 = FUN_005e1bfd(heap);
        heap.setU32((unaff_ESI + (5) * 4), (uVar3) >>> 0);
        heap.setU32((unaff_ESI + (1) * 4), (uVar9) >>> 0);
    ...
    heap.setU32((unaff_ESI + (5) * 4), (heap.u32(unaff_ESI + (5) * 4) + (uVar4 << (heap.u32(unaff_ESI + (8) * 4) & 0x1f))) >>> 0);
    uVar4 = FUN_005e1bfd(heap);
    heap.setU32((unaff_ESI + (5) * 4), (uVar9) >>> 0);

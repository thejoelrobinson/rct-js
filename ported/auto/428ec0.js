...
export function FUN_00428ec0(heap) {
  ...
  for (uVar6 = heap.u32(0x0087c398); uVar6 != 0xffff; uVar6 = heap.u32((0x00743b98) + (uVar6 * 0x80) * 4)) {
    ...
    if ((heap.u32((0x00743bc2) + (iVar8) * 4) == '\0') && (heap.u32((0x00743bbe) + (iVar8) * 4) == '\0')) {
      if (0x80 < heap.u32((byte)(0x00743bce) + (iVar8) * 4)) {
        uVar5 = uVar5 + 1;
      }
      if (((heap.u32((0x00743c5c + iVar8)) & 1) != 0) && (heap.u32((byte)(0x00743c5a) + (iVar8) * 4) < 0x5a)) {
        sVar7 = sVar7 + 1;
      }
    }
  }
  ...
  uVar3 = 0;
  for (uVar5 = heap.u32(0x0087c39c); uVar5 != 0xffff; uVar5 = heap.u32((0x00743b98) + (uVar5 * 0x80) * 4)) {
    if (0x1dff < (uint)(heap.u32((0x00743bb8 + uVar5 * 0x100)) - heap.u32(0x006e3b84))) {
      uVar3 = uVar3 + 1;
    }
  }
  if (0x95 < uVar3) {

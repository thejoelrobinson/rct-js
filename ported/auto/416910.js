...
export function FUN_00416910(heap, param_1, param_2, param_3, param_4) {
  ...
  if (heap.u32(piVar1) == 0x2d) {
    heap.u32(param_2) = 0x2d;
    puVar2 = param_2 + 1;
  }
  if (0 < param_3) {
    heap.u32(puVar2) = heap.u32(puVar2 + (1) * 4);
    puVar2 = puVar2 + 1;
  ...
  if (param_4 != 0) {
    heap.u32(puVar4) = 0x45;
  }
  if (heap.u32(heap.u32(piVar1 + (3) * 4)) != '0') {
    iVar3 = heap.u32(piVar1 + (1) * 4) + -1;
    if (iVar3 < 0) {
      iVar3 = -iVar3;
      heap.u32((puVar4 + 1)) = 0x2d;
    }
    if (99 < iVar3) {
      heap.u32((puVar4 + 2)) = heap.u32((puVar4 + 2)) + (((iVar3 / 100) + (iVar3 >>> 0x1f)) - (iVar3 * 0x51eb851f >>> 0x3f));
      iVar3 = iVar3 % 100;
    }
    if (9 < iVar3) {
      heap.u32((puVar4 + 3)) = heap.u32((puVar4 + 3)) + (((iVar3 / 10) + (iVar3 >>> 0x1f)) - (iVar3 * 0x66666667 >>> 0x3f));
      iVar3 = iVar3 % 10;
    }
    heap.u32((puVar4 + 1)) = heap.u32((puVar4 + 1)) + iVar3;
  }
  return param_2;
}

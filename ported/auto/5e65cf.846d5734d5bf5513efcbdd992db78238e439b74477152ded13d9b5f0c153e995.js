...
export function FUN_005e65cf(heap) {
  ...
  if (unaff_BL == 3) {
    ...
    if (heap.u32((0x00887441) + (iVar5) * 4) == 0) {
      ...
      if ((heap.u8(pbVar10) & 0x3c) == 0x10) {
        ...
        if (((bVar1 != 2) && (bVar1 != 3)) && (bVar1 != 1)) {
          ...
          heap.setU16(0x005f54f4, (heap.u32(((0x00887444) & 0xffff) + (uVar4 * 0x98) * 4)) >>> 0);
          heap.setU16(0x005f54f6, (((heap.u32(((0x00887444) >>> 0) + (uVar4 * 0x98) * 4) >>> 0x10) & 0xffff)) >>> 0);
          return uVar3;
        }
      ...
      heap.setU16(0x005f54f6, (heap.u32(((0x00887444) & 0xffff) + (uVar4 * 0x98) * 4)) >>> 0);
      heap.setU16(0x005f54f8, (((heap.u32(((0x00887444) >>> 0) + (uVar4 * 0x98) * 4) >>> 0x10) & 0xffff)) >>> 0);
    ...
    if (unaff_BL == 6) {
      heap.setU32(0x005f54f0, (0x4c2) >>> 0);
      heap.setU8(0x005f54f2, ((heap.u8((uVar4 + 4)) >>> 4) + 0x4d1) >>> 0);
      return uVar3;
    }
    if (unaff_BL == 7) {
      heap.setU32(0x005f54f0, (0x4c2) >>> 0);
      heap.setU8(0x005f54f2, ((heap.u8((uVar4 + 5)) & 0xf) + 0x632) >>> 0);
      return uVar3;
    }
    if (unaff_BL == 9) {
      heap.setU32(0x005f54f0, (0x4c2) >>> 0);
      heap.setU8(0x005f54f2, (heap.u16((0x0099fc3c + (uVar4 >>> 8 & 0xff) * 2))) >>> 0);
      return uVar3;
    }
    if (unaff_BL == 10) {
      heap.setU32(0x005f54f0, (0x4c2) >>> 0);

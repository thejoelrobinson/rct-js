...
export function FUN_004292b0(heap) {
  ...
  do {
    if ((heap.u32(pbVar1) != 0xff) && (heap.u32((pbVar1 + 0xf6)) != 0xffff)) {
      local_1c = local_1c + ((heap.u32((pbVar1 + 0xd4)) + heap.u32((pbVar1 + 0xd6)) + heap.u32((pbVar1 + 0xd8)) + heap.u32((pbVar1 + 0xda)) + heap.u32((pbVar1 + 0xdc)) + heap.u32((pbVar1 + 0xde)) + heap.u32((pbVar1 + 0xe0)) + heap.u32((pbVar1 + 0xe2)) + heap.u32((pbVar1 + 0xe4)) + heap.u32((pbVar1 + 0xe6))) + heap.u32((byte)(__addr_DAT_005f5d07) + (heap.u32(pbVar1) * 8) * 4) * 4) * heap.u32((pbVar1 + 0xf6));
    }
    pbVar1 = pbVar1 + 0x260;

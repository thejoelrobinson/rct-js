...
export function FUN_00403cd4(heap) {
  ...
  if (BVar1 != 0) {
    if (heap.u32((__addr_local_24 + 4)) == 0x12) {
      ...
      BVar1 = ((IsWindow(heap, heap.u32(0x005e91e0))) >>> 0);
      if ((BVar1 == 0) || (BVar1 = ((IsDialogMessageA(heap, heap.u32(0x005e91e0), __addr_local_24)) >>> 0), BVar1 == 0)) {
  ...
  return heap.u32(__addr_local_8) == 0;
} finally {
    heap.freeFrame(128);
  }
}

...
// HAND-FIX (ADDENDUM 106): 16-bit clip fields written as 32-bit — same defect
// as ported/auto/9b3e87.js, and THIS is the copy on the live blit path.
// 0x9a2024 / 0x9a2028 / 0x9a202c are 16-bit in the binary (`sub dx, word ptr
// [0x9a2028]` at 0x9b4975, `dec word ptr [0x9a202c]` at 0x9b49a2), and
// 0x9a202a / 0x9a202e are SEPARATE 16-bit fields. Writing the first three as
// u32 spilled into the second two.
// Evidence it is a SPURIOUS write by us rather than a missing one: single-
// stepping the interpreter through 60 blits shows the binary never writes
// 0x9a202a or 0x9a202e at all, yet the oracle's post-call scratch diff reported
// them differing on 50/1106 blits — so the extra bytes came from our side.
...
export function FUN_009b35fa(heap) {
  ...
  if (heap.i16((unaff_EDI + 0xe)) == 0) {
    ...
    if ((heap.u32(0x009a201c) & 4) != 0) {
      ...
      heap.setU16(0x009a2024, 0);                            // 0x9b386b DWORD
      ...
      if (cxv < 0) {                                         // 0x9b3886 jns
        ...
        heap.setU16(0x009a2024, (heap.u16(0x009a2024) - (cxv | 0)) >>> 0); // 0x9b3893 movsx ecx,cx; sub dword[0x9a2024],ecx
    ...
    uVar3 = ((CONCAT22(sVar5, heap.u32(0x009a2016))) >>> 0);
    heap.setU16(0x009a202c, (heap.u32(0x009a2016)) >>> 0);
    sVar5 = (((in_DX + sVar5) - heap.i16((unaff_EDI + 6))) & 0xffff);
    if (sVar5 < 0) {
      heap.setU16(0x009a202c, (heap.u32(0x009a2016) + sVar5) >>> 0);
    ...
    sVar2 = ((heap.u16(0x009a202c)) & 0xffff);
    sVar6 = ((sVar5 + heap.u16(0x009a202c) + -1) & 0xffff);
    if ((sVar6 == 0 || (((sVar5 + heap.u16(0x009a202c))) << 16 >> 16) < 1) || (heap.setU16(0x009a202c, (heap.u16(0x009a202c) - sVar6) >>> 0), heap.u16(0x009a202c) != 0 && sVar6 <= sVar2)) {
      ...
      if (sVar5 < 0) {
        heap.setU16(0x009a2028, (heap.u32(0x009a2014) + sVar5) >>> 0);
      ...
      sVar2 = ((heap.u16(0x009a2028)) & 0xffff);
      sVar6 = ((sVar5 + heap.u16(0x009a2028) + -1) & 0xffff);
      if (sVar6 != 0 && 0 < (((sVar5 + heap.u16(0x009a2028))) << 16 >> 16)) {
        heap.setU16(0x009a2028, (heap.u16(0x009a2028) - sVar6) >>> 0);
        if (heap.u16(0x009a2028) == 0 || sVar2 < sVar6) {
          return uVar3;
        }
  ...
  if ((heap.u32(0x009a201c) & 4) != 0) {
    ...
    heap.setU16(0x009a202c, (((uVar3) << 16 >> 16)) >>> 0);
    sVar5 = (((in_DX + sVar5 & 0xfffe) - heap.i16((unaff_EDI + 6))) & 0xffff);
    if (sVar5 < 0) {
      heap.setU16(0x009a202c, (heap.u16(0x009a202c) + sVar5) >>> 0);
      if (heap.u16(0x009a202c) < 0) {
        return uVar3;
      }
      if (heap.u16(0x009a202c) == 0) {
    ...
    if ((sVar6 == 0 || (((sVar5 + heap.u16(0x009a202c))) << 16 >> 16) < 1) || (heap.setU16(0x009a202c, (heap.u16(0x009a202c) - sVar6) >>> 0), heap.u16(0x009a202c) != 0 && sVar6 <= sVar2)) {
      ...
      if (sVar5 < 0) {
        ...
        heap.setU16(0x009a2024, (-((sVar5) | 0)) >>> 0);
        sVar5 = ((0) & 0xffff);
      }
      sVar2 = ((heap.u16(0x009a2028)) & 0xffff);
      sVar6 = ((sVar5 + heap.u16(0x009a2028) + -1) & 0xffff);
      if ((sVar6 == 0 || (((sVar5 + heap.u16(0x009a2028))) << 16 >> 16) < 1) || (heap.setU16(0x009a2028, (heap.u16(0x009a2028) - sVar6) >>> 0), heap.u16(0x009a2028) != 0 && sVar6 <= sVar2)) {
  ...
  if (sVar2 != 0) {
    sVar5 = (((in_DX + sVar5 & 0xfffe) - heap.i16((unaff_EDI + 6))) & 0xffff);
    heap.setU16(0x009a202c, (sVar2) >>> 0);
    if (sVar5 < 0) {
      heap.setU16(0x009a202c, (sVar2 + sVar5) >>> 0);
      if (heap.u16(0x009a202c) < 0) {
        return uVar3;
      }
      if (heap.u16(0x009a202c) == 0) {

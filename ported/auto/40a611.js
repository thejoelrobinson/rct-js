...
export function FUN_0040a611(heap, param_1, param_2) {
  ...
  if ((heap.u32(0x005ebf5c) != 0) && (heap.u32(0x005ebf60) != 0x0)) {
    if (heap.u32(0x005ebf54) == 0) {
      ...
      heap.setU32(param_2, (heap.u32(param_2) + heap.u32(__addr_local_28)) & 0xffffffff);
      heap.setU32((param_2 + (1) * 4), (heap.u32(param_2 + (1) * 4) + heap.u32((__addr_local_28 + 4))) & 0xffffffff);
      heap.setU32((param_2 + (2) * 4), (heap.u32(param_2 + (2) * 4) + heap.u32(__addr_local_28)) & 0xffffffff);
      heap.setU32((param_2 + (3) * 4), (heap.u32(param_2 + (3) * 4) + heap.u32((__addr_local_28 + 4))) & 0xffffffff);
    }
    do {

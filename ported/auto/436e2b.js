...
export function FUN_00436e2b(heap) {
  ...
  uVar9 = (uint)(ushort)((byte)(((ushort)(uVar2 * heap.u32((ushort)(byte)(0x00628aec) + (unaff_EBX) * 4)) >>> 8) + heap.u32((0x00628af1) + (unaff_EBX) * 4)) + 0x7097);
  iVar8 = uVar9 * 0x10;
  pbVar10 = heap.u32((0x008dc0b4) + (uVar9 * 4) * 4);
  cVar3 = heap.u32((0x008dc0b8) + (iVar8) * 4);
  cVar4 = heap.u32((0x008dc0ba) + (iVar8) * 4);
  if ((uVar2 & 0x100) != 0) {
    cVar3 = heap.u32((0x008dc0ba) + (iVar8) * 4);
    cVar4 = heap.u32((0x008dc0b8) + (iVar8) * 4);
  }
  uVar9 = uVar2 >>> 0x10;
  cVar7 = (uVar2 >>> 0x10);
  cVar6 = (uVar2 >>> 0x18);
  if ((uVar2 & 0x100) == 0) {
    ...
    if ((uVar2 & 0x200) == 0) {
      do {
        do {
          ...
          pbVar10 = pbVar10 + 1;
          if (heap.u32((byte)(0x00981efc) + (uVar2) * 4) <= bVar1) {
            heap.u32((0x00981efc) + (uVar2) * 4) = bVar1;
          }
          cVar6 = uVar2 + '\x01';
          cVar5 = cVar5 + -1;
    ...
    do {
      do {
        ...
        bVar1 = heap.u32(pbVar10);
        pbVar10 = pbVar10 + 1;
        if (heap.u32((byte)(0x00981efc) + (uVar9) * 4) <= bVar1) {
          heap.u32((0x00981efc) + (uVar9) * 4) = bVar1;
        }
        cVar7 = uVar9 + -1;
        cVar6 = cVar6 + -1;

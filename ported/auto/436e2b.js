...
export function FUN_00436e2b(heap) {
  ...
  heap.setU32(0x00628ae9, ((uVar2 >>> 8)) >>> 0);
  uVar9 = ((((uVar2 * heap.u32((__addr_DAT_00628aec) + (unaff_EBX) * 4)) >>> 8) + heap.u32((__addr_DAT_00628af1) + (unaff_EBX) * 4)) + 0x7097);
  iVar8 = uVar9 * 0x10;
  ...
  if ((uVar2 & 0x100) == 0) {
    ...
    if ((uVar2 & 0x200) == 0) {
      do {
        do {
          ...
          pbVar10 = pbVar10 + 1;
          if (heap.u32((__addr_DAT_00981efc) + (uVar2) * 4) <= bVar1) {
            heap.setU32(((__addr_DAT_00981efc) + (uVar2) * 4), (bVar1) >>> 0);
          }
          cVar6 = uVar2 + '\x01';
          cVar5 = cVar5 + -1;
    ...
    do {
      do {
        ...
        bVar1 = heap.u32(pbVar10);
        pbVar10 = pbVar10 + 1;
        if (heap.u32((__addr_DAT_00981efc) + (uVar9) * 4) <= bVar1) {
          heap.setU32(((__addr_DAT_00981efc) + (uVar9) * 4), (bVar1) >>> 0);
        }
        cVar7 = uVar9 + -1;
        cVar6 = cVar6 + -1;

...
export function FUN_0042dfd1(heap) {
  ...
  if (!in_ZF) {
    heap.setU8((unaff_ESI + (0x14)), (0xd) & 0xff);
    heap.setU8((unaff_ESI + (9)), (0x16) & 0xff);
    heap.setU8((unaff_ESI + (0x15)), (0xb) & 0xff);
    heap.setU32(unaff_ESI, (2) & 0xffffffff);
    (regs.eax = FUN_00444927(heap));
    heap.setU8((unaff_ESI + (1)), (7) & 0xff);
    heap.setU16((unaff_ESI + 0x26), (0) & 0xffff);
    heap.setU16((unaff_ESI + 0x24), (unaff_BX) & 0xffff);
  }
  return 1;
}

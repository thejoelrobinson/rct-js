...
export function FUN_005d91cd(heap) {
  ...
  uVar1 = 0;
  do {
    uVar1 = uVar1 + heap.u32((0x008874c4 + iVar2 * 2 + unaff_EDI));
    iVar2 = iVar2 + 1;
  } while (iVar2 < heap.u32((byte)(0x00887497) + (unaff_EDI) * 4));
  if (uVar1 == 0) {
    uVar1 = 1;
  }
  heap.u32((0x008874ac + unaff_EDI)) = heap.u32((0x008874ac + unaff_EDI)) / uVar1;
  FUN_005e5301(heap);
  return;
}

          ...
          if (heap.u32((__addr_local_1c + 4)) < 0x10) {
            ...
            if (LVar1 == 0x10) {
              if ((heap.u32(__addr_local_30 + (0) * 4) & 0xffff) == 1) {
                ...
                LVar1 = mmioRead(local_20, __addr_local_34, 2);
                if (LVar1 != 2) {
                  local_8 = 0xe102;
              ...
              if (heap.u32(param_3) == 0) {
                ...
                heap.u32((heap.u32(param_3) + 0x10)) = heap.u32(__addr_local_34);
                if (((heap.u32(__addr_local_34) & 0xffff) == 0) || (uVar3 = mmioRead(local_20, (heap.u32(param_3) + 0x12), heap.u32(__addr_local_34) & 0xffff), uVar3 == (heap.u32(__addr_local_34) & 0xffff))) {

...
export function FUN_005db339(heap) {
  ...
  let puVar7 = 0;
  let uVar8 = 0;
  heap.setU32((unaff_ESI + (0x50) * 4), (8) >>> 0);
  FUN_005db5d7(heap);
  iVar6 = heap.u32((unaff_ESI + 0x28)) >>> 10;
  puVar7 = unaff_ESI;
  while (true) {
    heap.setU32((puVar7 + (0x51) * 4), (0) >>> 0);
    ...
    heap.setU32((puVar7 + 0xb6), ((((heap.u32((__addr_DAT_0065ead8 + (heap.u32(puVar7 + (0x1e) * 4) >>> 1) * 4)) * (iVar4 >>> 0xf) >>> 0x10) * iVar6) >>> 8)) >>> 0);
    heap.setU32((puVar7 + 0xc0), ((((sVar1 * (iVar4 >>> 0xf) >>> 0x10) * iVar6) >>> 8)) >>> 0);
    heap.setU32((puVar7 + 0x4e), ((((iVar5 >>> 0x17) * iVar6) >>> 8)) >>> 0);
    uVar8 = FUN_005df40c(heap);
    iVar6 = (uVar8 >>> 0x20);
    heap.setU32((puVar7 + 0xb6), (heap.u32((puVar7 + 0xb6)) + ((uVar8 & 0xf) - 8)) >>> 0);
    heap.setU32((puVar7 + 0xc0), (heap.u32((puVar7 + 0xc0)) + (((uVar8 >>> 4) & 0xf) - 8)) >>> 0);
    heap.setU32((puVar7 + 0x4e), (heap.u32((puVar7 + 0x4e)) + (((uVar8 >>> 8) & 0xf) - 8)) >>> 0);
    heap.setU32((puVar7 + 0x38), (0) >>> 0);
    heap.setU32((puVar7 + 0x3a), (0) >>> 0);
    heap.setU32((puVar7 + 0x3c), (0) >>> 0);
  ...
  heap.setU32((__addr_DAT_00743bd6 + uVar2 * 0x100), (uVar3) >>> 0);
  heap.setU32((__addr_DAT_00743bd4 + uVar3 * 0x100), (uVar2) >>> 0);

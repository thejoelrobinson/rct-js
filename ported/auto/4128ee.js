...
export function FUN_004128ee(heap, param_1, param_2, param_3, param_4) {
  ...
  let MVar3 = 0;
  let local_8 = 0;
  LVar2 = mmioSeek(heap, heap.u32(param_1), heap.u32((param_3 + 12)) + 4, 0);
  if (LVar2 == -1) {
    local_8 = 0xe102;
  } else {
    local_8 = 0;
    while (MVar3 = mmioDescend(heap, heap.u32(param_1), param_2, param_3, 0), MVar3 == 0 && (heap.u32((param_2 + 4)) + heap.u32((param_2 + 12)) <= heap.u32((param_3 + 4)) + heap.u32((param_3 + 12)))) {

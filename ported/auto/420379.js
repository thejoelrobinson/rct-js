...
export function FUN_00420379(heap) {
  ...
  heap.setU32((unaff_EDI + 0x132), (((iVar1 + heap.u32((__addr_DAT_005f67a4 + iVar2)) * heap.u32(0x008ae984) + heap.u32((__addr_DAT_005f67a6 + iVar2)) * heap.u32(0x008ae982) + heap.u32((__addr_DAT_005f67a8 + iVar2)) * heap.u32(unaff_EDI + (0x78) * 4) + heap.u32((__addr_DAT_005f67aa + iVar2)) * heap.u32(unaff_EDI + (0x79) * 4) + heap.u32((__addr_DAT_005f67ac + iVar2)) * heap.u32(unaff_EDI + (0x77) * 4)) * 10 >>> 4)) >>> 0);
  heap.setU32((unaff_EDI + (0xfd) * 4), (heap.u32(unaff_EDI + (0xfd) * 4) | 2) >>> 0);
  return;
} finally {
    heap.freeFrame(36);
  }

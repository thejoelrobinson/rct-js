...
export function FUN_005d8c79(heap) {
  ...
  if (heap.u32((unaff_ESI + 0x50)) == '\a') {
    ...
    heap.u32((__addr_DAT_00887422 + unaff_EDI)) = heap.u32((__addr_DAT_00887422 + unaff_EDI)) | 8;
  ...
  heap.u32((__addr_DAT_008874b1) + (unaff_EDI) * 4) = bVar9;
  uVar4 = heap.u32((unaff_ESI + 0x28));
  if (uVar4 < 0) {
    uVar4 = -uVar4;
  }
  if (heap.u32((__addr_DAT_008874a8 + unaff_EDI)) < uVar4) {
    heap.u32((__addr_DAT_008874a8 + unaff_EDI)) = uVar4;
  }
  bVar2 = heap.u32((__addr_DAT_008874b0) + (unaff_EDI) * 4);
  if ((bVar9 == 0) && (0x8000 < uVar4)) {
    heap.u32((__addr_DAT_008874ac + unaff_EDI)) = heap.u32((__addr_DAT_008874ac + unaff_EDI)) + uVar4;
    heap.u32((__addr_DAT_008874c4 + bVar2 * 2 + unaff_EDI)) = heap.u32((__addr_DAT_008874c4 + bVar2 * 2 + unaff_EDI)) + 1;
  }
  ...
  if ((heap.u32((__addr_DAT_005f5b78 + heap.u32((uint)(byte)(__addr_DAT_00887420) + ((uint) * (unaff_ESI + 0x30) * 0x260) * 4) * 8)) & 0x80) != 0) {
    ...
    heap.u32((__addr_DAT_008874d2 + unaff_EDI)) = sVar3;
    heap.u32((__addr_DAT_008874d4 + unaff_EDI)) = sVar7;
    if (heap.u32((__addr_DAT_008874cc + unaff_EDI)) < sVar3) {
      heap.u32((__addr_DAT_008874cc + unaff_EDI)) = sVar3;
    }
    if (sVar3 < heap.u32((__addr_DAT_008874ce + unaff_EDI))) {
      heap.u32((__addr_DAT_008874ce + unaff_EDI)) = sVar3;
    }
    if (sVar7 < 0) {
      sVar7 = -sVar7;
    }
  ...
  heap.u32((__addr_DAT_008874dc + unaff_EDI)) = sVar3;
  heap.u32((__addr_DAT_008874ef) + (unaff_EDI) * 4) = cVar10;
  uVar6 = heap.u32((unaff_ESI + 0x36)) >>> 2;
  if ((heap.u32((unaff_ESI + 0x48)) & 1) == 0) {
    heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) & 0xffffffbf;
  } else {
    ...
    if ((uVar4 >>> 6 & 1) == 0) {
      ...
      if (0xbf < bVar9) {
        heap.u32((__addr_DAT_008874e5) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874e5) + (unaff_EDI) * 4) + -0x40;
      }
    }
  }
  if (uVar6 == 0x71) {
    heap.u32((__addr_DAT_008874a5) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874a5) + (unaff_EDI) * 4) | 0x20;
  }
  if (uVar6 == 0x70) {
    heap.u32((__addr_DAT_008874a5) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874a5) + (unaff_EDI) * 4) | 0x40;
  }
  if (uVar6 == 0x78) {
    heap.u32((__addr_DAT_008874a5) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874a5) + (unaff_EDI) * 4) | 0x80;
  }
  ...
  if ((uVar4 & 2) == 0) {
    if ((uVar4 & 4) == 0) {
      if ((uVar6 & 2) != 0) {
        heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) | 2;
        heap.u32((__addr_DAT_008874de + unaff_EDI)) = heap.u32((__addr_DAT_008874de + unaff_EDI)) & 0x7ff;
        if ((uVar6 & 8) != 0) {
          heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) | 8;
        }
        if ((uVar6 & 0x10) != 0) {
          heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) | 0x10;
        }
      }
      if ((uVar6 & 4) != 0) {
        heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) | 4;
        heap.u32((__addr_DAT_008874de + unaff_EDI)) = heap.u32((__addr_DAT_008874de + unaff_EDI)) & 0x7ff;
        if ((uVar6 & 8) != 0) {
          heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) | 8;
        }
      ...
      heap.u32((__addr_DAT_008874de + unaff_EDI)) = heap.u32((__addr_DAT_008874de + unaff_EDI)) + 0x800;
    }
  } else {
    if ((uVar6 & 2) == 0) {
    LAB_005d8e62: heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) & 0xfffffff9;
    heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) & 0xffffffe7;
  ...
  if ((uVar4 & 0x20) == 0) {
    if (((uVar6 & 0x20) != 0) && (-1 < heap.u32((unaff_ESI + 0x28)))) {
      heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) & 0xffffff7f;
      heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) | 0x20;
      bVar9 = heap.u32((__addr_DAT_008874e5) + (unaff_EDI) * 4) & 0x3f;
      if (bVar9 != 0x3f) {
        bVar9 = bVar9 + 1;
      }
      heap.u32((__addr_DAT_008874e5) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874e5) + (unaff_EDI) * 4) & 0xc0;
      heap.u32((__addr_DAT_008874e5) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874e5) + (unaff_EDI) * 4) | bVar9;
      heap.u32((__addr_DAT_008874e6) + (unaff_EDI) * 4) = (heap.u32((unaff_ESI + 0x12)) >>> 2);
      uVar4 = uVar4 & 0xffffff7f;
    }
  } else {
    if ((heap.u32((unaff_ESI + 0x28)) < 0) || ((uVar6 & 0x20) == 0)) {
    heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) & 0xffffffdf;
    bVar9 = (byte)(heap.u32((unaff_ESI + 0x12)) >>> 2);
    cVar10 = bVar9 - heap.u32((__addr_DAT_008874e6) + (unaff_EDI) * 4);
    if ((bVar9 < heap.u32((byte)(__addr_DAT_008874e6) + (unaff_EDI) * 4) || cVar10 == '\0') && (bVar9 = -cVar10, heap.u32((byte)(__addr_DAT_008874e7) + (unaff_EDI) * 4) < bVar9)) {
      heap.u32((__addr_DAT_008874e7) + (unaff_EDI) * 4) = bVar9;
    }
  }
  }
  if ((uVar4 & 0x80) == 0) {
    if (((uVar6 & 0x40) != 0) && (heap.u32((unaff_ESI + 0x28)) < 1)) {
      heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) & 0xffffffdf;
      heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) | 0x80;
      bVar9 = heap.u32((__addr_DAT_008874e5) + (unaff_EDI) * 4) & 0x3f;
      if (bVar9 != 0x3f) {
        bVar9 = bVar9 + 1;
      }
  ...
  if ((uVar6 & 0x80) != 0) {
    ...
    heap.u32((__addr_DAT_008874e4) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874e4) + (unaff_EDI) * 4) & 0xe0;
    heap.u32((__addr_DAT_008874e4) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874e4) + (unaff_EDI) * 4) | bVar9;
  }
  if ((uVar6 & 0x800) != 0) {
    ...
    heap.u32((__addr_DAT_008874a5) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874a5) + (unaff_EDI) * 4) & 0xe0;
    heap.u32((__addr_DAT_008874a5) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874a5) + (unaff_EDI) * 4) | bVar9;
  }
  LAB_005d90f1: if (heap.u32((unaff_ESI + 0xe)) != 0x8000) {
    ...
    if (heap.u32((unaff_ESI + 0x12)) < (ushort)(heap.u32(pbVar8 + (2) * 4) * 4)) {
      if ((uVar4 & 1) == 0) {
        ...
        heap.u32((__addr_DAT_008874ee) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874ee) + (unaff_EDI) * 4) & 0xe0;
        heap.u32((__addr_DAT_008874ee) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874ee) + (unaff_EDI) * 4) | bVar9;
        if (heap.u32((unaff_ESI + 0x1f)) != '\0') {
          heap.u32((__addr_DAT_008874ee) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874ee) + (unaff_EDI) * 4) | 0x20;
        }
        if (heap.u32((unaff_ESI + 0x20)) != '\0') {
          heap.u32((__addr_DAT_008874ee) + (unaff_EDI) * 4) = heap.u32((__addr_DAT_008874ee) + (unaff_EDI) * 4) | 0x40;
        }
      }
      iVar5 = (heap.u32((unaff_ESI + 0x2c)) + heap.u32((unaff_ESI + 0x28)) >>> 10) * 0x2a;
      if (iVar5 < 0) {
      ...
      heap.u32((__addr_DAT_008874e8 + unaff_EDI)) = heap.u32((__addr_DAT_008874e8 + unaff_EDI)) + iVar5;
      return;
    }
  }
  heap.u32((__addr_DAT_008874d8 + unaff_EDI)) = heap.u32((__addr_DAT_008874d8 + unaff_EDI)) & 0xfffffffe;
  return;
} finally {
    heap.freeFrame(116);
  }

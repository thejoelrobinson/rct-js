...
export function FUN_00401972(heap) {
  ...
  return (regs.eax = callIndirect(heap, heap.u32(0x005ebe9c), heap.u32(0x005e9100), __addr_local_bc, __addr_local_ac, heap.u32(__addr_local_bc), heap.u32(__addr_local_b8)));
} finally {
    heap.freeFrame(184);
  }
}

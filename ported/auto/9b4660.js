...
export function FUN_009b4660(heap) {
  ...
  if ((unaff_EBX & 0x20000000) != 0) {
    ...
    do {
      iVar7 = CONCAT22(heap, (iVar7 >>> 0x10), heap.u32(0x009a2028));
      do {
        if (heap.u32(((uint) * unaff_ESI + iVar2)) != 0) {
          heap.u32(unaff_EDI) = heap.u32(((uint) * unaff_ESI + iVar2));
        }
        ...
        iVar7 = CONCAT22(heap, uVar8, sVar5 + -1);
        pbVar9 = unaff_ESI + 1;
        pbVar10 = unaff_EDI + 1;
        if ((sVar5 + -1) == 0) {
          break;
        ...
        iVar7 = CONCAT22(heap, uVar8, sVar5 + -2);
        pbVar9 = unaff_ESI + 2;
        pbVar10 = unaff_EDI + 2;
        if ((sVar5 + -2) == 0) {
          break;
        ...
        iVar7 = CONCAT22(heap, uVar8, sVar5 + -3);
        pbVar10 = unaff_EDI + 3;
        if ((sVar5 + -3) == 0) {
          break;
        }
        unaff_ESI = unaff_ESI + 4;
        bVar3 = heap.u32(((uint) * pbVar9 + iVar2));
        if (bVar3 != 0) {
          heap.u32(unaff_EDI + (3) * 4) = bVar3;
        }
        unaff_EDI = unaff_EDI + 4;
        iVar7 = CONCAT22(heap, uVar8, sVar5 + -4);
        pbVar9 = unaff_ESI;
        pbVar10 = unaff_EDI;
      } while ((sVar5 + -4) != 0);
      ...
      if (uVar4 != 1) {
        ...
        if (uVar4 != 2) {
          ...
          if (uVar4 != 3) {
            ...
            unaff_EDI = unaff_EDI + 4;
            uVar4 = uVar4 - 4;
            in_EAX = CONCAT31(heap, (int3)(iVar2 >>> 8), bVar3);
            pbVar9 = unaff_ESI;
            pbVar10 = unaff_EDI;
            if (uVar4 != 0) {
    ...
    do {
      ...
      do {
        ...
        if (heap.u32(unaff_ESI + (1) * 4) != 0) {
          heap.u32(pbVar10) = heap.u32(((uint) * pbVar10 + iVar2));
        }
        pbVar10 = unaff_EDI + 2;
        iVar7 = CONCAT22(heap, uVar8, sVar5 + -2);
        pbVar9 = unaff_ESI + 2;

...
export function FUN_005dd134(heap) {
  ...
  iVar5 = uVar4 * 0x260;
  heap.u32((0x00887422) + (uVar4 * 0x130) * 4) = heap.u32((0x00887422) + (uVar4 * 0x130) * 4) & 0xff3f;
  heap.u32((0x0088751d) + (iVar5) * 4) = heap.u32((0x0088751d) + (iVar5) * 4) | 0xc;
  puVar1 = 0x00887422 + uVar4 * 0x130;
  uVar2 = heap.u32(puVar1);
  heap.u32(puVar1) = heap.u32(puVar1) & 0xfffe;
  if ((uVar2 & 1) != 0) {
    heap.u32((0x00887422) + (uVar4 * 0x130) * 4) = heap.u32((0x00887422) + (uVar4 * 0x130) * 4) & 0xf7fb;
    uVar4 = 0;
    do {
      LOCK(heap);
      uVar2 = heap.u32((0x0088747e + uVar4 * 2 + iVar5));
      heap.u32((0x0088747e + uVar4 * 2 + iVar5)) = 0xffff;
      UNLOCK(heap);
      for (; uVar2 != 0xffff; uVar2 = heap.u32((0x00743bd2 + uVar2 * 0x100))) {
        FUN_005e53ca(heap);
    ...
    uVar4 = 0;
    do {
      heap.u32((0x0088745e) + (uVar4 + iVar5) * 4) = 0xff;
      uVar4 = uVar4 + 1;
    } while (uVar4 < 4);
  }
  bVar6 = true;

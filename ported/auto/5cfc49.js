...
export function FUN_005cfc49(heap) {
  ...
  uVar5 = unaff_EBX ^ 2;
  if ((uVar5 & 4) == 0) {
    in_EAX = CONCAT22(heap, (in_EAX >>> 0x10), in_EAX + heap.u32((__addr_DAT_00652478) + (uVar5 * 2) * 4));
    in_CX = in_CX + heap.u32((__addr_DAT_0065247a) + (uVar5 * 2) * 4);
  }
  uVar2 = in_EAX;
  uVar4 = in_CX << 7 | in_CX >>> 9 | uVar2;
  pbVar6 = heap.u32((__addr_DAT_00971ef4) + ((ushort)(uVar4 >>> 5 | uVar4 << 0xb)) * 4);
  do {
    if ((((heap.u32(pbVar6) & 0x3c) == 8) && (heap.u32(pbVar6 + (7) * 4) == heap.u32(0x00652470))) && (heap.u32(heap.u32((__addr_PTR_DAT_00652498) + (heap.u32(pbVar6 + (4) * 4)) * 4) + ((heap.u32((pbVar6 + 5)) & 0xf) * 10 + 10) * 4) == -1)) {
      ...
      uVar4 = CONCAT11(heap, heap.u32((__addr_DAT_00653ef8) + (iVar7) * 4), heap.u32((__addr_DAT_00653ef8) + (iVar7) * 4)) & 0x4ff;
      uVar5 = CONCAT11(heap, (uVar4 >>> 8), uVar4 + heap.u32(pbVar6)) & 0xffffff03;
      if (((byte)(uVar5 | (byte)(uVar5 >>> 8)) == unaff_EBX) && ((ushort)(heap.u32(pbVar6 + (2) * 4) * 4 + (heap.u32((__addr_DAT_00653efb + iVar7)) - heap.u32((heap.u32((__addr_PTR_DAT_00652498) + (heap.u32(pbVar6 + (4) * 4)) * 4) + (heap.u32(pbVar6 + (5) * 4) & 0xf) * 10 + 5)))) == in_DX)) {
        ...
        return CONCAT24(heap, heap.u32(pbVar6 + (2) * 4) * 4 + (heap.u32((heap.u32((__addr_PTR_DAT_00652498) + (heap.u32(pbVar6 + (4) * 4)) * 4) + 5)) - heap.u32((heap.u32((__addr_PTR_DAT_00652498) + (heap.u32(pbVar6 + (4) * 4)) * 4) + (heap.u32((pbVar6 + 5)) & 0xf) * 10 + 5))), CONCAT22(heap, sVar3, uVar2));
      }
    }
    pbVar1 = pbVar6 + 1;
    pbVar6 = pbVar6 + 8;

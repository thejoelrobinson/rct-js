...
export function FUN_004274a9(heap) {
  ...
  heap.setU32((unaff_ESI + 0x59), (5) >>> 0);
  FUN_005e43de(heap);
  heap.setU32((unaff_ESI + (7) * 4), (heap.u32(0x005f5098)) >>> 0);
  heap.setU32((unaff_ESI + (3) * 4), (heap.u32(0x005f50ec)) >>> 0);
  heap.setU32((unaff_ESI + (6) * 4), (heap.u32(0x005f5108)) >>> 0);
  heap.setU32(unaff_ESI, (heap.u32(0x005f50b4)) >>> 0);
  heap.setU32((unaff_ESI + (1) * 4), (heap.u32(0x005f50d0)) >>> 0);
  heap.setU32((unaff_ESI + (5) * 4), (0) >>> 0);
  FUN_005e412c(heap);
  uVar2 = heap.u32(0x00971edc) >>> 1;
  heap.setU32((unaff_ESI + 8), ((heap.u32(0x00971eda) >>> 1) - 0x73) >>> 0);
  heap.setU32((unaff_ESI + 0x22), (uVar2 - 0x5b) >>> 0);
  FUN_005e43de(heap);
  return;
}

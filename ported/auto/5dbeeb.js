...
function FUN_005dbeeb_frozen(heap) {
  ...
  if (0x3689 < iVar6) {
    ...
    heap.setU32(0x0065dc48, (heap.u32((unaff_ESI + 0xe))) >>> 0);
    heap.setU32(0x0065dc4c, (heap.i16((unaff_ESI + 0x12))) >>> 0);
    uVar23 = (((regs.esi = 0x743b94, regs.eax = FUN_005e53ca(heap))) >>> 0);
    do {
      LAB_005dc538: {
      ...
      if (((heap.i16((unaff_ESI + 0x34)) + 1) & 0xffff) < heap.u16((pbVar20 + -2))) {
        ...
        LAB_005dc98a: do {
          do {
            ...
            heap.setI16((unaff_ESI + 0x34), (sVar3) & 0xffff);
            psVar21 = (((heap.u32((unaff_ESI + 0x34)) * 10 + heap.i32((heap.u32((0x0067af10) + (((heap.u8(unaff_ESI + (0xcd))) & 0xff)) * 4) + heap.u32((unaff_ESI + 0x36)) * 4)))) >>> 0);
  ...
  (regs.ecx = 0x670000, regs.esi = 0x743b94, regs.eax = FUN_00444927(heap));
  (regs.esi = 0x743b94, regs.eax = FUN_005e53ca(heap));
  }
  ...
  LAB_005dcd0c: if (((heap.u16((puVar2 + 0x36)) >>> 2 == 0x75) && (0x2f < heap.u16((puVar2 + 0x34)))) && (heap.u16((puVar2 + 0x34)) < 0x81)) {
    iVar6 = ((iVar6 - (heap.i32((puVar2 + 0x28)) >>> 6)) >>> 0);
  }
  heap.setI32((puVar2 + 0x2c), (iVar6) & 0xffffffff);
  return heap.u32(0x0065dc40);
...
export function FUN_005dbeeb(heap) {
  if ((globalThis.__realStartup || state.executionMode === "pure-js") &&
      state.promotedLiftedAddresses.has(0x5dbeeb)) {
    return callIndirect(heap, 0x5dbeeb);
  }
  return FUN_005dbeeb_frozen(heap);
}

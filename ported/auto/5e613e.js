...
import { CONCAT22, CONCAT31, DAT_005f5500_2, SCARRY2 } from "../runtime/win32.js";
  ...
  if ((heap.u32(0x0099a500) & 1) == 0) {
    ...
    if (cVar12 == '\x03') {
      ...
      if ((heap.u32(pbVar11) & 0x3c) == 0x10) {
        if (heap.u32(pbVar11 + (4) * 4) != 0) {
          ...
          if (1 < heap.u32((byte)(0x00887497) + (iVar16) * 4)) {
            heap.setU32(0x005f54f0, (0x56e) >>> 0);
          }
          heap.setU32(0x005f54f2, (heap.u32((0x00887442) + (uVar8 * 0x130) * 4)) >>> 0);
          heap.setU32(0x005f54f4, (heap.u32((undefined2)(0x00887444) + (uVar8 * 0x98) * 4)) >>> 0);
          heap.setU32(0x005f54f6, ((undefined2)(heap.u32((uint)(0x00887444) + (uVar8 * 0x98) * 4) >>> 0x10)) >>> 0);
          uVar5 = (heap.u32(pbVar11 + (5) * 4) & 0x70) >>> 4;
          uVar15 = uVar5;
          do {
            if (heap.u32((0x0088744a) + (uVar8 * 0x130 + uVar15) * 4) == -1) {
              uVar5 = uVar5 - 1;
            }
            uVar15 = uVar15 - 1;
          } while (-1 < uVar15);
        ...
        heap.setU32(0x005f54f6, (heap.u32((undefined2)(0x00887444) + (uVar8 * 0x98) * 4)) >>> 0);
        heap.setU32(0x005f54f8, ((heap.u32((uint)(0x00887444) + (uVar8 * 0x98) * 4) >>> 0x10)) >>> 0);
        uVar4 = (heap.u32(pbVar11 + (5) * 4) & 0x70) >>> 4;
        uVar15 = uVar4;
        uVar5 = uVar4;
        do {
          if (heap.u32((0x0088744a) + (uVar8 * 0x130 + uVar5) * 4) == -1) {
            uVar15 = uVar15 - 1;
          }
          uVar5 = uVar5 - 1;
        } while (-1 < uVar5);
        ...
        uVar17 = 0;
        if (heap.u32((0x00887462) + (uVar8 * 0x130 + uVar4) * 4) != -1) {
          uVar17 = heap.u32((ushort)(byte)(0x0088747a) + (iVar16 + uVar4) * 4);
        }
        heap.setU32(0x005f5500, (CONCAT22(heap, DAT_005f5500_2, uVar17)) >>> 0);
      ...
      heap.setU32(0x005f54f6, (heap.u32((undefined2)(0x00887444) + (uVar8 * 0x98) * 4)) >>> 0);
      heap.setU32(0x005f54f8, ((heap.u32((uint)(0x00887444) + (uVar8 * 0x98) * 4) >>> 0x10)) >>> 0);
      bVar1 = heap.u32((0x00887420) + (iVar16) * 4);
      heap.setU32(0x005f54fa, (heap.u32((0x005f5806 + bVar1 * 8)) + 2) >>> 0);
      uVar5 = (heap.u32(pbVar11 + (5) * 4) & 0x70) >>> 4;
      uVar15 = uVar5;
      do {
        if (heap.u32((0x0088744a) + (uVar8 * 0x130 + uVar15) * 4) == -1) {
    ...
    if (cVar12 == '\x02') {
      ...
      if (bVar1 == 0) {
        ...
        heap.setU32(0x005f54f6, (heap.u32((undefined2)(0x00887444) + (uVar8 * 0x98) * 4)) >>> 0);
        heap.setU32(0x005f54f8, ((heap.u32((uint)(0x00887444) + (uVar8 * 0x98) * 4) >>> 0x10)) >>> 0);
        heap.setU32(0x005f54fa, (heap.u32((0x005f5802 + heap.u32((uint)(byte)(0x00887420) + (uVar8 * 0x260) * 4) * 8)) + 2) >>> 0);
        for (pbVar10 = pbVar11; heap.u32(pbVar10 + (1) * 4) != 0; pbVar10 = 0x00743b94 + (uint) * (pbVar10 + 0x40) * 0x100) {
        ...
        do {
          iVar18 = iVar16;
          iVar16 = iVar18 + 1;
        } while (heap.u32((pbVar10 + 10)) != heap.u32((0x0088747e + iVar16 * 2 + uVar8 * 0x260)));
        sVar13 = iVar18 + 2;
    ...
    if (((unaff_ESI != 0) && (pbVar11 = heap.u32((unaff_ESI + 8)), pbVar11 != 0x0)) && (heap.u32(pbVar11 + (0x10) * 4) < 2)) {
      ...
      unaff_EBP = CONCAT22(heap, (unaff_EBP >>> 0x10), 0xffff);
      for (uVar17 = heap.u32(0x0087c398); uVar17 != 0xffff; uVar17 = heap.u32((0x00743b98) + (uVar17 * 0x80) * 4)) {
        iVar18 = uVar17 * 0x100;
        if (heap.u32((0x00743baa + iVar18)) != -0x8000) {
          sVar7 = ((heap.u32((0x00743baa + iVar18)) + heap.u32((0x00743bae + iVar18))) >>> 1) - uVar2;
          if (sVar7 < 0) {
            sVar7 = -sVar7;
          }
          sVar9 = ((heap.u32((0x00743bac + iVar18)) + heap.u32((0x00743bb0 + iVar18))) >>> 1) - sVar13;
          if (sVar9 < 0) {
            sVar9 = -sVar9;
          }
          if ((!SCARRY2(heap, sVar7, sVar9)) && ((ushort)(sVar7 + sVar9) < unaff_EBP)) {
            unaff_EBP = CONCAT22(heap, (unaff_EBP >>> 0x10), sVar7 + sVar9);
            pbVar11 = 0x00743b94 + iVar18;
          }
        }
      }
      if (unaff_EBP < 0x21) {
        unaff_EBX = CONCAT31(heap, (int3)(CONCAT22(heap, (unaff_EBX >>> 0x10), sVar13) >>> 8), 2);
        unaff_ESI = iVar16;
        ...
        if (heap.u32(pbVar11 + (0x2e) * 4) != 0) {
          ...
          heap.setU32(0x005f54f6, ((undefined2)((uint) * (pbVar11 + 0x9c) >>> 0x10)) >>> 0);
          ...
          heap.setU32(0x005f54fe, ((ushort)(uVar19 >>> 0x30)) >>> 0);
          return uVar19;
        }
        ...
        heap.setU32(0x005f54fa, (((uint) * (pbVar11 + 0x9c) >>> 0x10)) >>> 0);

...
export function FUN_0042ef8a(heap) {
  ...
  let uVar3 = 0;
  let uVar4 = 0;
  iVar2 = FUN_00405653(heap, 0x005f8540, 0x005f8850);
  if (iVar2 == 0) {
  ...
  do {
    uVar3 = 0;
    LAB_0042f06b: heap.u32((0x005f851c) + (uVar3) * 4) = 0;
    uVar4 = uVar3;
    FUN_0042f239(heap);
    ...
    if (iVar2 != -1) {
      ...
      if (0x16 < uVar3) {
        ...
        heap.setU32(0x005f8d5d, (heap.u32((0x0063297d) + (heap.u32(0x005f8d5f)) * 4)) >>> 0);
        heap.setU32(0x005f8d5e, (heap.u32((0x00632980) + (heap.u32(0x005f8d5f)) * 4)) >>> 0);
        FUN_0042f1d3(heap);
        return;
      }

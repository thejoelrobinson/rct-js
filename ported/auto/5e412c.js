...
export function FUN_005e412c(heap) {
  ...
  for (pcVar4 = heap.u32((unaff_ESI + 0x1c)); heap.u32(pcVar4) != '\x15'; pcVar4 = pcVar4 + 0x10) {
    if (heap.u32(pcVar4) == '\x11') {
      heap.setU32((iVar3 + 0x34 + unaff_ESI), (0) >>> 0);
      (heap.u32(heap.u32((unaff_ESI + 4))))(pcVar4, iVar3, iVar2);
      heap.setU32((iVar3 + 0x36 + unaff_ESI), (0) >>> 0);
      heap.setU32((iVar3 + 0x38 + unaff_ESI), (extraout_CX) >>> 0);
      heap.setU32((iVar3 + 0x3e + unaff_ESI), (0) >>> 0);
      heap.setU32((iVar3 + 0x40 + unaff_ESI), (extraout_DX) >>> 0);

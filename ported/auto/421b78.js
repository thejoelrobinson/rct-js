...
export function FUN_00421b78(heap) {
  ...
  uVar9 = (in_EDX >>> 0x10);
  if (((heap.u32(0x00991f70) + heap.u32((__addr_DAT_005f4694 + heap.u32(0x00991f88) * 4))) < 0x1000) && (uVar10 < 0x1000)) {
    uVar10 = uVar10 * 0x80 | uVar10 >>> 9 | heap.u32(0x00991f70) + heap.u32((__addr_DAT_005f4694 + heap.u32(0x00991f88) * 4));
    pbVar11 = heap.u32((__addr_DAT_00971ef4) + ((uVar10 >>> 5 | uVar10 << 0xb)) * 4);
    bVar1 = heap.u32(pbVar11);
    while ((bVar1 & 0x3c) != 0) {
      pbVar11 = pbVar11 + 8;
      bVar1 = heap.u32(pbVar11);
    }
    uVar12 = CONCAT22(uVar9, CONCAT11(heap.u32(pbVar11 + (5) * 4), in_EDX)) & 0xffff1fff;
    if (uVar12 == (uVar12 >>> 8)) {
      return;
    }
    uVar10 = (heap.u32(pbVar11 + (4) * 4) & 0xf) << (in_CL & 0x1f);
    uVar7 = CONCAT22((uVar12 >>> 0x10), CONCAT11(heap.u32(pbVar11 + (2) * 4) >>> 2, uVar12));
    uVar12 = heap.u32(pbVar11 + (4) * 4) & 0x10 | (uVar10 >>> 4 | uVar10) & 0xf;
  } else {
    uVar12 = 0;
  ...
  if ((bVar3 < bVar1) || (bVar6 < bVar5)) {
    ...
    while (bVar3 = (iVar8 >>> 8), bVar3 < bVar1 && (bVar3 < bVar5)) {
      (heap.u32(heap.u32((__addr_PTR_LAB_00431bb8) + (heap.u32(0x00991f88)) * 4)))();
      iVar8 = (bVar3 + 1) << 8;
    }
    if ((bVar3 < bVar1) || (bVar3 < bVar5)) {

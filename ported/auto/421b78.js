...
export function FUN_00421b78(heap) {
  ...
  let cVar4 = 0;
  let uVar9 = 0;
  uVar10 = heap.u32(0x00991f74) + heap.u32((0x005f4696 + heap.u32(0x00991f88) * 4));
  uVar9 = (undefined2)(in_EDX >>> 0x10);
  if (((ushort)(heap.u32(0x00991f70) + heap.u32((0x005f4694 + heap.u32(0x00991f88) * 4))) < 0x1000) && (uVar10 < 0x1000)) {
    uVar10 = uVar10 * 0x80 | uVar10 >>> 9 | heap.u32(0x00991f70) + heap.u32((0x005f4694 + heap.u32(0x00991f88) * 4));
    pbVar11 = heap.u32((0x00971ef4) + ((ushort)(uVar10 >>> 5 | uVar10 << 0xb)) * 4);
  ...
  bVar5 = cVar2 + heap.u32((0x005f46a4) + (unaff_EBX) * 4);
  cVar4 = (uVar7 >>> 8);
  bVar3 = cVar4 + heap.u32((0x005f46e4) + (uVar12) * 4);
  bVar6 = cVar4 + heap.u32((0x005f4704) + (uVar12) * 4);
  if ((bVar3 < bVar1) || (bVar6 < bVar5)) {
    ...
    if ((bVar3 < bVar1) || (bVar3 < bVar5)) {
      (heap.u32(heap.u32((0x00431bb8) + (heap.u32(0x00991f88)) * 4)))(iVar13, unaff_EBX);
    }
  }
  return;
}

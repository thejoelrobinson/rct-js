...
export function FUN_00416a50(heap, param_1, param_2, param_3) {
  ...
  if (heap.u32(0x005f0254) == '\0') {
    ...
    heap.u32(param_2 + (iVar1) * 4) = 0x30;
    heap.u32((param_2 + iVar1) + (1) * 4) = 0;
  }
  }
  puVar4 = param_2;
  ...
  if (0 < param_3) {
    FUN_00416cd0(heap, puVar4, 1);
    heap.u32(puVar4) = heap.u32(0x005ee758);
    ...
    if (iVar1 < 0) {
      ...
      for (uVar3 = param_3 >>> 2; uVar3 != 0; uVar3 = uVar3 - 1) {
        heap.u32(puVar5) = 0x30303030;
        puVar5 = puVar5 + 1;
      }
      for (param_3 = param_3 & 3; param_3 != 0; param_3 = param_3 - 1) {
        heap.u32(puVar5) = 0x30;
        puVar5 = (puVar5 + 1);
      }
    }
  }

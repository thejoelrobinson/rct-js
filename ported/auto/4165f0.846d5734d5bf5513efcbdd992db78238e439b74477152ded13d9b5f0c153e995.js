...
export function FUN_004165f0(heap, param_1, param_2, param_3) {
  let iVar1 = 0;
  iVar1 = ((heap.i32(param_2 + (1) * 4)) >>> 0);
  heap.setI32((param_2 + (1) * 4), (iVar1 + -1) & 0xffffffff);
  if (iVar1 + -1 < 0) {
    param_1 = (((regs.eax = FUN_00415b30(heap, param_1, param_2))) >>> 0);
  } else {
    heap.setI8(heap.i32(param_2), (((param_1) << 24 >> 24)) & 0xff);
    param_1 = ((param_1 & 0xff) >>> 0);
    heap.setU32(param_2, (heap.i32(param_2) + 1) & 0xffffffff);
  }
  if (param_1 == 0xffffffff) {
    heap.setU32(param_3, (-1) & 0xffffffff);
    return;
  }
  heap.setU32(param_3, (heap.i32(param_3) + 1) & 0xffffffff);
  return;
}

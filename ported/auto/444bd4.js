...
export function FUN_00444bd4(heap) {
  ...
  iVar3 = uVar2 * 0x100;
  FUN_00444c74(heap);
  heap.setU32(((__addr_DAT_00743ba2) + (uVar2 * 0x80) * 4), (0x8000) >>> 0);
  heap.setU32(((__addr_DAT_00743ba4) + (uVar2 * 0x80) * 4), (0x8000) >>> 0);
  heap.setU32(((__addr_DAT_00743ba6) + (uVar2 * 0x80) * 4), (0) >>> 0);
  LOCK();
  UNLOCK();
  uVar1 = heap.u32((__addr_DAT_00743b9e) + (uVar2 * 0x80) * 4);
  heap.setU32(((__addr_DAT_00743b96) + (uVar2 * 0x80) * 4), (heap.u32(0x00999f8e)) >>> 0);
  heap.setU32(0x00999f8e, (uVar1) >>> 0);
  heap.setU32((__addr_DAT_00743bb6 + iVar3), (0) >>> 0);
  heap.setU32(((__addr_DAT_00743ba8) + (iVar3) * 4), (0x10) >>> 0);
  heap.setU32(((__addr_DAT_00743b9d) + (iVar3) * 4), (0x14) >>> 0);
  heap.setU32(((__addr_DAT_00743ba9) + (iVar3) * 4), (8) >>> 0);
  heap.setU32((__addr_DAT_00743ba0 + iVar3), (0) >>> 0);
  heap.setU32((__addr_DAT_00743baa + iVar3), (0x8000) >>> 0);
  return;
} finally {
    heap.freeFrame(44);
  }

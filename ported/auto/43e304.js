...
export function FUN_0043e304(heap) {
  ...
  iVar8 = uVar7 * 0x260;
  uVar2 = in_EAX;
  if (((heap.u32((0x00887441) + (iVar8) * 4) != '\x01') || ((heap.u32((0x00887422) + (uVar7 * 0x130) * 4) & 0x80) != 0)) || ((heap.u32((unaff_ESI + 200)) & 1) != 0)) {
    /* goto LAB_0043e76b */ throw new Error("goto LAB_0043e76b not supported");
  }
  unaff_EBX = heap.u32((uint)(byte)(0x00887420) + (iVar8) * 4);
  if ((heap.u32((0x005f5b78 + unaff_EBX * 8)) & 0x20000) == 0) {
    unaff_EBX = in_DH;
    if ((unaff_BP & 2) == 0) {
      if (heap.u32((0x0088747a) + (iVar8 + unaff_EBX) * 4) != -1) {
        if ((unaff_BP & 1) == 0) {
          if (heap.u32((0x00887472 + unaff_EBX * 2 + iVar8)) != -1) {
            /* goto LAB_0043e743 */ throw new Error("goto LAB_0043e743 not supported");
          }
        } else {
          uVar1 = heap.u32((0x00887472 + unaff_EBX * 2 + iVar8));
          uVar2 = uVar1;
          if (uVar1 != 0xffff) {
            uVar7 = uVar1;
            uVar1 = heap.u32((0x00743ba6) + (uVar7 * 0x80) * 4) - heap.u32((unaff_ESI + 0x12));
            if (uVar1 < 0) {
              uVar1 = -uVar1;
            }
            uVar2 = uVar1;
            if (uVar1 < 7) {
              uVar1 = heap.u32((0x00743ba2) + (uVar7 * 0x80) * 4) - heap.u32((unaff_ESI + 0xe));
              if (uVar1 < 0) {
                uVar1 = -uVar1;
              }
              uVar4 = heap.u32((0x00743ba4) + (uVar7 * 0x80) * 4) - heap.u32((unaff_ESI + 0x10));
              if (uVar4 < 0) {
                uVar4 = -uVar4;
              }
              if (uVar1 < uVar4) {
              ...
              uVar2 = uVar1;
              if ((uVar1 < 0xe) && ((10 < heap.u32((0x00743c0e + uVar7 * 0x100)) || (uVar1 < 8)))) {
                /* goto LAB_0043e743 */ throw new Error("goto LAB_0043e743 not supported");
              }
            }
          }
      ...
      LAB_0043e743: heap.u32((0x00887422) + (in_DL * 0x130) * 4) = heap.u32((0x00887422) + (in_DL * 0x130) * 4) | 0x200;
    } else {
      ...
      uVar7 = in_DL;
      iVar8 = uVar7 * 0x260;
      uVar2 = heap.u32((uint)(short)(0x00887508) + (uVar7 * 0x130) * 4);
      ...
      if ((heap.u32((0x0088757e) + (iVar8) * 4) == '\0') || (0xe0 < heap.u32((unaff_ESI + 0x3a)))) {
        if (in_DL == heap.u32((unaff_ESI + 0xc5))) {
          if ((heap.u32((0x00887510) + (uVar7 * 0x130) * 4) == -1) || (heap.u32((0x00887512) + (uVar7 * 0x130) * 4) < 0x3e9)) {
            LAB_0043e52c: uVar1 = heap.u32((0x00887516) + (uVar7 * 0x130) * 4);
            if ((uVar1 == 0xffff) || ((((heap.u32((unaff_ESI + 0xca)) >>> 0xe & 1) != 0 && (heap.u32((unaff_ESI + 0xf0)) == '\x01')) && (in_DL == heap.u32((unaff_ESI + 0xf1)))))) {
              ...
              heap.u32((0x00887422) + (in_DL * 0x130) * 4) = heap.u32((0x00887422) + (in_DL * 0x130) * 4) & 0xfdff;
              return in_EAX;
            }
            ...
            if (heap.u32((ushort)(0x00887508) + (uVar7 * 0x130) * 4) <= (ushort)(uVar1 << 1)) {
              unaff_EBX = CONCAT22(heap, uVar6, uVar1 >>> 1);
              if ((heap.u32((ushort)(0x00887508) + (uVar7 * 0x130) * 4) <= uVar1 >>> 1) && ((unaff_BP & 4) == 0)) {
          ...
          if (heap.u32((0x00887510) + (uVar7 * 0x130) * 4) == -1) {
          ...
          if (heap.u32(0x008d7eb6) == '\0') {
            ...
            uVar2 = uVar2 + uVar5;
            if ((unaff_EBX <= heap.u32((0x00887512) + (uVar7 * 0x130) * 4)) && (heap.u32((0x00887512) + (uVar7 * 0x130) * 4) <= uVar2)) {
              uVar2 = heap.u32((unaff_ESI + 0x44)) & 3;
              unaff_EBX = heap.u32((0x0062d620 + uVar2 * 4)) - uVar5;
              uVar2 = heap.u32((0x0062d622 + uVar2 * 4)) + uVar5;
              if (heap.u32((0x00887514 + iVar8)) <= uVar2) {
                if ((0x8b < heap.u32((0x00887514 + iVar8))) && (0xa0 < heap.u32((unaff_ESI + 0x3c)))) {
                  /* goto LAB_0043e76b */ throw new Error("goto LAB_0043e76b not supported");
                }
                /* goto LAB_0043e52c */ throw new Error("goto LAB_0043e52c not supported");
              }
            ...
            uVar2 = CONCAT31(heap, (int3)(char)(heap.u32((ushort)(0x00887508) + (uVar7 * 0x130) * 4) >>> 8), heap.u32((byte)(0x008874e4) + (iVar8) * 4) >>> 5);
            if (3 < heap.u32((byte)(0x008874e4) + (iVar8) * 4) >>> 5) {
              /* goto LAB_0043e52c */ throw new Error("goto LAB_0043e52c not supported");
            }
          }
        }
    ...
    if (heap.u32((0x005f5e88) + (unaff_EBX * 4) * 4) == -1) {
      if (heap.u32((unaff_ESI + 0x40)) < 0x46) {
        /* goto LAB_0043e76b */ throw new Error("goto LAB_0043e76b not supported");
      }
      uVar1 = heap.u32((0x00887508) + (uVar7 * 0x130) * 4) * 0x28;
      uVar2 = uVar1;
    ...
    LAB_0043e61a: uVar2 = heap.u32((uint)(short)(0x00887508) + (uVar7 * 0x130) * 4);
    if (uVar2 == 0) {

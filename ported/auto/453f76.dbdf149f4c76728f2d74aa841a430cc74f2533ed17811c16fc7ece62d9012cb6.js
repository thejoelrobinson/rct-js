...
export function FUN_00453f76(heap) {
  ...
  if (heap.u32(0x0063293c) == 1) {
    ...
    if ((heap.u8(0x008d7eb2) == 2) && (uVar2 = (((regs.eax = FUN_005df40c(heap))) >>> 0), ((uVar2) & 0xffff) < 0x1b5)) {
      // asm 0x45409e: mov word ptr [0x632974], ax — 16-bit. 0x632974/0x632976 are adjacent
      // u16 counters; the u32 store here zeroed the 0x632976 counter written just below.
      heap.setU16(0x00632974, ((((((uVar2) >>> 0) >>> 0x10) & 0xffff) & 0x3f) + 0x2b) >>> 0);
      // asm 0x4540aa: mov word ptr [0x632976], ax — 16-bit.
      heap.setU16(0x00632976, (((((uVar2) >>> 0) >>> 0x18) & 0xff) & 0x1f) >>> 0);
      heap.setU8(0x009b2300, (1) & 0xff);
    }
  } else {
    // asm 0x4540bc/0x4540c6: cmp word ptr [0x632976], 0 / dec word ptr [0x632976] — 16-bit.
    if (((heap.u16(0x00632976) != 0) && (heap.setU16(0x00632976, (heap.u16(0x00632976) - 1) >>> 0), heap.u8(0x009b2300) == 0)) && (uVar1 = (((regs.eax = FUN_005df40c(heap))) & 0xffff), uVar1 < 0x2001)) {
      heap.setU8(0x009b2300, (1) & 0xff);
    }
    // asm 0x4540e8: dec word ptr [0x632974] / jne — 16-bit. As a u32 dec this zeroed the
    // adjacent 0x632976 counter on every tick.
    heap.setU16(0x00632974, (heap.u16(0x00632974) + -1) >>> 0);
    if (heap.u16(0x00632974) == 0) {
      ...
      if ((uVar3 & 0x10000) == 0) {
        ...
        heap.setU8(0x00632970, ((uVar3 >>> 0x12 & 0xff) * -8) >>> 0);

...
export function FUN_00443e98(heap) {
  ...
  FUN_005e43de(heap);
  heap.u32(unaff_ESI + (7) * 4) = heap.u32(0x00630704);
  heap.u32(unaff_ESI + (3) * 4) = heap.u32(0x00630740);
  heap.u32(unaff_ESI + (6) * 4) = heap.u32(0x00630754);
  heap.u32(unaff_ESI) = heap.u32(0x00630718);
  heap.u32(unaff_ESI + (1) * 4) = heap.u32(0x0063072c);

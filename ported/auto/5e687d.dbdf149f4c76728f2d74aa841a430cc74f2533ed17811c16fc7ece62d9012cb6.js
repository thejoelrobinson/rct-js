...
import { cancelToolExact, runSelectionEntry } from "./extra_ui_selection.js";
...
export function FUN_005e687d(heap) {
  if (globalThis.__realStartup || state.executionMode === "pure-js") return runSelectionEntry(heap, 0x5e687d, cancelToolExact);
  let uVar1 = 0;

  ...
  if ((in_EAX < 0x1000) && (in_CX < 0x1000)) {
    ...
    if ((byte)((heap.u32(pbVar4 + (5) * 4) & 0x1f) << 2) <= heap.u32(pbVar4 + (2) * 4)) {
      ...
      do {
        ...
        pbVar4 = pbVar5 + 8;
      } while ((((heap.u32(pbVar5 + (0xb) * 4) <= uVar1) || ((byte)(uVar1 >>> 8) < heap.u32(pbVar5 + (10) * 4))) || (bVar2 = heap.u32(pbVar4) & 0x3c, bVar2 == 4)) || ((bVar2 == 0x14 || ((bVar2 == 0xc && ((heap.u32((uint)(__addr_PTR_DAT_006e1ec8) + (heap.u32(pbVar5 + (0xc) * 4) * 2) * 4) & 1) == 0))))));
    }
  }
  return CONCAT44(heap, in_EDX, in_EAX);
} finally {

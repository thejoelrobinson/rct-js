...
export function FUN_0043c6b2(heap) {
  ...
  const __addr_PTR_DAT_006e1ec8 = __sp + 4;
  try {
  let in_EAX = 0;
  let in_CX = 0;
  let in_EDX = 0;
  ...
  if ((in_EAX < 0x1000) && (in_CX < 0x1000)) {
    ...
    if (((heap.u32(pbVar4 + (5) * 4) & 0x1f) << 2) <= heap.u32(pbVar4 + (2) * 4)) {
      bVar2 = heap.u32(pbVar4 + (2) * 4);
      uVar1 = CONCAT11(bVar2 + 4, bVar2);
      if ((heap.u32(pbVar4 + (4) * 4) & 0x10) != 0) {
        uVar1 = CONCAT11(bVar2 + 8, bVar2);
      }
      do {
        pbVar5 = pbVar4;
        ...
        pbVar4 = pbVar5 + 8;
      } while ((((heap.u32(pbVar5 + (0xb) * 4) <= uVar1) || ((uVar1 >>> 8) < heap.u32(pbVar5 + (10) * 4))) || (bVar2 = heap.u32(pbVar4) & 0x3c, bVar2 == 4)) || ((bVar2 == 0x14 || ((bVar2 == 0xc && ((heap.u32((__addr_PTR_DAT_006e1ec8) + (heap.u32(pbVar5 + (0xc) * 4) * 2) * 4) & 1) == 0))))));
    }
  }
  return CONCAT44(in_EDX, in_EAX);
} finally {

...
export function FUN_004219b5(heap) {
  ...
  let cVar4 = 0;
  let uVar9 = 0;
  uVar10 = heap.u32(0x00991f74) + heap.u32((0x005f4686 + heap.u32(0x00991f88) * 4));
  uVar9 = (undefined2)(in_EDX >>> 0x10);
  if (((ushort)(heap.u32(0x00991f70) + heap.u32((0x005f4684 + heap.u32(0x00991f88) * 4))) < 0x1000) && (uVar10 < 0x1000)) {
    uVar10 = uVar10 * 0x80 | uVar10 >>> 9 | heap.u32(0x00991f70) + heap.u32((0x005f4684 + heap.u32(0x00991f88) * 4));
    pbVar12 = heap.u32((0x00971ef4) + ((ushort)(uVar10 >>> 5 | uVar10 << 0xb)) * 4);
    bVar1 = heap.u32(pbVar12);
    while ((bVar1 & 0x3c) != 0) {
      pbVar12 = pbVar12 + 8;
      bVar1 = heap.u32(pbVar12);
    }
    uVar13 = CONCAT22(heap, uVar9, CONCAT11(heap, heap.u32(pbVar12 + (5) * 4), in_EDX)) & 0xffff1fff;
    if (uVar13 == (uVar13 >>> 8)) {
      return;
    }
    uVar10 = (heap.u32(pbVar12 + (4) * 4) & 0xf) << (in_CL & 0x1f);
    uVar7 = CONCAT22(heap, (uVar13 >>> 0x10), CONCAT11(heap, heap.u32(pbVar12 + (2) * 4) >>> 2, uVar13));
    uVar13 = heap.u32(pbVar12 + (4) * 4) & 0x10 | (ushort)(uVar10 >>> 4 | uVar10) & 0xf;
  } else {
    uVar13 = 0;
  ...
  cVar4 = (uVar7 >>> 8);
  bVar3 = cVar4 + heap.u32((0x005f46a4) + (uVar13) * 4);
  bVar6 = cVar4 + heap.u32((0x005f4704) + (uVar13) * 4);
  if ((bVar3 < bVar1) || (bVar6 < bVar5)) {
    ...
    if ((bVar3 < bVar1) || (bVar3 < bVar5)) {
      (heap.u32(heap.u32((0x00431bb8) + (heap.u32(0x00991f88)) * 4)))(iVar11, unaff_EBX);
    }
  }
  return;
}

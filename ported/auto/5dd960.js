...
export function FUN_005dd960(heap) {
  ...
  let unaff_ESI = 0;
  let iVar13 = 0;
  uVar11 = heap.u32((ushort)(__addr_DAT_0088744a) + ((uint) * (unaff_ESI + 0x30) * 0x130 + (uint) * (unaff_ESI + 0x4b)) * 4) >>> 8;
  uVar3 = (heap.u32((__addr_DAT_0088744a) + ((uint) * (unaff_ESI + 0x30) * 0x130 + (uint) * (unaff_ESI + 0x4b)) * 4) & 0xff) * 0x20;
  uVar5 = uVar11 * 0x20;
  bVar7 = heap.u32((__addr_DAT_00887452) + ((uint) * (unaff_ESI + 0x30) * 0x260 + (uint) * (unaff_ESI + 0x4b)) * 4);
  for (pbVar8 = heap.u32((__addr_DAT_00971ef4) + ((ushort)((ushort)(uVar11 << 0xc | uVar3) >>> 5 | (uVar5 >>> 9) << 0xb)) * 4); ((heap.u32(pbVar8) & 0x3c) != 8 || (bVar7 != heap.u32(pbVar8 + (2) * 4))); pbVar8 = pbVar8 + 8) {
  ...
  pbVar8 = heap.u32((__addr_DAT_00971ef4) + ((ushort)(uVar11 >>> 5 | uVar11 << 0xb)) * 4);
  do {
    if (((((heap.u32(pbVar8) & 0x3c) == 8) && (((bVar2 = heap.u32(pbVar8 + (2) * 4), bVar7 == bVar2 || (bVar7 == (byte)(bVar2 + 4))) || (bVar7 == (byte)(bVar2 - 4))))) && (((bVar2 = heap.u32(pbVar8 + (4) * 4), bVar2 == 1 || (bVar2 == 3)) || (bVar2 == 2)))) && ((heap.u32((__addr_DAT_00887496) + (heap.u32(pbVar8 + (7) * 4) * 0x260) * 4) & 0x20) != 0)) {
  ...
  pbVar8 = heap.u32((__addr_DAT_00971ef4) + ((ushort)(uVar11 >>> 5 | uVar11 << 0xb)) * 4);
  while ((heap.u32(pbVar8) & 0x3c) != 8 || ((((bVar2 = heap.u32(pbVar8 + (2) * 4), bVar7 != bVar2 && (bVar7 != (byte)(bVar2 + 4))) && (bVar7 != (byte)(bVar2 - 4))) || ((((bVar2 = heap.u32(pbVar8 + (4) * 4), bVar2 != 1 && (bVar2 != 3)) && (bVar2 != 2)) || ((heap.u32((__addr_DAT_00887496) + (heap.u32(pbVar8 + (7) * 4) * 0x260) * 4) & 0x20) == 0)))))) {
    pbVar1 = pbVar8 + 1;
    pbVar8 = pbVar8 + 8;
  ...
  for (iVar10 = 0; iVar10 < heap.u32((byte)(__addr_DAT_00887498) + (iVar13) * 4); iVar10 = iVar10 + 1) {
    if (((heap.u32((__addr_DAT_0088747e + iVar10 * 2 + iVar13)) != 0xffff) && (iVar12 = (uint) * (__addr_DAT_0088747e + iVar10 * 2 + iVar13) * 0x100, heap.u32((__addr_DAT_00743be4) + (iVar12) * 4) == '\x02')) && ((heap.u32((__addr_DAT_00743be5) + (iVar12) * 4) == '\0' && (((heap.u32((__addr_DAT_00743bdc + iVar12)) >>> 2 & 1) != 0 && ((heap.u32(pbVar8 + (5) * 4) & 0x70) >>> 4 == heap.u32((__addr_DAT_00743bdf) + (iVar12) * 4))))))) {
      heap.u32((__addr_DAT_00743bdc + iVar12)) = heap.u32((__addr_DAT_00743bdc + iVar12)) & 0xfffb;
  ...
  while (true) {
    cVar4 = uVar6;
    bVar7 = (byte)(uVar6 >>> 8);
    if (heap.u32((byte)(__addr_DAT_00887498) + (iVar10) * 4) <= iVar13) {
      break;
    }
    if (heap.u32((__addr_DAT_0088747e + iVar13 * 2 + iVar10)) != 0xffff) {
      iVar12 = (uint) * (__addr_DAT_0088747e + iVar13 * 2 + iVar10) * 0x100;
  ...
  if ((byte)(cVar4 + bVar7) != heap.u32((__addr_DAT_00887498) + (iVar10) * 4)) {
    return uVar3;
  }
  if (heap.u32((byte)(__addr_DAT_00887498) + (iVar10) * 4) >>> 1 <= bVar7) {
    return uVar3;
  }
  heap.u32((unaff_ESI + 0x48)) = heap.u32((unaff_ESI + 0x48)) & 0xfffb;
  return uVar3;

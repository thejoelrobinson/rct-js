...
export function FUN_0042e062(heap) {
  ...
  let bVar8 = 0;
  let uVar9 = 0;
  uVar2 = in_EAX + (heap.u32((0x00652478) + ((unaff_EBX >>> 3) * 2) * 4) >>> 3);
  uVar3 = in_CX + (heap.u32((0x0065247a) + ((unaff_EBX >>> 3) * 2) * 4) >>> 3);
  bVar8 = false;
  FUN_0042547b(heap);
  if (!bVar8) {
    uVar1 = uVar3 >>> 9;
    pbVar6 = heap.u32((0x00971ef4) + ((ushort)((ushort)((uVar3 & 0xffe0) << 7 | uVar1 | uVar2 & 0xffe0) >>> 5 | uVar1 << 0xb)) * 4);
    do {
  ...
  while (pbVar6 = pbVar5, (heap.u32(pbVar5) & 0x3c) != 0) {
    ...
    if ((heap.u32(pbVar6 + (1) * 4) & 0x80) != 0) {
      ...
      if (499 < heap.u32(0x0087c3a8)) {
        uVar4 = 0;
        for (uVar2 = heap.u32(0x0087c39c); uVar9 = uVar2 == 0xffff, !uVar9; uVar2 = heap.u32((0x00743b98) + (uVar2 * 0x80) * 4)) {
          iVar7 = uVar2 * 0x100;
          if (uVar4 <= heap.u32((0x00743bb8 + iVar7))) {
            uVar4 = heap.u32((0x00743bb8 + iVar7));
            pbVar5 = 0x00743b94 + iVar7;
          }
        }

...
export function FUN_005cfac7(heap) {
  ...
  switch (heap.u32(unaff_ESI) & 3) {
    case 0:
      uVar3 = CONCAT22(heap, uVar4, (sVar6 + heap.u32((__addr_DAT_00653efd + iVar11))) - heap.u32((puVar2 + uVar9 * 10 + 1)));
      uVar5 = (in_CX + heap.u32((__addr_DAT_00653eff + iVar11))) - heap.u32((puVar2 + uVar9 * 10 + 3));
      break;
    case 1:
      uVar3 = CONCAT22(heap, uVar4, (sVar6 + heap.u32((__addr_DAT_00653eff + iVar11))) - heap.u32((puVar2 + uVar9 * 10 + 3)));
  ...
  uVar7 = CONCAT11(heap, heap.u32((__addr_DAT_00653ef8) + (iVar11) * 4), heap.u32((__addr_DAT_00653ef8) + (iVar11) * 4)) & 0x4ff;
  uVar9 = CONCAT11(heap, (uVar7 >>> 8), uVar7 + heap.u32(unaff_ESI)) & 0xffffff03;
  bVar8 = (byte)(uVar9 >>> 8);
  heap.setU32(0x00652471, (uVar9 | bVar8) >>> 0);
  if (bVar8 == 0) {
    uVar3 = CONCAT22(heap, (uVar3 >>> 0x10), uVar3 + heap.u32((__addr_DAT_00652478) + (heap.u32(0x00652471) * 2) * 4));
    uVar5 = uVar5 + heap.u32((__addr_DAT_0065247a) + (heap.u32(0x00652471) * 2) * 4);
  }
  uVar5 = uVar5 << 7 | uVar5 >>> 9 | uVar3;
  pbVar10 = heap.u32((__addr_DAT_00971ef4) + ((ushort)(uVar5 >>> 5 | uVar5 << 0xb)) * 4);
  do {
    if ((((heap.u32(pbVar10) & 0x3c) == 8) && (heap.u32(pbVar10 + (7) * 4) == heap.u32(unaff_ESI + (7) * 4))) && ((heap.u32(pbVar10 + (5) * 4) & 0xf) == 0)) {
      ...
      uVar5 = CONCAT11(heap, heap.u32((__addr_DAT_00653ef7) + (iVar11) * 4), heap.u32((__addr_DAT_00653ef7) + (iVar11) * 4)) & 0x4ff;
      uVar9 = CONCAT11(heap, (uVar5 >>> 8), uVar5 + heap.u32(pbVar10)) & 0xffffff03;
      if (((byte)(uVar9 | (byte)(uVar9 >>> 8)) == heap.u32(0x00652471)) && ((ushort)(heap.u32(pbVar10 + (2) * 4) * 4 + (heap.u32((__addr_DAT_00653ef9 + iVar11)) - heap.u32((heap.u32((__addr_PTR_DAT_00652498) + (heap.u32(pbVar10 + (4) * 4)) * 4) + 5)))) == sVar6)) {

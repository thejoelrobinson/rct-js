...
export function FUN_005cfac7(heap) {
  ...
  do {
    if ((((heap.u32(pbVar10) & 0x3c) == 8) && (heap.u32(pbVar10 + (7) * 4) == heap.u32(unaff_ESI + (7) * 4))) && ((heap.u32(pbVar10 + (5) * 4) & 0xf) == 0)) {
      ...
      if (((uVar9 | (uVar9 >>> 8)) == heap.u32(0x00652471)) && ((heap.u32(pbVar10 + (2) * 4) * 4 + (heap.u32((__addr_DAT_00653ef9 + iVar11)) - heap.u32((heap.u32((__addr_PTR_DAT_00652498) + (heap.u32(pbVar10 + (4) * 4)) * 4) + 5)))) == sVar6)) {

...
export function FUN_00458b05(heap) {
  ...
  uVar4 = heap.u32((__addr_DAT_0099a516) + (uVar5) * 4) * -3 + unaff_DI;
  uVar3 = 0;
  puVar7 = unaff_ESI;
  while (true) {
    puVar6 = puVar7;
    bVar1 = heap.u32(puVar6);
    puVar7 = (puVar6 + 1);
    if (bVar1 == 0) {
      return 0;
    }
    ...
    if (bVar1 < 5) {
      ...
      if (bVar1 == 7) {
      uVar5 = 0x1c0;
      LAB_00458bba: uVar4 = heap.u32((__addr_DAT_0099a516) + (uVar5) * 4) * -3 + unaff_DI;
    } else {
      if (bVar1 == 8) {
        uVar5 = 0x2a0;
      ...
      if (0x10 < bVar1) {
        if (bVar1 == 0x17) {
          ...
          LAB_00458b39: if (unaff_DI < uVar3) {
            heap.setU32(unaff_ESI, (0x2e2e2e) >>> 0);
            return uVar2;
          }
          if (uVar3 <= uVar4) {
            unaff_ESI = puVar7;

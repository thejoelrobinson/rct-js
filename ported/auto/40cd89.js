...
export function FUN_0040cd89(heap, param_1, param_2, param_3) {
  ...
  if (iVar1 == 0) {
    if (heap.u32(heap.u32((__addr_DAT_005f04bc + param_1 * 0x16c))) == 1) {
      ...
      if (iVar1 == 0) {
        heap.setU32((__addr_DAT_005f04f0 + param_1 * 0x16c), ((heap.u32((heap.u32((__addr_DAT_005f04bc + param_1 * 0x16c)) + 8)) * 0x78) / 100) >>> 0);
        ...
        if (local_8 == 0) {
          heap.setU32((__addr_DAT_005f04ec + param_1 * 0x16c), (heap.u32((__addr_DAT_005ebfe8 + param_1 * 4))) >>> 0);
          heap.setU32((__addr_DAT_005f0508 + param_1 * 0x16c), (0) >>> 0);
          heap.setU32((__addr_DAT_005f04fc + param_1 * 0x16c), (0) >>> 0);
          heap.setU32((__addr_DAT_005f0504 + param_1 * 0x16c), (1) >>> 0);
          FUN_0040cb41(heap, param_1);
          heap.setU32((__addr_DAT_005f04f8 + param_1 * 0x16c), (param_3) >>> 0);
          heap.setU32((__addr_DAT_005f0500 + param_1 * 0x16c), (0) >>> 0);
          uVar2 = 0;
        } else {
          uVar2 = 0xffffff9a;
        }

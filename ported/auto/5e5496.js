...
export function FUN_005e5496(heap) {
  ...
  if (sVar1 != -0x8000) {
    ...
    for (piVar6 = ((0x009a121c) >>> 0); iVar5 = ((heap.i32(piVar6)) >>> 0), iVar5 != 0; piVar6 = (((piVar6 + ((1) * 4)) >>> 0)) >>> 0) {
      if ((((heap.i8((iVar5 + 0x10)) == 0) && (heap.i16((iVar5 + 8)) < sVar3)) && (heap.i16((iVar5 + 10)) < sVar4)) && ((sVar1 < (((heap.i16((iVar5 + 8)) + heap.i16((iVar5 + 0xc)))) << 16 >> 16) && (sVar2 < (((heap.i16((iVar5 + 10)) + heap.i16((iVar5 + 0xe)))) << 16 >> 16))))) {

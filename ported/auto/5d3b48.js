...
export function FUN_005d3b48(heap) {
  ...
  for (pcVar10 = heap.u32((__addr_PTR_DAT_00652498) + (in_EDX >>> 8 & 0xff) * 4); heap.u32(pcVar10) != -1; pcVar10 = pcVar10 + 10) {
    ...
    heap.setU32(0x00656ae3, (((byte)(heap.u32(pcVar10 + (7) * 4) + heap.u32((__addr_DAT_005f5d01) + (heap.u32(pbVar11) * 8) * 4)) >>> 2) + heap.u32(0x00656ae2)) >>> 0);
    ...
    heap.u32((__addr_DAT_00971ef4) + ((uVar5 >>> 5 | uVar5 << 0xb)) * 4) = heap.u32(0x00656af0);
    uVar7 = uVar7 + 0x20 & 0xfe0;
    heap.u32((__addr_DAT_00971ef4) + (((extraout_CX << 7 | extraout_CX >>> 9 | uVar7) >>> 5 | (extraout_CX >>> 9) << 0xb)) * 4) = heap.u32(0x00656af4);
    uVar7 = uVar7 - 0x40 & 0xfe0;
    heap.u32((__addr_DAT_00971ef4) + (((extraout_CX << 7 | extraout_CX >>> 9 | uVar7) >>> 5 | (extraout_CX >>> 9) << 0xb)) * 4) = heap.u32(0x00656af8);
    uVar7 = uVar7 + 0x20 & 0xfe0;
    uVar5 = extraout_CX + 0x20 & 0xfe0;
    heap.u32((__addr_DAT_00971ef4) + (((uVar5 << 7 | uVar7) >>> 5 | (uVar5 >>> 9) << 0xb)) * 4) = heap.u32(0x00656afc);
    uVar5 = extraout_CX - 0x20 & 0xfe0;
    heap.u32((__addr_DAT_00971ef4) + (((uVar5 << 7 | uVar7) >>> 5 | (uVar5 >>> 9) << 0xb)) * 4) = heap.u32(0x00656b00);
  }

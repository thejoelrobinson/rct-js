...
export function FUN_00412759(heap, param_1, param_2, param_3, param_4) {
  ...
  if (heap.u32(param_1) == 0) {
    ...
    local_8 = ((mmioSetInfo(heap, ((heap.u32(param_1)) >>> 0), param_4, 0)) >>> 0);
    if (((local_8 == 0) && (local_8 = ((mmioAscend(heap, ((heap.u32(param_1)) >>> 0), param_2, 0)) >>> 0), local_8 == 0)) && (local_8 = ((mmioAscend(heap, ((heap.u32(param_1)) >>> 0), param_3, 0)) >>> 0), local_8 == 0)) {
      mmioSeek(heap, ((heap.u32(param_1)) >>> 0), 0, 0);
      local_8 = ((mmioDescend(heap, ((heap.u32(param_1)) >>> 0), param_3, 0x0, 0)) >>> 0);
      if (local_8 == 0) {
        heap.setU32(param_2, (0x74636166) >>> 0);
        MVar1 = ((mmioDescend(heap, ((heap.u32(param_1)) >>> 0), param_2, param_3, 0x10)) >>> 0);
        if (MVar1 == 0) {
          mmioWrite(heap, ((heap.u32(param_1)) >>> 0), __addr_stack0x00000014, 4);
          mmioAscend(heap, ((heap.u32(param_1)) >>> 0), param_2, 0);
        }
        local_8 = ((mmioAscend(heap, ((heap.u32(param_1)) >>> 0), param_3, 0)) >>> 0);
      }
    }
    if (heap.u32(param_1) != 0) {
      mmioClose(heap, ((heap.u32(param_1)) >>> 0), 0);

...
export function FUN_0040db14(heap) {
  heap.setU32(0x005ebf0c, ((regs.eax = FUN_0040da11(heap))) >>> 0);
  heap.setU32(0x005ebf10, ((regs.eax = FUN_004133c0(heap, heap.u32(0x005ebf0c) * 0x210))) >>> 0);
  if (heap.u32(0x005ebf10) != 0) {
    (regs.eax = FUN_0040dae1(heap));
  }
  return;
}

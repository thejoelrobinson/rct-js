...
export function FUN_00405b58(heap) {
  ...
  pHVar4 = CreateWindowExA(heap, 0, 0x005e9030, 0x005f1ba0, 0x10cf0000, heap.u32(0x005f1384), heap.u32(0x005f1388), heap.u32(0x005f12ac) + iVar1 * 2, heap.u32(0x005f129c) + iVar2 * 2 + iVar3, 0x0, 0x0, heap.u32(0x005f1398), 0x0);
  return pHVar4;
}

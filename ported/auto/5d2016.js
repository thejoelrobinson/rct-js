...
export function FUN_005d2016(heap) {
  ...
  if (heap.u32(0x00652288) == '\x03') {
    ...
    if (heap.u32(0x00652293) < '\0') {
      ...
      uVar3 = CONCAT31(heap, uVar5, bVar2);
      if (heap.u32(0x00652288) == '\x02') {
        uVar3 = CONCAT31(heap, uVar5, bVar2) ^ 2;
      }
      ...
      if ((heap.u32(0x00652292) & 1) == 0) {
        ...
        if (!bVar6) {
          ...
          heap.setU32(0x006522a0, (heap.u32((0x00653ef9 + extraout_DH * 10)) + unaff_DI) >>> 0);
          heap.setU32(0x006522a2, ((byte)(uVar3 >>> 8)) >>> 0);
          iVar4 = CONCAT31(heap, (int3)(uVar3 >>> 8), 0x69);
        ...
        if ((heap.u32(0x006522a2) & 4) == 0) {
          bVar6 = heap.u32(0x0065229e) < heap.u32((ushort)(0x0065247a) + (heap.u32(0x006522a2) * 2) * 4);
        }

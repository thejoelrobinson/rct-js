...
export function FUN_0040871f(heap, param_1, param_2, param_3, param_4, param_5) {
  ...
  heap.setU32((puVar4 + 2), (0) >>> 0);
  local_158 = 0x2e;
  local_15c = _strrchr(heap, param_3, 0x2e);
  local_158 = 0x5c;
  local_160 = _strrchr(heap, param_3, 0x5c);
  if (local_15c == 0x0) {
    if (local_160 != 0x0) {

    ...
    if (local_8 == 0) {
      ...
      if (local_8 == 0) {
        if (heap.u32(param_3) == 1) {
          LVar2 = mmioWrite((HMMIO) * param_2, param_3, 0x10);
          if (LVar2 != 0x10) {
            return 0xe104;
          }
        } else {
          LVar2 = mmioWrite((HMMIO) * param_2, param_3, heap.u32(param_3 + (8) * 4) + 0x12);
        ...
        if (local_8 == 0) {
          ...
          local_8 = mmioCreateChunk((HMMIO) * param_2, __addr_local_20, 0);
          if (local_8 == 0) {
            LVar2 = mmioWrite((HMMIO) * param_2, __addr_local_c, 4);
            if (LVar2 == 4) {
              MVar3 = mmioAscend((HMMIO) * param_2, __addr_local_20, 0);
              if (MVar3 == 0) {
                local_8 = 0;
              } else {
                local_8 = 0xe104;

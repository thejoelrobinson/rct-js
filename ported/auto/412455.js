...
export function FUN_00412455(heap, param_1, param_2, param_3, param_4, param_5) {
  ...
  if (heap.u32(param_2) == 0) {
    ...
    heap.setU32(__addr_local_8, (mmioCreateChunk(heap, ((heap.u32(param_2)) >>> 0), param_5, 0x20)) >>> 0);
    if (heap.u32(__addr_local_8) == 0) {
      heap.setU32(param_4, (0x20746d66) >>> 0);
      heap.setU32((param_4 + 4), (0x10) >>> 0);
      heap.setU32(__addr_local_8, (mmioCreateChunk(heap, ((heap.u32(param_2)) >>> 0), param_4, 0)) >>> 0);
      if (heap.u32(__addr_local_8) == 0) {
        if (heap.u32(param_3) == 1) {
          LVar2 = ((mmioWrite(heap, ((heap.u32(param_2)) >>> 0), param_3, 0x10)) >>> 0);
          if (LVar2 != 0x10) {
            return 0xe104;
          }
        } else {
          LVar2 = ((mmioWrite(heap, ((heap.u32(param_2)) >>> 0), param_3, ((heap.u32(param_3 + (8) * 4)) & 0xffff) + 0x12)) >>> 0);
          if (LVar2 != ((heap.u32(param_3 + (8) * 4)) & 0xffff) + 0x12) {
            return 0xe104;
          }
        }
        heap.setU32(__addr_local_8, (mmioAscend(heap, ((heap.u32(param_2)) >>> 0), param_4, 0)) >>> 0);
        if (heap.u32(__addr_local_8) == 0) {
          heap.setU32(__addr_local_20, (0x74636166) >>> 0);
          heap.setU32((__addr_local_20 + 4), (0) >>> 0);
          heap.setU32(__addr_local_8, (mmioCreateChunk(heap, ((heap.u32(param_2)) >>> 0), __addr_local_20, 0)) >>> 0);
          if (heap.u32(__addr_local_8) == 0) {
            LVar2 = ((mmioWrite(heap, ((heap.u32(param_2)) >>> 0), __addr_local_c, 4)) >>> 0);
            if (LVar2 == 4) {
              MVar3 = ((mmioAscend(heap, ((heap.u32(param_2)) >>> 0), __addr_local_20, 0)) >>> 0);
              if (MVar3 == 0) {
                heap.setU32(__addr_local_8, (0) >>> 0);
              } else {
                heap.setU32(__addr_local_8, (0xe104) >>> 0);

...
export function FUN_005d3329(heap) {
  ...
  let iVar3 = 0;
  let bVar4 = 0;
  bVar4 = heap.u32((__addr_DAT_00887420) + (heap.u32((unaff_ESI + 7)) * 0x260) * 4) == '\x14';
  if (!bVar4) {
    ...
    while (true) {
      iVar3 = iVar2;
      iVar2 = heap.u32((unaff_ESI + 4)) * 8;
      bVar4 = false;
      heap.setU32(0x006522a7, (CONCAT11(heap.u32((__addr_DAT_006545b2) + (iVar2) * 4), heap.u32((__addr_DAT_006545b4) + (iVar2) * 4))) >>> 0);
      in_EAX = uVar1;
      uVar1 = FUN_005cfac7(heap, unaff_ESI, in_ECX, uVar1, unaff_EDI);
      if ((bVar4) || (iVar2 = heap.u32((unaff_ESI + 4)) * 8, in_EAX = uVar1, CONCAT11(heap.u32((__addr_DAT_006545b3) + (iVar2) * 4), heap.u32((__addr_DAT_006545b5) + (iVar2) * 4)) != heap.u32(0x006522a7))) {
        break;
      }
      in_ECX = extraout_ECX;
      iVar2 = unaff_ESI;

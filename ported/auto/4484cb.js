...
export function FUN_004484cb(heap) {
  ...
  if (uVar20 == '\x10') {
    ...
    uVar13 = (bVar17 - heap.u32(unaff_ESI)) & 3;
      ...
      do {
        ...
        if (bVar12 == heap.u32(pbVar23 + (2) * 4)) {
          if (bVar4 == 0x10) {
            ...
            if ((heap.u32((__addr_DAT_005f4970) + (CONCAT31((int3)((heap.u32(pbVar23 + (4) * 4) << 4) >>> 8), (heap.u32(pbVar23 + (4) * 4) << 4) | heap.u32(pbVar23 + (5) * 4) & 0xf)) * 4) >>> (bVar17 - heap.u32(pbVar23) & 3 ^ 2) & 1) == 0) {
              break;
            }
            if (heap.u32(0x00630b3c) == '\0') {
              heap.setU32(heap.u32(0x00630b30), (8) >>> 0);
              heap.setU32((pbVar22 + (1) * 4), (bVar17) >>> 0);
            ...
            uVar26 = CONCAT44(uVar15, uVar6);
            if (((heap.u32((__addr_DAT_006559d8) + (uVar20) * 4) & 0x20) == 0) || (uVar26 = CONCAT44(uVar15, uVar6), (heap.u32((__addr_DAT_006559d8) + (uVar20) * 4) >>> (bVar17 - heap.u32(pbVar23) & 3 ^ 2) & 1) == 0)) {
              break;
            }
            if (heap.u32(0x00630b3c) == '\0') {
              heap.setU32(heap.u32(0x00630b30), (1) >>> 0);
              heap.setU32((pbVar22 + (1) * 4), (bVar17) >>> 0);
              heap.setU32(0x00630b30, (heap.u32(0x00630b30) + 2) >>> 0);
            }
          }
          ...
          if ((uVar20 == '\x04') && (uVar26 = CONCAT44(iVar14, uVar6), heap.u32(0x00630b3c) == '\x01')) {
            heap.setU32((unaff_ESI + ((uVar8 >>> 3) + 6) * 4), (heap.u32(unaff_ESI + ((uVar8 >>> 3) + 6) * 4) | '\x01' << (uVar8 & 7)) >>> 0);
        ...
        LAB_004485cb: if (bVar4 == 4) {
          if (bVar12 == heap.u32(pbVar23 + (2) * 4)) {
            ...
            if ((bVar12 - 4) != heap.u32(pbVar23 + (2) * 4)) {
          ...
          if (heap.u32(0x00630b3c) == '\0') {
            bVar12 = 2;
            if (heap.u32(pbVar23 + (4) * 4) >>> 4 == 0) {
              if (1 < heap.u32((__addr_DAT_00630b00) + (heap.u32(pbVar23 + (6) * 4) & 0xf) * 4)) {
                /* goto LAB_00448708 */ throw new Error("goto LAB_00448708 not supported");
              }
              bVar12 = 3;
            }
            heap.setU32(heap.u32(0x00630b30), (bVar12) >>> 0);
            heap.setU32((pbVar22 + (1) * 4), (bVar17) >>> 0);
            heap.setU32(0x00630b30, (heap.u32(0x00630b30) + 2) >>> 0);
          }
          LAB_00448708: if ((heap.u32(0x00630b3c) == '\x01') && (heap.setU32((pbVar23 + (((uVar8 ^ 2) >>> 3) + 6) * 4), (heap.u32(pbVar23 + (((uVar8 ^ 2) >>> 3) + 6) * 4) | '\x01' << ((uVar8 ^ 2) & 7)) >>> 0), (heap.u32(pbVar23 + (4) * 4) & 0xf0) == 0)) {
            FUN_00448d15(heap, uVar15, uVar7, uVar5);
          }
  ...
  for (puVar21 = __addr_DAT_00630b34; unaff_EDI = (puVar21 + 1), unaff_EDI < heap.u32(0x00630b30); puVar21 = puVar21 + 1) {
    do {
      if (heap.u32(puVar21) < heap.u32(unaff_EDI)) {
        LOCK();
        uVar2 = heap.u32(unaff_EDI);
        heap.setU32(unaff_EDI, (heap.u32(puVar21)) >>> 0);
        UNLOCK();
        heap.setU32(puVar21, (uVar2) >>> 0);
      }
  ...
  if (__addr_DAT_00630b34 < heap.u32(0x00630b30)) {
    ...
    heap.setU32(0x00630b35, ((heap.u32(0x00630b36) >>> 8)) >>> 0);
  ...
  while (pbVar1 = pbVar24 + 1, pbVar24 = pbVar24 + 8, (heap.u32(pbVar1) & 0x80) == 0) {
    LAB_00448951: if ((((heap.u32(pbVar24) & 0x3c) == 4) && ((heap.u32(pbVar24 + (4) * 4) & 4) == 0)) && ((heap.u32(pbVar24 + (4) * 4) >>> 4 != 0 && (bVar17 == heap.u32(pbVar24 + (2) * 4))))) {
      uVar10 = uVar20 + 1 & 3;
      uVar18 = uVar10 + 4;
      heap.setU32((pbVar24 + ((uVar18 >>> 3) + 6) * 4), (heap.u32(pbVar24 + ((uVar18 >>> 3) + 6) * 4) | '\x01' << (uVar18 & 7)) >>> 0);
      FUN_005e56d3(heap, pbVar24, unaff_EDI, pbVar23, uVar9, uVar8, pbVar22, uVar7, uVar5);
      uVar5 = uVar10 - 1 & 3;
      uVar7 = uVar5 + 4;
      heap.setU32((pbVar23 + ((uVar7 >>> 3) + 6) * 4), (heap.u32(pbVar23 + ((uVar7 >>> 3) + 6) * 4) | '\x01' << (uVar7 & 7)) >>> 0);
      FUN_005e56d3(heap, pbVar23);
      uVar5 = (uVar5 - 1 & 3) + 4;
      heap.setU32((pbVar22 + ((uVar5 >>> 3) + 6) * 4), (heap.u32(pbVar22 + ((uVar5 >>> 3) + 6) * 4) | '\x01' << (uVar5 & 7)) >>> 0);
      FUN_005e56d3(heap, pbVar22);
      uVar5 = (uVar19 & 3) + 4;
      heap.setU32((unaff_ESI + ((uVar5 >>> 3) + 6) * 4), (heap.u32(unaff_ESI + ((uVar5 >>> 3) + 6) * 4) | '\x01' << (uVar5 & 7)) >>> 0);

      ...
      if ((heap.u32((0x008ae9c5) + (iVar11) * 4) & 1) == 0) {
        for (iVar6 = ((0) >>> 0); ((iVar6) & 0xff) < heap.u32(((0x00887498) & 0xff) + (iVar7) * 4); iVar6 = (((iVar6 + 1) >>> 0)) >>> 0) {
          if ((heap.u16((0x0088747e + iVar6 * 2 + iVar7)) != 0xffff) && (iVar9 = ((heap.u32((0x0088747e + iVar6 * 2 + iVar7)) * 0x100) >>> 0), heap.u32((0x00743be4) + (iVar9) * 4) == 3)) {
            heap.setU8(((0x008ae9ce) + (iVar11) * 4), (((iVar6) & 0xff)) & 0xffffffff);
            ...
            if (uVar8 < 0x12c0) {
              if ((heap.u32((0x008ae9c5) + (iVar11) * 4) & 4) != 0) {
                if (globalThis.__realStartup || state.executionMode === "pure-js") {
                  ...
                  const savedEbp = regs.ebp >>> 0;
                  regs.esi = (0x00743b94 + iVar6) >>> 0;
                  regs.ebx = iVar7 >>> 0;
                  regs.ebp = uVar8 >>> 0;
                  sVar2 = (((regs.eax = FUN_005d9220(heap))) & 0xffff);
              ...
              if ((heap.u32(0x006e3b84) & 1) == 0) {
                ...
                heap.setU16(((0x008b0f50) + (iVar11 + uVar8) * 4), ((((((((iVar7) << 16 >> 16) + heap.u32(((0x008b0f50) & 0xffff) + (iVar11 + uVar8) * 4)) & 0xffff) >>> 1)) << 24 >> 24)) & 0xffffffff);
                heap.setU16(((0x008b2210) + (iVar11 + uVar8) * 4), ((((((uVar5 + heap.u32(((0x008b2210) & 0xff) + (iVar11 + uVar8) * 4)) & 0xffff) >>> 1)) << 24 >> 24)) & 0xffffffff);
              }

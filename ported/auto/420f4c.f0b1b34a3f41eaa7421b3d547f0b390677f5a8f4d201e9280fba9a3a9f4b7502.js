...
export function FUN_00420f4c(heap) {
  ...
  let cVar2 = 0;
  let cVar4 = 0;
  uVar9 = ((heap.u32(0x00991f74) + heap.i16((0x005f4696 + heap.u8(0x00991f88) * 4))) & 0xffff);
  if ((((heap.u32(0x00991f70) + heap.i16((0x005f4694 + heap.u8(0x00991f88) * 4))) & 0xffff) < 0x1000) && (uVar9 < 0x1000)) {
    uVar9 = ((uVar9 * 0x80 | uVar9 >>> 9 | heap.u32(0x00991f70) + heap.i16((0x005f4694 + heap.u8(0x00991f88) * 4))) & 0xffff);
  ...
  bVar3 = ((cVar4 + heap.u32((0x005f46e4) + (uVar11) * 4)) & 0xff);

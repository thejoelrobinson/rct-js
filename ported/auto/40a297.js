...
export function FUN_0040a297(heap, param_1, param_2, param_3, param_4, param_5, param_6) {
  ...
  if (heap.u32(0x005ebf54) == 0) {
    ...
    uVar1 = FUN_0040a006(heap, param_1, param_2, param_3, __addr_local_18, param_6);
  } else {
    if ((((param_1 != 0) && (param_3 != 0)) && (heap.u32((param_3 + 0x80)) != 0)) && (heap.u32((param_1 + 0x80)) != 0)) {
      ...
      do {
        local_8 = (heap.u32(heap.u32((heap.u32(heap.u32((param_3 + 0x80))) + 0x1c))))(heap.u32((param_3 + 0x80)), param_4, param_5, heap.u32((param_1 + 0x80)), param_2, 0x11);

...
export function FUN_00401c9b(heap) {
  ...
  if (iVar1 == 0) {
    ...
    for (heap.setU32(__addr_local_8, (0) >>> 0); heap.u32(__addr_local_8) < heap.u32(0x005f15c4); heap.setU32(__addr_local_8, (heap.u32(__addr_local_8) + 0x40) >>> 0)) {
      ...
      while (iVar1 = ((heap.u32(__addr_local_b4)) >>> 0), heap.u32(__addr_local_b4) < heap.u32(0x005f1b34)) {
        if (heap.u8(heap.u32(__addr_local_b8) + (local_cc)) == 0) {
          ...
          (regs.eax = callIndirect(heap, heap.u32(0x005ebeb4), __addr_local_c8, heap.u32(__addr_local_8), iVar1));

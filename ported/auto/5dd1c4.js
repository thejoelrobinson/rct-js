...
export function FUN_005dd1c4(heap) {
  ...
  uVar6 = heap.u32((uint)(byte)(__addr_DAT_00887421) + (iVar10) * 4);
  ...
  if (bVar5 == 0xff) {
    ...
    bVar5 = heap.u32((__addr_DAT_005f6be5) + (heap.u32((uint)(byte)(__addr_DAT_00887421) + (iVar10) * 4) * 4) * 4);
    bVar1 = heap.u32((__addr_DAT_005f5d03) + ((uint) * pbVar11 * 8) * 4);
    do {
      FUN_005ddbe1(heap);
      uVar6 = 0;
      uVar9 = 0;
    ...
    bVar5 = 1;
    LAB_005dd294: bVar1 = heap.u32((__addr_DAT_005f6be4) + (heap.u32((uint)(byte)(__addr_DAT_00887421) + (iVar10) * 4) * 4) * 4);
    if (local_22 < bVar1) {
      local_22 = bVar1;
    }
    if (bVar5 < bVar1) {
    ...
    for (pbVar11 = __addr_DAT_0065ea78; heap.u32(pbVar11) != 0xff; pbVar11 = pbVar11 + 1) {
      uVar6 = uVar6 + heap.u32((__addr_DAT_005f6f1c + (uint) * pbVar11 * 8));
    }
    uVar7 = uVar6 >>> 1;
    if (local_22 != 1) {
      uVar7 = uVar6 >>> 2;
  ...
  if (sVar4 != CONCAT11(heap, heap.u32((__addr_DAT_00887498) + (iVar10) * 4), heap.u32((__addr_DAT_00887499) + (iVar10) * 4))) {

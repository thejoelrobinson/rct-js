...
export function FUN_0042e276(heap) {
  ...
  FUN_00444bd4(heap);
  if (!in_ZF) {
    heap.setU32((unaff_ESI + 0x46), (unaff_BP) >>> 0);
    heap.setU32((unaff_ESI + 0x2e), (unaff_BX) >>> 0);
    heap.setU32((unaff_ESI + (0x1e) * 4), (unaff_BX << 3) >>> 0);
    heap.setU32((unaff_ESI + (0x14) * 4), (0x21) >>> 0);
    heap.setU32((unaff_ESI + (9) * 4), (0x24) >>> 0);
    heap.setU32((unaff_ESI + (0x15) * 4), (0xc) >>> 0);
    heap.setU32(unaff_ESI, (2) >>> 0);
    FUN_00444927(heap);
    heap.setU32((unaff_ESI + (1) * 4), (6) >>> 0);

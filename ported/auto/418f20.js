...
export function FUN_00418f20(heap, param_1, param_2) {
  ...
  if (iVar1 != 0) {
    iVar1 = (((regs.eax = FUN_00418ef0(heap, heap.u32(param_1 + (1) * 4), 1, param_1 + 1))) >>> 0);
    if (iVar1 != 0) {
      heap.setU32((param_1 + (2) * 4), (heap.u32(param_1 + (2) * 4) + 1) & 0xffffffff);
    }
  }
  iVar1 = (((regs.eax = FUN_00418ef0(heap, heap.u32(param_1 + (1) * 4), heap.u32(param_2 + (1) * 4), param_1 + 1))) >>> 0);
  if (iVar1 != 0) {
    heap.setU32((param_1 + (2) * 4), (heap.u32(param_1 + (2) * 4) + 1) & 0xffffffff);
  }
  return (regs.eax = FUN_00418ef0(heap, heap.u32(param_1 + (2) * 4), heap.u32(param_2 + (2) * 4), param_1 + 2));
}

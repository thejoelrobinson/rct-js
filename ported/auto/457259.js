...
export function FUN_00457259(heap) {
  ...
  if ((!bVar3) && (((heap.u32((__addr_DAT_008d7e2a) + (heap.u32((unaff_ESI + 0xc5))) * 4) & 2) == 0 || (uVar2 = (uVar1 & 0xf80) >>> 7, (heap.u32((byte)(__addr_DAT_008d422a) + ((uVar2 >>> 3) + ((extraout_ECX & 0xf80) >>> 7) * 4 + (uint) * (unaff_ESI + 0xc5) * 0x80) * 4) >>> (uVar2 & 7) & 1) != 0)))) {

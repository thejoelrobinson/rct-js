  ...
  if ((unaff_EBX & 0x20000000) == 0) {
    if ((unaff_EBX & 0x40000000) == 0) {
      ...
      if (bVar3 != 0) {
        ...
        uVar5 = heap.u32(0x009a2028) & 1;
        if (heap.u32(0x009a2028) >>> 1 != 0) {
          uVar10 = (heap.u32(0x009a2028) >>> 1);
          uVar7 = uVar10;
          LAB_009b661e: do {
            ...
            pbVar12 = unaff_EDI + 1;
            if (sVar6 != 1) {
              bVar1 = heap.u32(unaff_ESI + (2) * 4);
              if (bVar1 != 0) {
                heap.setU32((unaff_EDI + (1) * 4), (bVar1) >>> 0);
              }
              pbVar11 = unaff_ESI + 4;
              pbVar12 = unaff_EDI + 2;
              if (sVar6 != 2) {
                ...
                if (bVar1 != 0) {
                  heap.setU32((unaff_EDI + (2) * 4), (bVar1) >>> 0);
                }
                pbVar11 = unaff_ESI + 6;
                pbVar12 = unaff_EDI + 3;
                if (sVar6 != 3) {
                  bVar1 = heap.u32(unaff_ESI + (6) * 4);
                  unaff_ESI = unaff_ESI + 8;
                  if (bVar1 != 0) {
                    heap.setU32((unaff_EDI + (3) * 4), (bVar1) >>> 0);
                  }
                  ...
                  pbVar12 = unaff_EDI;
                  if ((sVar6 - 4) != 0) {
                    /* goto LAB_009b661e */ throw new Error("goto LAB_009b661e not supported");
                  }
                }
              }
            }
            unaff_ESI = pbVar11 + in_EDX + uVar4 + uVar5;
      ...
      uVar5 = heap.u32(0x009a2028) & 1;
      if (heap.u32(0x009a2028) >>> 1 != 0) {
        heap.setU32(0x009a2028, (CONCAT22(heap.u16(0x009a2028), heap.u32(0x009a2028) >>> 1)) >>> 0);
        iVar8 = ((bVar3 >>> 1) - 1) << 0x10;
        do {
          iVar8 = CONCAT22((iVar8 >>> 0x10), heap.u32(0x009a2028));
          do {
            if (heap.u32(unaff_ESI) != 0) {
            ...
            if (heap.u32(unaff_ESI + (2) * 4) != 0) {
              heap.setU32(pbVar12, (heap.u32((heap.u32(pbVar12) + iVar2))) >>> 0);
            }
            pbVar12 = unaff_EDI + 2;
      ...
      if (heap.u32(0x009a2028) >>> 1 != 0) {
        ...
        do {
          ...
          do {
            ...
            unaff_ESI = unaff_ESI + 8;
            bVar3 = heap.u32((heap.u32(pbVar11) + iVar2));
            if (bVar3 != 0) {

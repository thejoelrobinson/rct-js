...
export function FUN_00427410(heap) {
  ...
  heap.setU16((unaff_ESI + ((0x59) * 4)), (6) & 0xffff);
  (regs.eax = FUN_005e43de(heap));
  heap.setU32((unaff_ESI + (7) * 4), (heap.u32(0x005f509c)) & 0xffffffff);
  heap.setU32((unaff_ESI + (3) * 4), (heap.u32(0x005f50f0)) & 0xffffffff);
  heap.setU32((unaff_ESI + (6) * 4), (heap.u32(0x005f510c)) & 0xffffffff);
  heap.setU32(unaff_ESI, (heap.u32(0x005f50b8)) & 0xffffffff);
  heap.setU32((unaff_ESI + (1) * 4), (heap.u32(0x005f50d4)) & 0xffffffff);
  heap.setU32((unaff_ESI + (5) * 4), (0) & 0xffffffff);
  return (regs.eax = 0x428842, regs.ecx = 0x1b, regs.eax = FUN_005e412c(heap));
}

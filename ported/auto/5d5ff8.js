...
export function FUN_005d5ff8(heap) {
  ...
  let bVar10 = 0;
  let local_24 = 0;
  pHVar3 = FUN_0040844b(heap, 0x005f90c5, 0x0065d900);
  pcVar6 = 0x00658aae;
    ...
    if (!bVar10) {
      ...
      if (local_24 == heap.u32(0x00656b34)) {
        do {
          ...
          if (uVar4 == 0) {
            if ((heap.u32((byte)(0x0087c3fc) + (((heap.u32(0x00656b35) & 0x1f) >>> 3) + (uint)(heap.u32(0x00656b35) >>> 5) * 4) * 4) >>> (heap.u32(0x00656b35) & 7) & 1) != 0) {
              pcVar7 = 0x0065d92c;
              uVar4 = 0;
              pcVar8 = pcVar6;
        ...
        } while ((heap.u32((0x0087c41c + (uVar2 >>> 3) + (in_EDX & 0xff) * 4)) >>> (uVar2 & 7) & 1) != 0);
      }
    }

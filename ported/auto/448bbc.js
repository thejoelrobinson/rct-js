...
export function FUN_00448bbc(heap) {
  ...
  let uVar5 = 0;
  let iVar8 = 0;
  for (pbVar6 = 0x00630be0; pbVar6 < heap.u32(0x00630bdc); pbVar6 = pbVar6 + 1) {
    bVar2 = heap.u32(pbVar6);
    iVar8 = bVar2 * 0x260;
    if (heap.u32((0x00887420) + (iVar8) * 4) != -1) {
      uVar5 = 0;
      do {
        uVar4 = heap.u32((0x00887462) + (bVar2 * 0x130 + uVar5) * 4);
        if (uVar4 != 0xffff) {
          bVar3 = heap.u32((0x00887452) + (iVar8 + uVar5) * 4);
          pbVar7 = heap.u32((0x00971ef4) + ((ushort)((ushort)((uVar4 >>> 8) << 0xc | (uVar4 & 0xff) << 5) >>> 5 | ((ushort)((uVar4 >>> 8) << 5) >>> 9) << 0xb)) * 4);
          do {

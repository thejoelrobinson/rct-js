...
export function FUN_009b3e87(heap) {
  ...
  if ((heap.u32(0x009a201c) & 4) != 0) {
    ...
    sVar6 = (in_DX + sVar6 & 0xfffc) - heap.u32((unaff_EDI + 6));
    if (sVar6 < 0) {
    ...
    if ((sVar5 == 0 || (sVar6 + heap.u32(0x009a202c)) < 1) || (heap.setU32(0x009a202c, (heap.u32(0x009a202c) - sVar5) >>> 0), heap.u32(0x009a202c) != 0 && sVar5 <= sVar7)) {
      ...
      sVar6 = (in_CX + heap.u32(0x009a2018) & 0xfffc) - heap.u32((unaff_EDI + 4));
      if (sVar6 < 0) {
        ...
        while (sVar6 != 0) {
          ...
          if (bVar1 < '\0') {
            ...
            for (uVar3 = -(bVar1 >>> 3); uVar3 != 0; uVar3 = uVar3 - 1) {
              heap.setU32(pbVar10, (heap.u32(pbVar9)) >>> 0);
              pbVar9 = pbVar9 + 1;
              pbVar10 = pbVar10 + 1;
            }
          } else {
            ...
            for (; pbVar8 = pbVar8 + 1, uVar3 != 0; uVar3 = uVar3 - 1) {
              heap.setU32(pbVar10, (heap.u32(pbVar8)) >>> 0);
              pbVar10 = pbVar10 + 1;
            }
          }
        }

...
export function FUN_0045163c(heap) {
  ...
  uVar5 = 0xff00;
  do {
    bVar1 = heap.u32((0x005f5560) + (uVar5 & 0xff) * 4);
    uVar4 = CONCAT31(heap, (int3)(uVar5 >>> 8), bVar1);
    uVar2 = bVar1;
    if ((heap.u32(0x00631d0c) == heap.u32((0x005f5d05) + (uVar2 * 8) * 4)) && ((heap.u32((0x0087c3dc + ((uVar2 & 0x1f) >>> 3) + (uint)(bVar1 >>> 5) * 4)) >>> (uVar2 & 7) & 1) != 0)) {
      if ((uVar5 >>> 8) == -1) {
        uVar4 = CONCAT11(heap, bVar1, bVar1);
      }
      if (uVar4 == heap.u32((0x00631d0d) + (heap.u32(0x00631d0c)) * 4)) {
        /* goto LAB_004516ad */ throw new Error("goto LAB_004516ad not supported");
      }
      sVar7 = sVar7 + 1;
    }
    cStack_10 = uVar5;
    uVar5 = CONCAT31(heap, (int3)(uVar4 >>> 8), cStack_10 + 1U);
  } while ((byte)(cStack_10 + 1U) < 0x31);
  heap.u32((0x00631d0d) + (heap.u32(0x00631d0c)) * 4) = (uVar4 >>> 8);
  sVar7 = 0;

...
export function FUN_005d5801(heap) {
  ...
  if (heap.u32(0x00652293) < '\0') {
    ...
    heap.setU32(0x0099a4de, (heap.u32(0x0065228a) & 0xffe0) >>> 0);
    heap.setU32(0x0099a4e0, (heap.u32(0x0065228c) & 0xffe0) >>> 0);
    heap.setU32(0x0099a4e2, (heap.u32(0x0065228e) + 0xf) >>> 0);
    heap.setU32(0x0099a4e4, (4) >>> 0);
    uVar1 = heap.u32(0x0065228c) & 0x1f;
    if ((((heap.u32(0x0065228a) & 0x1f) != 0 || uVar1 != 0) && (heap.setU32(0x0099a4e4, (6) >>> 0), (uVar1 & heap.u32(0x0065228a) & 0x1f) == 0)) && (heap.setU32(0x0099a4e4, (5) >>> 0), uVar1 == 0)) {

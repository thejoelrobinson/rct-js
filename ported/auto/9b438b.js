...
export function FUN_009b438b(heap) {
  ...
  if (heap.u32(0x009a2000) != 0) {
    if ((unaff_EBX & 0x80000000) == 0) {
      ...
      uVar3 = unaff_EBX >>> 0x11 & 0x7f;
      if (uVar3 != 0x27) {
        iVar8 = heap.u32((0x008dc0b4) + (heap.u32((0x009aa06c + uVar3 * 4)) * 4) * 4);
        ...
        iVar8 = heap.u32((0x008dc0b4) + (heap.u32((0x009aa06c + (unaff_EBX >>> 0x18 & 0x1f) * 4)) * 4) * 4);
    ...
    in_EAX = heap.u32((0x008dc0b4) + (heap.u32((0x009aa06c + uVar3 * 4)) * 4) * 4);
    heap.setU32(0x009a200c, (in_EAX) >>> 0);
  }
  uVar3 = unaff_EBX & 0x1ffff;
  iVar8 = uVar3 * 0x10;
  if (heap.u32((unaff_EDI + 0xe)) == 0) {
    pbVar9 = heap.u32((0x008dc0b4) + (uVar3 * 4) * 4);
    uVar3 = heap.u32((0x008dc0b8 + iVar8));
    ...
    if ((heap.u32(0x009a201c) & 4) != 0) {
      uVar4 = CONCAT22(heap, sVar5, heap.u32(0x009a2016));
    ...
    if (uVar7 < 0) {
      ...
      uVar4 = (uint)(ushort)(heap.u32((unaff_EDI + 8)) + heap.u32((unaff_EDI + 0xc))) * uVar7;
    }
    ...
    if ((sVar2 == 0 || (uVar7 + heap.u32(0x009a202c)) < heap.u32((unaff_EDI + 10))) || (heap.setU32(0x009a202c, (heap.u32(0x009a202c) - sVar2) >>> 0), heap.u32(0x009a202c) != 0 && sVar2 <= sVar5)) {
      ...
      if ((heap.u32(0x009a201c) & 2) != 0) {
        ...
        while (sVar5 != 0) {
          ...
          if (bVar1 < '\0') {
            pbVar10 = pbVar9 + 1;
            sVar5 = sVar5 - (ushort)(byte) - (bVar1 >>> 3);
            pbVar9 = pbVar9 + 2;
  ...
  if ((heap.u32(0x009a201c) & 4) != 0) {
    ...
    heap.setU32(0x009a2020, (0) >>> 0);
    if ((uVar3 & 0x10000) != 0) {
      uVar4 = CONCAT22(heap, sVar5, heap.u32(0x009a2016) + -1);
  ...
  uVar4 = CONCAT22(heap, sVar5, sVar2);
  if (sVar2 != 0) {
    uVar7 = (in_DX + sVar5 & 0xfffeU) - heap.u32((unaff_EDI + 6));
    if (uVar7 < 0) {
      ...
      uVar4 = (uint)(ushort)((heap.u32((unaff_EDI + 8)) >>> 1) + heap.u32((unaff_EDI + 0xc))) * (uint)(uVar7 >>> 1);

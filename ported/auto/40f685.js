...
export function FUN_0040f685(heap, param_1, param_2, param_3) {
  ...
  if (heap.u32(param_1 + (0x22) * 4) == 0) {
    ...
    for (local_10 = 0; local_10 < 0x100; local_10 = local_10 + 1) {
      heap.setU32((iVar1 + 0x2a + local_10 * 4), (heap.u32((__addr_DAT_005ef6aa) + (local_10 * 4) * 4)) >>> 0);
      heap.setU32((iVar1 + 0x29 + local_10 * 4), (heap.u32((__addr_DAT_005ef6a9) + (local_10 * 4) * 4)) >>> 0);
      heap.setU32((iVar1 + 0x28 + local_10 * 4), (heap.u32((__addr_DAT_005ef6a8) + (local_10 * 4) * 4)) >>> 0);
